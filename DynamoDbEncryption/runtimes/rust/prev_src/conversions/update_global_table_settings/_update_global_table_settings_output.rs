...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_global_table_settings::UpdateGlobalTableSettingsOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateGlobalTableSettingsOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateGlobalTableSettingsOutput::UpdateGlobalTableSettingsOutput {
...
pub fn from_dafny(
    ...
    crate::operation::update_global_table_settings::UpdateGlobalTableSettingsOutput::builder()
