...
pub use crate::operation::create_aws_kms_hierarchical_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_aws_kms_hierarchical_keyring::_create_aws_kms_hierarchical_keyring_input::CreateAwsKmsHierarchicalKeyringInputBuilder;
...
impl CreateAwsKmsHierarchicalKeyringInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::create_aws_kms_hierarchical_keyring::CreateKeyringOutput,
...
pub struct CreateAwsKmsHierarchicalKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_aws_kms_hierarchical_keyring::builders::CreateAwsKmsHierarchicalKeyringInputBuilder,
}
impl CreateAwsKmsHierarchicalKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_aws_kms_hierarchical_keyring::builders::CreateAwsKmsHierarchicalKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_aws_kms_hierarchical_keyring::CreateAwsKmsHierarchicalKeyring::send(&self.client, input).await
    }
