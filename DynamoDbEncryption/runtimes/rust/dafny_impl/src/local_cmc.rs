...
pub mod internal_SynchronizedLocalCMC {
    ...
    pub struct SynchronizedLocalCMC {
        wrapped: Mutex<::dafny_runtime::Object<LocalCMC::LocalCMC>>,
    }

    impl SynchronizedLocalCMC {
        pub fn _allocate_object(
            cmc: ::dafny_runtime::Object<LocalCMC::LocalCMC>,
    ...
    fn r#_PutCacheEntry_k(&mut self, input: &std::rc::Rc<crate::software::amazon::cryptography::materialproviders::internaldafny::types::PutCacheEntryInput>) -> std::rc::Rc<crate::Wrappers::Result<(), std::rc::Rc<crate::software::amazon::cryptography::materialproviders::internaldafny::types::Error>>> {
      self.wrapped.lock().unwrap().as_mut()._PutCacheEntry_k(input)
    }

    fn r#_UpdateUsageMetadata_k(&mut self, input: &std::rc::Rc<crate::software::amazon::cryptography::materialproviders::internaldafny::types::UpdateUsageMetadataInput>) -> std::rc::Rc<crate::Wrappers::Result<(), std::rc::Rc<crate::software::amazon::cryptography::materialproviders::internaldafny::types::Error>>> {
    ...
    fn r#_DeleteCacheEntry_k(&mut self, input: &std::rc::Rc<crate::software::amazon::cryptography::materialproviders::internaldafny::types::DeleteCacheEntryInput>) -> std::rc::Rc<crate::Wrappers::Result<(), std::rc::Rc<crate::software::amazon::cryptography::materialproviders::internaldafny::types::Error>>> {
