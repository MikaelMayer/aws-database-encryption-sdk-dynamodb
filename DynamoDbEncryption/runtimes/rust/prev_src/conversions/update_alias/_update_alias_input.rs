...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_alias::UpdateAliasRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateAliasRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateAliasRequest::UpdateAliasRequest {
...
pub fn from_dafny(
    ...
    crate::operation::update_alias::UpdateAliasRequest::builder()
