...
impl crate::client::Client {
    ...
    ///   - [`signature_algorithm(impl Into<Option<primitives::types::EcdsaSignatureAlgorithm>>)`](crate::operation::ecdsa_sign::builders::ECDSASignFluentBuilder::signature_algorithm) / [`set_signature_algorithm(Option<primitives::types::EcdsaSignatureAlgorithm>)`](crate::operation::ecdsa_sign::builders::ECDSASignFluentBuilder::set_signature_algorithm): (undocumented)<br>
    ...
    pub fn ecdsa_sign(&self) -> crate::operation::ecdsa_sign::builders::EcdsaSignFluentBuilder {
        crate::operation::ecdsa_sign::builders::EcdsaSignFluentBuilder::new(self.clone())
    }
}
