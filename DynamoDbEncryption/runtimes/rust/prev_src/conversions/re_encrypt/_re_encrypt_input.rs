...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::re_encrypt::ReEncryptRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ReEncryptRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ReEncryptRequest::ReEncryptRequest {
...
pub fn from_dafny(
    ...
    crate::operation::re_encrypt::ReEncryptRequest::builder()
