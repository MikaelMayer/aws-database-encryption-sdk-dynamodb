...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::DeleteItemInput>>)`](crate::operation::delete_item_input_transform::builders::DeleteItemInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::DeleteItemInput>)`](crate::operation::delete_item_input_transform::builders::DeleteItemInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::DeleteItemInput>)`](crate::operation::delete_item_input_transform::DeleteItemInputTransformOutput::transformed_input): (undocumented)
