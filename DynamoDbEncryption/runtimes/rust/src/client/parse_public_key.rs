...
impl crate::client::Client {
    ...
    ///   - [`public_key(Option<primitives::types::EccPublicKey>)`](crate::operation::parse_public_key::ParsePublicKeyOutput::public_key): (undocumented)
    /// - On failure, responds with [`SdkError<ParsePublicKeyError>`](crate::operation::parse_public_key::ParsePublicKeyError)
    pub fn parse_public_key(&self) -> crate::operation::parse_public_key::builders::ParsePublicKeyFluentBuilder {
        crate::operation::parse_public_key::builders::ParsePublicKeyFluentBuilder::new(self.clone())
    }
}
