...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_backups::ListBackupsInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListBackupsInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListBackupsInput::ListBackupsInput {
 ...
 BackupType: ::std::rc::Rc::new(match &value.backup_type {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::backup_type_filter::to_dafny(x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::list_backups::ListBackupsInput::builder()
 ...
 .set_backup_type(match &**dafny_value.BackupType() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::backup_type_filter::from_dafny(value)
    ),
    _ => None,
}
)
