...
pub use crate::operation::generate_rsa_key_pair::_generate_rsa_key_pair_output::GenerateRsaKeyPairOutputBuilder;

pub use crate::operation::generate_rsa_key_pair::_generate_rsa_key_pair_input::GenerateRsaKeyPairInputBuilder;
...
pub struct GenerateRsaKeyPairFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::generate_rsa_key_pair::builders::GenerateRsaKeyPairInputBuilder,
}
impl GenerateRsaKeyPairFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::generate_rsa_key_pair::builders::GenerateRsaKeyPairInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::generate_rsa_key_pair::GenerateRsaKeyPair::send(&self.client, input).await
    }
