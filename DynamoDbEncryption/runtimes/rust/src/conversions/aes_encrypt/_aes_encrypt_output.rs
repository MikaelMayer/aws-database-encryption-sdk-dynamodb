...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::aes_encrypt::AesEncryptOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::AESEncryptOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::AESEncryptOutput::AESEncryptOutput {
...
pub fn from_dafny(
    ...
    crate::operation::aes_encrypt::AesEncryptOutput::builder()
