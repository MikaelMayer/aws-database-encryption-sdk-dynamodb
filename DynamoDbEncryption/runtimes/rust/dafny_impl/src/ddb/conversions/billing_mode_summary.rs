...
,
 LastUpdateToPayPerRequestDateTime: crate::ddb::standard_library_conversions::otimestamp_to_dafny(&value.last_update_to_pay_per_request_date_time),
    }
  )
} #[allow(dead_code)]
pub fn from_dafny(
 ...
 .set_last_update_to_pay_per_request_date_time(crate::ddb::standard_library_conversions::otimestamp_from_dafny(dafny_value.LastUpdateToPayPerRequestDateTime().clone()))
          .build()
