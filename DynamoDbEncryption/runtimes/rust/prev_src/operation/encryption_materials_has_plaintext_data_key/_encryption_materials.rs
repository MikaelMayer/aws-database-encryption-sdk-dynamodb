...
pub struct EncryptionMaterials {
    #[allow(missing_docs)] // documentation missing in model
pub algorithm_suite: ::std::option::Option<material_providers::types::AlgorithmSuiteInfo>,
#[allow(missing_docs)] // documentation missing in model
pub encrypted_data_keys: ::std::option::Option<::std::vec::Vec<material_providers::types::EncryptedDataKey>>,
#[allow(missing_docs)] // documentation missing in model
...
impl EncryptionMaterials {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite(&self) -> &::std::option::Option<material_providers::types::AlgorithmSuiteInfo> {
    &self.algorithm_suite
}
#[allow(missing_docs)] // documentation missing in model
pub fn encrypted_data_keys(&self) -> &::std::option::Option<::std::vec::Vec<material_providers::types::EncryptedDataKey>> {
...
impl EncryptionMaterials {
    ...
    pub fn builder() -> crate::operation::encryption_materials_has_plaintext_data_key::builders::EncryptionMaterialsBuilder {
        crate::operation::encryption_materials_has_plaintext_data_key::builders::EncryptionMaterialsBuilder::default()
    }
}
...
pub struct EncryptionMaterialsBuilder {
    pub(crate) algorithm_suite: ::std::option::Option<material_providers::types::AlgorithmSuiteInfo>,
pub(crate) encrypted_data_keys: ::std::option::Option<::std::vec::Vec<material_providers::types::EncryptedDataKey>>,
...
impl EncryptionMaterialsBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite(mut self, input: impl ::std::convert::Into<material_providers::types::AlgorithmSuiteInfo>) -> Self {
    self.algorithm_suite = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_algorithm_suite(mut self, input: ::std::option::Option<material_providers::types::AlgorithmSuiteInfo>) -> Self {
    self.algorithm_suite = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_algorithm_suite(&self) -> &::std::option::Option<material_providers::types::AlgorithmSuiteInfo> {
    &self.algorithm_suite
}
#[allow(missing_docs)] // documentation missing in model
pub fn encrypted_data_keys(mut self, input: impl ::std::convert::Into<::std::vec::Vec<material_providers::types::EncryptedDataKey>>) -> Self {
    self.encrypted_data_keys = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_encrypted_data_keys(mut self, input: ::std::option::Option<::std::vec::Vec<material_providers::types::EncryptedDataKey>>) -> Self {
    self.encrypted_data_keys = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_encrypted_data_keys(&self) -> &::std::option::Option<::std::vec::Vec<material_providers::types::EncryptedDataKey>> {
    &self.encrypted_data_keys
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_symmetric_signing_keys(&self) -> &::std::option::Option<::std::vec::Vec<::aws_smithy_types::Blob>> {
    ...
    pub fn build(
        ...
        crate::operation::encryption_materials_has_plaintext_data_key::EncryptionMaterials,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::encryption_materials_has_plaintext_data_key::EncryptionMaterials {
