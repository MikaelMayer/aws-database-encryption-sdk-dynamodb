...
impl RsaEncryptInput {
    /// Creates a new builder-style object to manufacture [`RsaEncryptInput`](crate::primitives::operation::rsa_encrypt::builders::RsaEncryptInput).
    pub fn builder() -> crate::primitives::operation::rsa_encrypt::builders::RsaEncryptInputBuilder {
        crate::primitives::operation::rsa_encrypt::builders::RsaEncryptInputBuilder::default()
    }
}

/// A builder for [`RsaEncryptInput`](crate::primitives::operation::operation::RsaEncryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`RsaEncryptInput`](crate::primitives::operation::operation::RsaEncryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::rsa_encrypt::RsaEncryptInput {
