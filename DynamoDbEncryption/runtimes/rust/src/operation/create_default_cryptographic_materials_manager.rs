...
impl CreateDefaultCryptographicMaterialsManager {
    ...
    > {
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::create_default_cryptographic_materials_manager::_create_default_cryptographic_materials_manager_output::from_dafny(inner_result.value().clone()),
            )
        } else {
