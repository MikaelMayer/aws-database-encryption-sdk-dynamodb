...
pub struct DescribeTableReplicaAutoScalingFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingInputBuilder,
}
impl DescribeTableReplicaAutoScalingFluentBuilder {
    ...
    > {
        ...
        crate::operation::describe_table_replica_auto_scaling::DescribeTableReplicaAutoScaling::send(&self.client, input).await
    }
