...
impl AesEncryptOutput {
    ...
    pub fn builder() -> crate::operation::aes_encrypt::builders::AesEncryptOutputBuilder {
        crate::operation::aes_encrypt::builders::AesEncryptOutputBuilder::default()
    }
}
...
pub fn get_cipher_text(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::aes_encrypt::AesEncryptOutput {
