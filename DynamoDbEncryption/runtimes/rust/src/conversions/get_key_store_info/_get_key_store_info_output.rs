...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_key_store_info::GetKeyStoreInfoOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetKeyStoreInfoOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetKeyStoreInfoOutput::GetKeyStoreInfoOutput {
...
,
 kmsConfiguration: key_store::conversions::kms_configuration::to_dafny(&value.kms_configuration.clone().unwrap())
,
    })
}
 #[allow(dead_code)]
pub fn from_dafny(
    ...
    crate::operation::get_key_store_info::GetKeyStoreInfoOutput::builder()
 ...
 .set_kms_configuration(Some( key_store::conversions::kms_configuration::from_dafny(dafny_value.kmsConfiguration().clone())
 ))
        .build()
        .unwrap()
}
