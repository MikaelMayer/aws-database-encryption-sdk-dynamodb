...
impl ParsePublicKeyOutput {
    /// Creates a new builder-style object to manufacture [`ParsePublicKeyOutput`](crate::primitives::operation::parse_public_key::builders::ParsePublicKeyOutput).
    pub fn builder() -> crate::primitives::operation::parse_public_key::builders::ParsePublicKeyOutputBuilder {
        crate::primitives::operation::parse_public_key::builders::ParsePublicKeyOutputBuilder::default()
    }
}

/// A builder for [`ParsePublicKeyOutput`](crate::primitives::operation::operation::ParsePublicKeyOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<crate::primitives::types::EccPublicKey> {
    ...
    /// Consumes the builder and constructs a [`ParsePublicKeyOutput`](crate::primitives::operation::operation::ParsePublicKeyOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::parse_public_key::ParsePublicKeyOutput {
