...
impl ParsePublicKeyOutput {
    ...
    pub fn builder() -> crate::operation::parse_public_key::builders::ParsePublicKeyOutputBuilder {
        crate::operation::parse_public_key::builders::ParsePublicKeyOutputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<primitives::types::EccPublicKey> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::parse_public_key::ParsePublicKeyOutput {
