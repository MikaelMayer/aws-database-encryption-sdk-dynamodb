...
pub struct ScanInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::ScanInput>,
}
impl ScanInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::ScanInput> {
    &self.sdk_input
}
}
impl ScanInputTransformInput {
    ...
    pub fn builder() -> crate::operation::scan_input_transform::builders::ScanInputTransformInputBuilder {
...
pub struct ScanInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::ScanInput>,
}
impl ScanInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::ScanInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::ScanInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::ScanInput> {
    &self.sdk_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::scan_input_transform::ScanInputTransformInput {
