...
pub use crate::operation::create_aws_kms_multi_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_aws_kms_multi_keyring::_create_aws_kms_multi_keyring_input::CreateAwsKmsMultiKeyringInputBuilder;
...
impl CreateAwsKmsMultiKeyringInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::create_aws_kms_multi_keyring::CreateKeyringOutput,
...
pub struct CreateAwsKmsMultiKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInputBuilder,
}
impl CreateAwsKmsMultiKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_aws_kms_multi_keyring::CreateAwsKmsMultiKeyring::send(&self.client, input).await
    }
