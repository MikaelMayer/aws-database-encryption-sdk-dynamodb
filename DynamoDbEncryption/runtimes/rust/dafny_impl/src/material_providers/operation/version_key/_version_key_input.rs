...
impl VersionKeyInput {
    /// Creates a new builder-style object to manufacture [`VersionKeyInput`](crate::material_providers::operation::version_key::builders::VersionKeyInput).
    pub fn builder() -> crate::material_providers::operation::version_key::builders::VersionKeyInputBuilder {
        crate::material_providers::operation::version_key::builders::VersionKeyInputBuilder::default()
    }
}

/// A builder for [`VersionKeyInput`](crate::material_providers::operation::operation::VersionKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_branch_key_identifier(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`VersionKeyInput`](crate::material_providers::operation::operation::VersionKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::material_providers::operation::version_key::VersionKeyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::material_providers::operation::version_key::VersionKeyInput {
