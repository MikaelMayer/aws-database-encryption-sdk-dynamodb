...
impl crate::HMAC::_default {
  ...
  pub fn Digest(_input: &::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::HMacInput>)
...
pub mod HMAC {
  ...
  impl HMac {
    ...
    pub fn Build(_input: &::std::rc::Rc<software::amazon::cryptography::primitives::internaldafny::types::DigestAlgorithm>) 
    -> ::std::rc::Rc<Wrappers::Result<::dafny_runtime::Object<Self>, ::std::rc::Rc<software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
