...
#[allow(missing_docs)] // documentation missing in model
pub wrapping_alg: ::std::option::Option<material_providers::types::AesWrappingAlg>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn wrapping_alg(&self) -> &::std::option::Option<material_providers::types::AesWrappingAlg> {
    &self.wrapping_alg
}
#[allow(missing_docs)] // documentation missing in model
...
impl CreateRawAesKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInputBuilder {
        crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInputBuilder::default()
    }
}
...
pub(crate) wrapping_alg: ::std::option::Option<material_providers::types::AesWrappingAlg>,
...
pub fn get_wrapping_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_raw_aes_keyring::CreateRawAesKeyringInput {
