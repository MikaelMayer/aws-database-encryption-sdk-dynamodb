...
impl RsaPrivateKey {
    /// Creates a new builder-style object to manufacture [`RsaPrivateKey`](crate::primitives::types::RsaPrivateKey).
    pub fn builder() -> crate::primitives::types::builders::RsaPrivateKeyBuilder {
        crate::primitives::types::builders::RsaPrivateKeyBuilder::default()
    }
}

/// A builder for [`RsaPrivateKey`](crate::primitives::types::RsaPrivateKey).
#[non_exhaustive]
#[derive(
...
pub fn get_pem(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`RsaPrivateKey`](crate::primitives::types::RsaPrivateKey).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::types::RsaPrivateKey {
