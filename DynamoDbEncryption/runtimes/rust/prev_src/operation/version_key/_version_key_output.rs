...
impl VersionKeyOutput {
    ...
    pub fn builder() -> crate::operation::version_key::builders::VersionKeyOutputBuilder {
        crate::operation::version_key::builders::VersionKeyOutputBuilder::default()
    }
}
...
impl VersionKeyOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::version_key::VersionKeyOutput {
