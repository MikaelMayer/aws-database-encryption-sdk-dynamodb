...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::execute_statement::ExecuteStatementInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExecuteStatementInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExecuteStatementInput::ExecuteStatementInput {
 ...
 Parameters: ::std::rc::Rc::new(match &value.parameters {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| dynamodb::conversions::attribute_value::to_dafny(e.clone())
,
        )
    },
...
pub fn from_dafny(
    ...
    crate::operation::execute_statement::ExecuteStatementInput::builder()
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| dynamodb::conversions::attribute_value::from_dafny(e.clone())
,
            )
        ),
    _ => None
