...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::retire_grant::RetireGrantRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::RetireGrantRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::RetireGrantRequest::RetireGrantRequest {
...
pub fn from_dafny(
    ...
    crate::operation::retire_grant::RetireGrantRequest::builder()
