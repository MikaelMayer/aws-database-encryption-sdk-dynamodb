...
impl InitializeEncryptionMaterialsInput {
    ...
    pub fn builder() -> crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsInputBuilder {
        crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsInputBuilder::default()
    }
}
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::initialize_encryption_materials::InitializeEncryptionMaterialsInput {
