...
pub use crate::operation::create_default_cryptographic_materials_manager::_create_cryptographic_materials_manager_output::CreateCryptographicMaterialsManagerOutputBuilder;

pub use crate::operation::create_default_cryptographic_materials_manager::_create_default_cryptographic_materials_manager_input::CreateDefaultCryptographicMaterialsManagerInputBuilder;
...
pub struct CreateDefaultCryptographicMaterialsManagerFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_default_cryptographic_materials_manager::builders::CreateDefaultCryptographicMaterialsManagerInputBuilder,
}
impl CreateDefaultCryptographicMaterialsManagerFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_default_cryptographic_materials_manager::builders::CreateDefaultCryptographicMaterialsManagerInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_default_cryptographic_materials_manager::CreateDefaultCryptographicMaterialsManager::send(&self.client, input).await
    }
