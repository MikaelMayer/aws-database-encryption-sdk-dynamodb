...
impl GenerateEccKeyPairOutput {
    /// Creates a new builder-style object to manufacture [`GenerateEccKeyPairOutput`](crate::primitives::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairOutput).
    pub fn builder() -> crate::primitives::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairOutputBuilder {
        crate::primitives::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairOutputBuilder::default()
    }
}

/// A builder for [`GenerateEccKeyPairOutput`](crate::primitives::operation::operation::GenerateEccKeyPairOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<crate::primitives::types::EccPublicKey> {
    ...
    /// Consumes the builder and constructs a [`GenerateEccKeyPairOutput`](crate::primitives::operation::operation::GenerateEccKeyPairOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::generate_ecc_key_pair::GenerateEccKeyPairOutput {
