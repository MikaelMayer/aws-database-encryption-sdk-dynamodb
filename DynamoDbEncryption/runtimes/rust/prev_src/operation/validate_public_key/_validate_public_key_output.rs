...
impl ValidatePublicKeyOutput {
    ...
    pub fn builder() -> crate::operation::validate_public_key::builders::ValidatePublicKeyOutputBuilder {
        crate::operation::validate_public_key::builders::ValidatePublicKeyOutputBuilder::default()
    }
}
...
pub fn get_success(&self) -> &::std::option::Option<::std::primitive::bool> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::validate_public_key::ValidatePublicKeyOutput {
