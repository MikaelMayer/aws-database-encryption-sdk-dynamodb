...
impl InitializeDecryptionMaterialsInput {
    ...
    pub fn builder() -> crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInputBuilder {
        crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInputBuilder::default()
    }
}
...
pub fn get_required_encryption_context_keys(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::initialize_decryption_materials::InitializeDecryptionMaterialsInput {
