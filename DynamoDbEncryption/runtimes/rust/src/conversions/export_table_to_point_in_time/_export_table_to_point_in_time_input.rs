...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExportTableToPointInTimeInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExportTableToPointInTimeInput::ExportTableToPointInTimeInput {
 ...
 S3SseAlgorithm: ::std::rc::Rc::new(match &value.s3_sse_algorithm {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::s3_sse_algorithm::to_dafny(x.clone()) },
...
,
 ...
 ExportFormat: ::std::rc::Rc::new(match &value.export_format {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::export_format::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
    })
...
pub fn from_dafny(
    ...
    crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput::builder()
 ...
 .set_s3_sse_algorithm(match &**dafny_value.S3SseAlgorithm() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::s3_sse_algorithm::from_dafny(value)
    ),
    _ => None,
}
)
 ...
 .set_export_format(match &**dafny_value.ExportFormat() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::export_format::from_dafny(value)
    ),
    _ => None,
}
)
