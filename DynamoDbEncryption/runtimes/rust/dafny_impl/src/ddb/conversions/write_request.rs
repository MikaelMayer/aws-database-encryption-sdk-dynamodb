...
pub fn to_dafny(
  ...
  ::std::rc::Rc::new(
    ...
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::put_request::to_dafny(x) },
    None => crate::Wrappers::Option::None { }
})
,
 DeleteRequest: ::std::rc::Rc::new(match &value.delete_request {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::delete_request::to_dafny(x) },
    None => crate::Wrappers::Option::None { }
})
,
    }
...
pub fn from_dafny(
    ...
    crate::Wrappers::Option::Some { value } =>
        Some(crate::ddb::conversions::put_request::from_dafny(value.clone())),
    _ => None,
}
)
 .set_delete_request(match (*dafny_value.DeleteRequest()).as_ref() {
    crate::Wrappers::Option::Some { value } =>
        Some(crate::ddb::conversions::delete_request::from_dafny(value.clone())),
    _ => None,
}
)
          .build()
