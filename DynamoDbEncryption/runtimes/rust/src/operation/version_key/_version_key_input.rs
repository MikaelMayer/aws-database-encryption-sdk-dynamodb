...
impl VersionKeyInput {
    ...
    pub fn builder() -> crate::operation::version_key::builders::VersionKeyInputBuilder {
        crate::operation::version_key::builders::VersionKeyInputBuilder::default()
    }
}
...
pub fn get_branch_key_identifier(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::version_key::VersionKeyInput {
