...
pub use crate::primitives::operation::parse_public_key::_parse_public_key_output::ParsePublicKeyOutputBuilder;

pub use crate::primitives::operation::parse_public_key::_parse_public_key_input::ParsePublicKeyInputBuilder;
...
pub struct ParsePublicKeyFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::parse_public_key::builders::ParsePublicKeyInputBuilder,
}
impl ParsePublicKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::parse_public_key::builders::ParsePublicKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::parse_public_key::ParsePublicKey::send(&self.client, input).await
    }
