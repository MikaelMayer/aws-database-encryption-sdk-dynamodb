...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_item::GetItemInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetItemInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetItemInput::GetItemInput {
...
pub fn from_dafny(
    ...
    crate::operation::get_item::GetItemInput::builder()
