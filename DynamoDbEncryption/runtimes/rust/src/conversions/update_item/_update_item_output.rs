...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_item::UpdateItemOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateItemOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateItemOutput::UpdateItemOutput {
        Attributes:
...
pub fn from_dafny(
    ...
    crate::operation::update_item::UpdateItemOutput::builder()
