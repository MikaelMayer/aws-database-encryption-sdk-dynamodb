...
impl crate::client::Client {
    ...
    ///   - [`transformed_output(Option<dynamodb::types::ExecuteTransactionOutput>)`](crate::operation::execute_transaction_output_transform::ExecuteTransactionOutputTransformOutput::transformed_output): (undocumented)
