...
impl EcdsaVerifyInput {
    /// Creates a new builder-style object to manufacture [`EcdsaVerifyInput`](crate::primitives::operation::ecdsa_verify::builders::EcdsaVerifyInput).
    pub fn builder() -> crate::primitives::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder {
        crate::primitives::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder::default()
    }
}

/// A builder for [`EcdsaVerifyInput`](crate::primitives::operation::operation::EcdsaVerifyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`EcdsaVerifyInput`](crate::primitives::operation::operation::EcdsaVerifyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::ecdsa_verify::EcdsaVerifyInput {
