...
impl GetKeyStoreInfoOutput {
    /// Creates a new builder-style object to manufacture [`GetKeyStoreInfoOutput`](crate::material_providers::operation::get_key_store_info::builders::GetKeyStoreInfoOutput).
    pub fn builder() -> crate::material_providers::operation::get_key_store_info::builders::GetKeyStoreInfoOutputBuilder {
        crate::material_providers::operation::get_key_store_info::builders::GetKeyStoreInfoOutputBuilder::default()
    }
}

/// A builder for [`GetKeyStoreInfoOutput`](crate::material_providers::operation::operation::GetKeyStoreInfoOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_logical_key_store_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`GetKeyStoreInfoOutput`](crate::material_providers::operation::operation::GetKeyStoreInfoOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::material_providers::operation::get_key_store_info::GetKeyStoreInfoOutput {
