...
pub use crate::operation::create_aws_kms_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_aws_kms_keyring::_create_aws_kms_keyring_input::CreateAwsKmsKeyringInputBuilder;
...
pub struct CreateAwsKmsKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringInputBuilder,
}
impl CreateAwsKmsKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_aws_kms_keyring::CreateAwsKmsKeyring::send(&self.client, input).await
    }
