...
impl CreateKeyInput {
    /// Creates a new builder-style object to manufacture [`CreateKeyInput`](crate::material_providers::operation::create_key::builders::CreateKeyInput).
    pub fn builder() -> crate::material_providers::operation::create_key::builders::CreateKeyInputBuilder {
        crate::material_providers::operation::create_key::builders::CreateKeyInputBuilder::default()
    }
}

/// A builder for [`CreateKeyInput`](crate::material_providers::operation::operation::CreateKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`CreateKeyInput`](crate::material_providers::operation::operation::CreateKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::material_providers::operation::create_key::CreateKeyInput {
