...
pub use crate::operation::create_aws_kms_mrk_discovery_multi_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_aws_kms_mrk_discovery_multi_keyring::_create_aws_kms_mrk_discovery_multi_keyring_input::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder;
...
pub struct CreateAwsKmsMrkDiscoveryMultiKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder,
}
impl CreateAwsKmsMrkDiscoveryMultiKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_aws_kms_mrk_discovery_multi_keyring::CreateAwsKmsMrkDiscoveryMultiKeyring::send(&self.client, input).await
    }
