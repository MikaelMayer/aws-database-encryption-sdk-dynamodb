...
pub use crate::primitives::operation::digest::_digest_output::DigestOutputBuilder;

pub use crate::primitives::operation::digest::_digest_input::DigestInputBuilder;
...
pub struct DigestFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::digest::builders::DigestInputBuilder,
}
impl DigestFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::digest::builders::DigestInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::digest::Digest::send(&self.client, input).await
    }
