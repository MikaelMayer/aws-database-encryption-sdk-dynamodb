...
pub use crate::operation::rsa_decrypt::_rsa_decrypt_output::RsaDecryptOutputBuilder;

pub use crate::operation::rsa_decrypt::_rsa_decrypt_input::RsaDecryptInputBuilder;
...
pub struct RsaDecryptFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::rsa_decrypt::builders::RsaDecryptInputBuilder,
}
impl RsaDecryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::rsa_decrypt::builders::RsaDecryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::rsa_decrypt::RsaDecrypt::send(&self.client, input).await
    }
