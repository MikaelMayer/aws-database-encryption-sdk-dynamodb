...
pub struct EncryptPathStructureOutput {
    #[allow(missing_docs)] // documentation missing in model
pub encrypted_structure: ::std::option::Option<::std::vec::Vec<structured_encryption::types::CryptoItem>>,
#[allow(missing_docs)] // documentation missing in model
pub parsed_header: ::std::option::Option<structured_encryption::types::ParsedHeader>,
}
impl EncryptPathStructureOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn encrypted_structure(&self) -> &::std::option::Option<::std::vec::Vec<structured_encryption::types::CryptoItem>> {
...
impl EncryptPathStructureOutput {
    ...
    pub fn builder() -> crate::operation::encrypt_path_structure::builders::EncryptPathStructureOutputBuilder {
        crate::operation::encrypt_path_structure::builders::EncryptPathStructureOutputBuilder::default()
    }
}
...
pub struct EncryptPathStructureOutputBuilder {
    pub(crate) encrypted_structure: ::std::option::Option<::std::vec::Vec<structured_encryption::types::CryptoItem>>,
pub(crate) parsed_header: ::std::option::Option<structured_encryption::types::ParsedHeader>,
}
impl EncryptPathStructureOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn encrypted_structure(mut self, input: impl ::std::convert::Into<::std::vec::Vec<structured_encryption::types::CryptoItem>>) -> Self {
    self.encrypted_structure = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_encrypted_structure(mut self, input: ::std::option::Option<::std::vec::Vec<structured_encryption::types::CryptoItem>>) -> Self {
    self.encrypted_structure = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_encrypted_structure(&self) -> &::std::option::Option<::std::vec::Vec<structured_encryption::types::CryptoItem>> {
    &self.encrypted_structure
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_parsed_header(&self) -> &::std::option::Option<structured_encryption::types::ParsedHeader> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::encrypt_path_structure::EncryptPathStructureOutput {
