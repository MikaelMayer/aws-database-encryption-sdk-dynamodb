...
pub use crate::operation::derive_shared_secret::_derive_shared_secret_response::DeriveSharedSecretResponseBuilder;

pub use crate::operation::derive_shared_secret::_derive_shared_secret_request::DeriveSharedSecretRequestBuilder;
...
pub struct DeriveSharedSecretFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::derive_shared_secret::builders::DeriveSharedSecretRequestBuilder,
}
impl DeriveSharedSecretFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::derive_shared_secret::builders::DeriveSharedSecretRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::derive_shared_secret::DeriveSharedSecret::send(&self.client, input).await
    }
...
pub fn key_agreement_algorithm(mut self, input: impl ::std::convert::Into<kms::types::KeyAgreementAlgorithmSpec>) -> Self {
    self.inner = self.inner.key_agreement_algorithm(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
