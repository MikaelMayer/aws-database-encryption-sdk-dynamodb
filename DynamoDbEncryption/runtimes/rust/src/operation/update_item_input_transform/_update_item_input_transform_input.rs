...
pub struct UpdateItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::UpdateItemInput>,
}
impl UpdateItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::UpdateItemInput> {
    &self.sdk_input
}
}
impl UpdateItemInputTransformInput {
    ...
    pub fn builder() -> crate::operation::update_item_input_transform::builders::UpdateItemInputTransformInputBuilder {
...
pub struct UpdateItemInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::UpdateItemInput>,
}
impl UpdateItemInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::UpdateItemInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::UpdateItemInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::UpdateItemInput> {
    &self.sdk_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::update_item_input_transform::UpdateItemInputTransformInput {
