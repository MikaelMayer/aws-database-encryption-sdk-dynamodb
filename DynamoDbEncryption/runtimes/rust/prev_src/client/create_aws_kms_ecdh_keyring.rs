...
impl crate::client::Client {
    ...
    ///   - [`kms_client(impl Into<Option<kms::client::Client>>)`](crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringFluentBuilder::kms_client) / [`set_kms_client(Option<kms::client::Client>)`](crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringFluentBuilder::set_kms_client): (undocumented)<br>
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_ecdh_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_ecdh_keyring(&self) -> crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringFluentBuilder {
        crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringFluentBuilder::new(self.clone())
    }
}
