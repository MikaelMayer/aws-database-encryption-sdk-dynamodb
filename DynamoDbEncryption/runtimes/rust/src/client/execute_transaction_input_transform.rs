...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::ExecuteTransactionInput>>)`](crate::operation::execute_transaction_input_transform::builders::ExecuteTransactionInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::ExecuteTransactionInput>)`](crate::operation::execute_transaction_input_transform::builders::ExecuteTransactionInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::ExecuteTransactionInput>)`](crate::operation::execute_transaction_input_transform::ExecuteTransactionInputTransformOutput::transformed_input): (undocumented)
