...
pub use crate::primitives::operation::h_mac::_h_mac_output::HMacOutputBuilder;

pub use crate::primitives::operation::h_mac::_h_mac_input::HMacInputBuilder;
...
pub struct HMacFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::h_mac::builders::HMacInputBuilder,
}
impl HMacFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::h_mac::builders::HMacInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::h_mac::HMac::send(&self.client, input).await
    }
