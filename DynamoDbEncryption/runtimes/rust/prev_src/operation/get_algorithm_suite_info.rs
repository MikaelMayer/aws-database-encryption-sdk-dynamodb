...
impl GetAlgorithmSuiteInfo {
    ...
    > {
                let inner_input = crate::conversions::get_algorithm_suite_info::_get_algorithm_suite_info_input::to_dafny(input);
        let inner_result =
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::get_algorithm_suite_info::_get_algorithm_suite_info_output::from_dafny(
