...
impl HkdfInput {
    ...
    pub fn builder() -> crate::operation::hkdf::builders::HkdfInputBuilder {
        crate::operation::hkdf::builders::HkdfInputBuilder::default()
    }
}
...
pub fn get_salt(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::hkdf::HkdfInput {
