...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::validate_commitment_policy_on_encrypt::ValidateCommitmentPolicyOnEncryptInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ValidateCommitmentPolicyOnEncryptInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ValidateCommitmentPolicyOnEncryptInput::ValidateCommitmentPolicyOnEncryptInput {
...
pub fn from_dafny(
    ...
    crate::operation::validate_commitment_policy_on_encrypt::ValidateCommitmentPolicyOnEncryptInput::builder()
