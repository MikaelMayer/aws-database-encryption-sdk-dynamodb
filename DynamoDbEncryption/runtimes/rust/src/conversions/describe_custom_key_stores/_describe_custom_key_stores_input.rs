...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DescribeCustomKeyStoresRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DescribeCustomKeyStoresRequest::DescribeCustomKeyStoresRequest {
...
pub fn from_dafny(
    ...
    crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresRequest::builder()
