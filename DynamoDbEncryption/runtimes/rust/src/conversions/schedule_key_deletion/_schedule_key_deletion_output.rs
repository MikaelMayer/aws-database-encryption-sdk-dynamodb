...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::schedule_key_deletion::ScheduleKeyDeletionResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ScheduleKeyDeletionResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ScheduleKeyDeletionResponse::ScheduleKeyDeletionResponse {
 ...
 KeyState: ::std::rc::Rc::new(match &value.key_state {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::key_state::to_dafny(x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::schedule_key_deletion::ScheduleKeyDeletionResponse::builder()
 ...
 .set_key_state(match &**dafny_value.KeyState() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        kms::conversions::key_state::from_dafny(value)
    ),
    _ => None,
}
)
