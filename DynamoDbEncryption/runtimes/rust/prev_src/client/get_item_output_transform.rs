...
impl crate::client::Client {
    ...
    ///   - [`original_input(impl Into<Option<dynamodb::types::GetItemInput>>)`](crate::operation::get_item_output_transform::builders::GetItemOutputTransformFluentBuilder::original_input) / [`set_original_input(Option<dynamodb::types::GetItemInput>)`](crate::operation::get_item_output_transform::builders::GetItemOutputTransformFluentBuilder::set_original_input): (undocumented)<br>
    ///   - [`sdk_output(impl Into<Option<dynamodb::types::GetItemOutput>>)`](crate::operation::get_item_output_transform::builders::GetItemOutputTransformFluentBuilder::sdk_output) / [`set_sdk_output(Option<dynamodb::types::GetItemOutput>)`](crate::operation::get_item_output_transform::builders::GetItemOutputTransformFluentBuilder::set_sdk_output): (undocumented)<br>
    ...
    ///   - [`transformed_output(Option<dynamodb::types::GetItemOutput>)`](crate::operation::get_item_output_transform::GetItemOutputTransformOutput::transformed_output): (undocumented)
    ...
    pub fn get_item_output_transform(&self) -> crate::operation::get_item_output_transform::builders::GetItemOutputTransformFluentBuilder {
