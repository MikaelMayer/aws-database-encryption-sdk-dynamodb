...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_item::UpdateItemInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateItemInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateItemInput::UpdateItemInput {
...
::std::rc::Rc::new(match &value.attribute_updates {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::hashmap_to_dafny_map(x,
            |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&k),
            |v| dynamodb::conversions::attribute_value_update::to_dafny(v.clone())
,
        )
    },
...
::std::rc::Rc::new(match &value.expected {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::hashmap_to_dafny_map(x,
            |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&k),
            |v| dynamodb::conversions::expected_attribute_value::to_dafny(v.clone())
,
        )
    },
    None => crate::r#_Wrappers_Compile::Option::None {}
...
,
 ConditionalOperator: ::std::rc::Rc::new(match &value.conditional_operator {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::conditional_operator::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 ReturnValues: ::std::rc::Rc::new(match &value.return_values {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::return_value::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
pub fn from_dafny(
    ...
    crate::operation::update_item::UpdateItemInput::builder()
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(k),
                |v| dynamodb::conversions::attribute_value_update::from_dafny(v.clone())
,
            )
        ),
    _ => None
 ...
 .set_expected(match (*dafny_value.Expected()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(k),
                |v| dynamodb::conversions::expected_attribute_value::from_dafny(v.clone())
,
            )
        ),
    _ => None
 ...
 .set_conditional_operator(match &**dafny_value.ConditionalOperator() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::conditional_operator::from_dafny(value)
    ),
    _ => None,
}
)
 .set_return_values(match &**dafny_value.ReturnValues() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::return_value::from_dafny(value)
    ),
    _ => None,
}
)
