...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::material_providers::operation::get_branch_key_version::GetBranchKeyVersionInput,
) -> ::std::rc::Rc<
...
>{
 ...
 branchKeyVersion: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.branch_key_version) .Extract(),
    })
}
 #[allow(dead_code)]
pub fn from_dafny(
    ...
    crate::material_providers::operation::get_branch_key_version::GetBranchKeyVersionInput::builder()
