...
impl RsaDecryptOutput {
    ...
    pub fn builder() -> crate::operation::rsa_decrypt::builders::RsaDecryptOutputBuilder {
        crate::operation::rsa_decrypt::builders::RsaDecryptOutputBuilder::default()
    }
}
...
pub fn get_plaintext(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::rsa_decrypt::RsaDecryptOutput {
