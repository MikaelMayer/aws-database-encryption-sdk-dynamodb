...
impl crate::client::Client {
    ...
    pub fn version_key(&self) -> crate::operation::version_key::builders::VersionKeyFluentBuilder {
        crate::operation::version_key::builders::VersionKeyFluentBuilder::new(self.clone())
    }
}
