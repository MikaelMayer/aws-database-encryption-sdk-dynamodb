...
impl crate::client::Client {
    ...
    ///   - [`client_supplier(impl Into<Option<material_providers::types::client_supplier::ClientSupplierRef>>)`](crate::operation::create_aws_kms_mrk_multi_keyring::builders::CreateAwsKmsMrkMultiKeyringFluentBuilder::client_supplier) / [`set_client_supplier(Option<material_providers::types::client_supplier::ClientSupplierRef>)`](crate::operation::create_aws_kms_mrk_multi_keyring::builders::CreateAwsKmsMrkMultiKeyringFluentBuilder::set_client_supplier): (undocumented)<br>
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_mrk_multi_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_mrk_multi_keyring(&self) -> crate::operation::create_aws_kms_mrk_multi_keyring::builders::CreateAwsKmsMrkMultiKeyringFluentBuilder {
        crate::operation::create_aws_kms_mrk_multi_keyring::builders::CreateAwsKmsMrkMultiKeyringFluentBuilder::new(self.clone())
    }
}
