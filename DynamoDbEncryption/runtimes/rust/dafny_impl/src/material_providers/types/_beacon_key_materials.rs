...
impl BeaconKeyMaterials {
    /// Creates a new builder-style object to manufacture [`BeaconKeyMaterials`](crate::material_providers::types::BeaconKeyMaterials).
    pub fn builder() -> crate::material_providers::types::builders::BeaconKeyMaterialsBuilder {
        crate::material_providers::types::builders::BeaconKeyMaterialsBuilder::default()
    }
}

/// A builder for [`BeaconKeyMaterials`](crate::material_providers::types::BeaconKeyMaterials).
#[non_exhaustive]
#[derive(
...
pub fn get_hmac_keys(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::aws_smithy_types::Blob>> {
    ...
    /// Consumes the builder and constructs a [`BeaconKeyMaterials`](crate::material_providers::types::BeaconKeyMaterials).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::material_providers::types::BeaconKeyMaterials {
