...
#[allow(missing_docs)] // documentation missing in model
pub padding_scheme: ::std::option::Option<material_providers::types::PaddingScheme>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding_scheme(&self) -> &::std::option::Option<material_providers::types::PaddingScheme> {
    &self.padding_scheme
}
#[allow(missing_docs)] // documentation missing in model
...
impl CreateRawRsaKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_raw_rsa_keyring::builders::CreateRawRsaKeyringInputBuilder {
        crate::operation::create_raw_rsa_keyring::builders::CreateRawRsaKeyringInputBuilder::default()
    }
}
...
pub(crate) padding_scheme: ::std::option::Option<material_providers::types::PaddingScheme>,
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_raw_rsa_keyring::CreateRawRsaKeyringInput {
