...
pub struct BatchExecuteStatementInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::BatchExecuteStatementInput>,
}
impl BatchExecuteStatementInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::BatchExecuteStatementInput> {
    &self.sdk_input
}
}
impl BatchExecuteStatementInputTransformInput {
...
pub struct BatchExecuteStatementInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::BatchExecuteStatementInput>,
}
impl BatchExecuteStatementInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::BatchExecuteStatementInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::BatchExecuteStatementInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::BatchExecuteStatementInput> {
    &self.sdk_input
}
