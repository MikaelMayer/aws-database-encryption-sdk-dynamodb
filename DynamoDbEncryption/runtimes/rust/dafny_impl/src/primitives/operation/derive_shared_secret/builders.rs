...
pub use crate::primitives::operation::derive_shared_secret::_derive_shared_secret_output::DeriveSharedSecretOutputBuilder;

pub use crate::primitives::operation::derive_shared_secret::_derive_shared_secret_input::DeriveSharedSecretInputBuilder;
...
pub struct DeriveSharedSecretFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder,
}
impl DeriveSharedSecretFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::derive_shared_secret::DeriveSharedSecret::send(&self.client, input).await
    }
