...
pub struct DescribeContinuousBackupsFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder,
}
impl DescribeContinuousBackupsFluentBuilder {
    ...
    > {
        ...
        crate::operation::describe_continuous_backups::DescribeContinuousBackups::send(&self.client, input).await
    }
