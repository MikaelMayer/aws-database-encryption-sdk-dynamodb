...
pub use crate::operation::generate_random_bytes::_generate_random_bytes_output::GenerateRandomBytesOutputBuilder;

pub use crate::operation::generate_random_bytes::_generate_random_bytes_input::GenerateRandomBytesInputBuilder;
...
pub struct GenerateRandomBytesFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::generate_random_bytes::builders::GenerateRandomBytesInputBuilder,
}
impl GenerateRandomBytesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::generate_random_bytes::builders::GenerateRandomBytesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::generate_random_bytes::GenerateRandomBytes::send(&self.client, input).await
    }
