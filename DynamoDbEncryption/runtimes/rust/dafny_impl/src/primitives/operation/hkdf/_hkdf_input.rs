...
impl HkdfInput {
    /// Creates a new builder-style object to manufacture [`HkdfInput`](crate::primitives::operation::hkdf::builders::HkdfInput).
    pub fn builder() -> crate::primitives::operation::hkdf::builders::HkdfInputBuilder {
        crate::primitives::operation::hkdf::builders::HkdfInputBuilder::default()
    }
}

/// A builder for [`HkdfInput`](crate::primitives::operation::operation::HkdfInput).
#[non_exhaustive]
#[derive(
...
pub fn get_salt(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`HkdfInput`](crate::primitives::operation::operation::HkdfInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::hkdf::HkdfInput {
