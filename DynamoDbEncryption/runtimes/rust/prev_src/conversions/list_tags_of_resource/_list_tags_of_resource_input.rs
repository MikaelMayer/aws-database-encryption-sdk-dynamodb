...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_tags_of_resource::ListTagsOfResourceInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListTagsOfResourceInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListTagsOfResourceInput::ListTagsOfResourceInput {
...
pub fn from_dafny(
    ...
    crate::operation::list_tags_of_resource::ListTagsOfResourceInput::builder()
