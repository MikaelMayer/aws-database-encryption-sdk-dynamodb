...
impl crate::client::Client {
    ...
    pub fn aes_kdf_counter_mode(&self) -> crate::operation::aes_kdf_counter_mode::builders::AesKdfCounterModeFluentBuilder {
        crate::operation::aes_kdf_counter_mode::builders::AesKdfCounterModeFluentBuilder::new(self.clone())
    }
}
