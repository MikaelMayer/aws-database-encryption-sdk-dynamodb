...
pub use crate::operation::encryption_materials_has_plaintext_data_key::_unit::UnitBuilder;

pub use crate::operation::encryption_materials_has_plaintext_data_key::_encryption_materials::EncryptionMaterialsBuilder;
...
pub struct EncryptionMaterialsHasPlaintextDataKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::encryption_materials_has_plaintext_data_key::builders::EncryptionMaterialsBuilder,
}
impl EncryptionMaterialsHasPlaintextDataKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::encryption_materials_has_plaintext_data_key::builders::EncryptionMaterialsBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::encryption_materials_has_plaintext_data_key::EncryptionMaterialsHasPlaintextDataKey::send(&self.client, input).await
    }
