...
pub fn from_dafny(
    ...
    aws_sdk_dynamodb::types::TableDescription::builder()
        .set_attribute_definitions(match (*dafny_value.AttributeDefinitions()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::attribute_definition::from_dafny(e.clone())
                }),
            ),
            _ => None,
        })
        ...
        .set_key_schema(match (*dafny_value.KeySchema()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::key_schema_element::from_dafny(e.clone())
                }),
            ),
            _ => None,
        })
        .set_table_status(match &**dafny_value.TableStatus() {
            crate::Wrappers::Option::Some { value } => {
                Some(crate::ddb::conversions::table_status::from_dafny(value))
            }
            _ => None,
        })
        ...
        .set_provisioned_throughput(match (*dafny_value.ProvisionedThroughput()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::provisioned_throughput_description::from_dafny(
                    value.clone(),
                ),
            ),
            _ => None,
        })
        .set_table_size_bytes(crate::ddb::standard_library_conversions::olong_from_dafny(
            dafny_value.TableSizeBytes().clone(),
        ))
        .set_item_count(crate::ddb::standard_library_conversions::olong_from_dafny(
        ...
        .set_billing_mode_summary(match (*dafny_value.BillingModeSummary()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::billing_mode_summary::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_local_secondary_indexes(match (*dafny_value.LocalSecondaryIndexes()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::local_secondary_index_description::from_dafny(
                        e.clone(),
                    )
                }),
            ),
        ...
        .set_global_secondary_indexes(match (*dafny_value.GlobalSecondaryIndexes()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::global_secondary_index_description::from_dafny(
                        e.clone(),
                    )
                }),
            ),
        ...
        .set_latest_stream_label(
            crate::ddb::standard_library_conversions::ostring_from_dafny(
                dafny_value.LatestStreamLabel().clone(),
            ),
        )
        .set_latest_stream_arn(
            crate::ddb::standard_library_conversions::ostring_from_dafny(
                dafny_value.LatestStreamArn().clone(),
            ),
        )
        .set_global_table_version(
            crate::ddb::standard_library_conversions::ostring_from_dafny(
        ...
        .set_replicas(match (*dafny_value.Replicas()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::replica_description::from_dafny(e.clone())
                }),
            ),
            _ => None,
        })
        .set_restore_summary(match (*dafny_value.RestoreSummary()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::restore_summary::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_sse_description(match (*dafny_value.SSEDescription()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::sse_description::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_archival_summary(match (*dafny_value.ArchivalSummary()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::archival_summary::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_table_class_summary(match (*dafny_value.TableClassSummary()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::table_class_summary::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .build()
