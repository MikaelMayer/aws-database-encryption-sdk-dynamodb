...
pub use crate::operation::create_aws_kms_ecdh_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_aws_kms_ecdh_keyring::_create_aws_kms_ecdh_keyring_input::CreateAwsKmsEcdhKeyringInputBuilder;
...
impl CreateAwsKmsEcdhKeyringInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::create_aws_kms_ecdh_keyring::CreateKeyringOutput,
...
pub struct CreateAwsKmsEcdhKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringInputBuilder,
}
impl CreateAwsKmsEcdhKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_aws_kms_ecdh_keyring::CreateAwsKmsEcdhKeyring::send(&self.client, input).await
    }
