...
pub use crate::operation::rsa_encrypt::_rsa_encrypt_output::RsaEncryptOutputBuilder;

pub use crate::operation::rsa_encrypt::_rsa_encrypt_input::RsaEncryptInputBuilder;
...
pub struct RsaEncryptFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::rsa_encrypt::builders::RsaEncryptInputBuilder,
}
impl RsaEncryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::rsa_encrypt::builders::RsaEncryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::rsa_encrypt::RsaEncrypt::send(&self.client, input).await
    }
