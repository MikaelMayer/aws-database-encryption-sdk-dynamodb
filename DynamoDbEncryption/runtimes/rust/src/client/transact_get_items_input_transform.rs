...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::TransactGetItemsInput>>)`](crate::operation::transact_get_items_input_transform::builders::TransactGetItemsInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::TransactGetItemsInput>)`](crate::operation::transact_get_items_input_transform::builders::TransactGetItemsInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::TransactGetItemsInput>)`](crate::operation::transact_get_items_input_transform::TransactGetItemsInputTransformOutput::transformed_input): (undocumented)
