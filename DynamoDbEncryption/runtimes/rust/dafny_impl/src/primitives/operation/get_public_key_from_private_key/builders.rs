...
pub use crate::primitives::operation::get_public_key_from_private_key::_get_public_key_from_private_key_output::GetPublicKeyFromPrivateKeyOutputBuilder;

pub use crate::primitives::operation::get_public_key_from_private_key::_get_public_key_from_private_key_input::GetPublicKeyFromPrivateKeyInputBuilder;
...
pub struct GetPublicKeyFromPrivateKeyFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInputBuilder,
}
impl GetPublicKeyFromPrivateKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::get_public_key_from_private_key::GetPublicKeyFromPrivateKey::send(&self.client, input).await
    }
