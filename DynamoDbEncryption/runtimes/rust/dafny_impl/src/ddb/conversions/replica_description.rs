...
pub fn to_dafny(
  ...
  ::std::rc::Rc::new(
    crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::ReplicaDescription::ReplicaDescription {
        RegionName: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.region_name),
 ReplicaStatus: ::std::rc::Rc::new(match &value.replica_status {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::replica_status::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
 ReplicaStatusDescription: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.replica_status_description),
 ReplicaStatusPercentProgress: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.replica_status_percent_progress),
 ...
 GlobalSecondaryIndexes: ::std::rc::Rc::new(match &value.global_secondary_indexes {
    Some(x) => crate::Wrappers::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| crate::ddb::conversions::replica_global_secondary_index_description::to_dafny(e)
,
        )
    },
    None => crate::Wrappers::Option::None {}
...
,
 ReplicaInaccessibleDateTime: crate::ddb::standard_library_conversions::otimestamp_to_dafny(&value.replica_inaccessible_date_time),
...
pub fn from_dafny(
    ...
    aws_sdk_dynamodb::types::ReplicaDescription::builder()
          .set_region_name(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.RegionName().clone()))
 .set_replica_status(match &**dafny_value.ReplicaStatus() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::replica_status::from_dafny(value)
    ),
    _ => None,
}
)
 .set_replica_status_description(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.ReplicaStatusDescription().clone()))
 .set_replica_status_percent_progress(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.ReplicaStatusPercentProgress().clone()))
 ...
 .set_provisioned_throughput_override(match (*dafny_value.ProvisionedThroughputOverride()).as_ref() {
    crate::Wrappers::Option::Some { value } =>
        Some(crate::ddb::conversions::provisioned_throughput_override::from_dafny(value.clone())),
    _ => None,
}
)
    ...
    crate::Wrappers::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| crate::ddb::conversions::replica_global_secondary_index_description::from_dafny(e.clone())
,
            )
        ),
    _ => None
 ...
 .set_replica_inaccessible_date_time(crate::ddb::standard_library_conversions::otimestamp_from_dafny(dafny_value.ReplicaInaccessibleDateTime().clone()))
