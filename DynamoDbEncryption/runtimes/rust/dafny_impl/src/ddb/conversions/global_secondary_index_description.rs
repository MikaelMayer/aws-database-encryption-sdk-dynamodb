...
pub fn from_dafny(
    ...
    aws_sdk_dynamodb::types::GlobalSecondaryIndexDescription::builder()
        ...
        .set_projection(match (*dafny_value.Projection()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::projection::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_index_status(match &**dafny_value.IndexStatus() {
            crate::Wrappers::Option::Some { value } => {
                Some(crate::ddb::conversions::index_status::from_dafny(value))
            }
            _ => None,
        })
        .set_backfilling(crate::ddb::standard_library_conversions::obool_from_dafny(
        ...
        .set_index_size_bytes(crate::ddb::standard_library_conversions::olong_from_dafny(
