...
impl HkdfExtractInput {
    ...
    pub fn builder() -> crate::operation::hkdf_extract::builders::HkdfExtractInputBuilder {
        crate::operation::hkdf_extract::builders::HkdfExtractInputBuilder::default()
    }
}
...
pub fn get_salt(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::hkdf_extract::HkdfExtractInput {
