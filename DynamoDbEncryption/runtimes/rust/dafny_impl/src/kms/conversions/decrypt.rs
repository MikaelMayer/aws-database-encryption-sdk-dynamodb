    ...
    match value {
        aws_sdk_kms::error::SdkError::ServiceError(service_error) => match service_error.err() {
            ...
            aws_sdk_kms::operation::decrypt::DecryptError::InvalidCiphertextException(e) => {
                crate::kms::conversions::error::invalid_ciphertext_exception::to_dafny(e.clone())
            }
            ...
            aws_sdk_kms::operation::decrypt::DecryptError::IncorrectKeyException(e) => {
                crate::kms::conversions::error::incorrect_key_exception::to_dafny(e.clone())
            }
            e => crate::kms::conversions::error::to_opaque_error(e.to_string()),
        },
        _ => crate::kms::conversions::error::to_opaque_error(value.to_string()),
    }
}
