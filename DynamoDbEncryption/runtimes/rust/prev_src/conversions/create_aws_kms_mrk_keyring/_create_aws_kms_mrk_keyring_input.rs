...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_aws_kms_mrk_keyring::CreateAwsKmsMrkKeyringInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateAwsKmsMrkKeyringInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateAwsKmsMrkKeyringInput::CreateAwsKmsMrkKeyringInput {
...
pub fn from_dafny(
    ...
    crate::operation::create_aws_kms_mrk_keyring::CreateAwsKmsMrkKeyringInput::builder()
