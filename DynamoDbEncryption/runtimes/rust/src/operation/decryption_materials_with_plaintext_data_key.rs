...
impl DecryptionMaterialsWithPlaintextDataKey {
    ...
    > {
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::decryption_materials_with_plaintext_data_key::_decryption_materials_with_plaintext_data_key_output::from_dafny(inner_result.value().clone()),
            )
        } else {
