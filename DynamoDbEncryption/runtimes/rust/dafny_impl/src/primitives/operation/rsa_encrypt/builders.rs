...
pub use crate::primitives::operation::rsa_encrypt::_rsa_encrypt_output::RsaEncryptOutputBuilder;

pub use crate::primitives::operation::rsa_encrypt::_rsa_encrypt_input::RsaEncryptInputBuilder;
...
pub struct RsaEncryptFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::rsa_encrypt::builders::RsaEncryptInputBuilder,
}
impl RsaEncryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::rsa_encrypt::builders::RsaEncryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::rsa_encrypt::RsaEncrypt::send(&self.client, input).await
    }
