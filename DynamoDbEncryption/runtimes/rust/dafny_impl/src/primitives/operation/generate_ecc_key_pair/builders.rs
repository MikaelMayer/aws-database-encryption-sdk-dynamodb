...
pub use crate::primitives::operation::generate_ecc_key_pair::_generate_ecc_key_pair_output::GenerateEccKeyPairOutputBuilder;

pub use crate::primitives::operation::generate_ecc_key_pair::_generate_ecc_key_pair_input::GenerateEccKeyPairInputBuilder;
...
pub struct GenerateEccKeyPairFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairInputBuilder,
}
impl GenerateEccKeyPairFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::generate_ecc_key_pair::GenerateEccKeyPair::send(&self.client, input).await
    }
