...
pub use crate::operation::get_public_key::_get_public_key_response::GetPublicKeyResponseBuilder;

pub use crate::operation::get_public_key::_get_public_key_request::GetPublicKeyRequestBuilder;
...
pub struct GetPublicKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_public_key::builders::GetPublicKeyRequestBuilder,
}
impl GetPublicKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_public_key::builders::GetPublicKeyRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_public_key::GetPublicKey::send(&self.client, input).await
    }
