...
impl AesDecryptInput {
    ...
    pub fn builder() -> crate::operation::aes_decrypt::builders::AesDecryptInputBuilder {
        crate::operation::aes_decrypt::builders::AesDecryptInputBuilder::default()
    }
}
...
pub fn get_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::aes_decrypt::AesDecryptInput {
            aad: self.aad,
