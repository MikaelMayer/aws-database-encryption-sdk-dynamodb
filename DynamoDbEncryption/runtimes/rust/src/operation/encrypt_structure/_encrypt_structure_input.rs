...
pub struct EncryptStructureInput {
    #[allow(missing_docs)] // documentation missing in model
pub algorithm_suite_id: ::std::option::Option<material_providers::types::DbeAlgorithmSuiteId>,
#[allow(missing_docs)] // documentation missing in model
...
impl EncryptStructureInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite_id(&self) -> &::std::option::Option<material_providers::types::DbeAlgorithmSuiteId> {
...
impl EncryptStructureInput {
    /// Creates a new builder-style object to manufacture [`EncryptStructureInput`](crate::operation::encrypt_structure::builders::EncryptStructureInput).
    pub fn builder() -> crate::operation::encrypt_structure::builders::EncryptStructureInputBuilder {
        crate::operation::encrypt_structure::builders::EncryptStructureInputBuilder::default()
    }
}

/// A builder for [`EncryptStructureInput`](crate::operation::operation::EncryptStructureInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct EncryptStructureInputBuilder {
    pub(crate) algorithm_suite_id: ::std::option::Option<material_providers::types::DbeAlgorithmSuiteId>,
...
pub fn get_table_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`EncryptStructureInput`](crate::operation::operation::EncryptStructureInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::encrypt_structure::EncryptStructureInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::encrypt_structure::EncryptStructureInput {
