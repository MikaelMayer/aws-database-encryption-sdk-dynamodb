...
impl RsaEncryptOutput {
    ...
    pub fn builder() -> crate::operation::rsa_encrypt::builders::RsaEncryptOutputBuilder {
        crate::operation::rsa_encrypt::builders::RsaEncryptOutputBuilder::default()
    }
}
...
pub fn get_cipher_text(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::rsa_encrypt::RsaEncryptOutput {
