...
impl GetBranchKeyVersionInput {
    /// Creates a new builder-style object to manufacture [`GetBranchKeyVersionInput`](crate::material_providers::operation::get_branch_key_version::builders::GetBranchKeyVersionInput).
    pub fn builder() -> crate::material_providers::operation::get_branch_key_version::builders::GetBranchKeyVersionInputBuilder {
        crate::material_providers::operation::get_branch_key_version::builders::GetBranchKeyVersionInputBuilder::default()
    }
}

/// A builder for [`GetBranchKeyVersionInput`](crate::material_providers::operation::operation::GetBranchKeyVersionInput).
#[non_exhaustive]
#[derive(
...
pub fn get_branch_key_version(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`GetBranchKeyVersionInput`](crate::material_providers::operation::operation::GetBranchKeyVersionInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::material_providers::operation::get_branch_key_version::GetBranchKeyVersionInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::material_providers::operation::get_branch_key_version::GetBranchKeyVersionInput {
