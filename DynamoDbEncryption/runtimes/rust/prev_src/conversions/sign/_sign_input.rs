...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::sign::SignRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::SignRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::SignRequest::SignRequest {
...
pub fn from_dafny(
    ...
    crate::operation::sign::SignRequest::builder()
