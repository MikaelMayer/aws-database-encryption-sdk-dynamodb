...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_tables::ListTablesOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListTablesOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListTablesOutput::ListTablesOutput {
...
pub fn from_dafny(
    ...
    crate::operation::list_tables::ListTablesOutput::builder()
