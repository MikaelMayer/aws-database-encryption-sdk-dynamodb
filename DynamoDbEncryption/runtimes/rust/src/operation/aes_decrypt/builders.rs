...
pub use crate::operation::aes_decrypt::_aes_decrypt_output::AesDecryptOutputBuilder;

pub use crate::operation::aes_decrypt::_aes_decrypt_input::AesDecryptInputBuilder;
...
pub struct AesDecryptFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::aes_decrypt::builders::AesDecryptInputBuilder,
}
impl AesDecryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::aes_decrypt::builders::AesDecryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::aes_decrypt::AesDecrypt::send(&self.client, input).await
    }
