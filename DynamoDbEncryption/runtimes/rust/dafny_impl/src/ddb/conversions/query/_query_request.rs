...
> {
 ...
 Select: ::std::rc::Rc::new(match &value.select {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::select::to_dafny(x.clone()) },
...
,
 ...
 ConsistentRead: crate::ddb::standard_library_conversions::obool_to_dafny(&value.consistent_read),
 KeyConditions:
...
,
 ConditionalOperator: ::std::rc::Rc::new(match &value.conditional_operator {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::conditional_operator::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
 ScanIndexForward: crate::ddb::standard_library_conversions::obool_to_dafny(&value.scan_index_forward),
 ExclusiveStartKey:
...
,
 ProjectionExpression: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.projection_expression),
 FilterExpression: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.filter_expression),
 KeyConditionExpression: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.key_condition_expression),
...
pub fn from_dafny(
 ...
 .set_select(match &**dafny_value.Select() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::select::from_dafny(value)
    ),
    _ => None,
}
)
    ...
    crate::Wrappers::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                ...
                |v| crate::ddb::conversions::condition::from_dafny(v.clone())
,
            )
        ),
    _ => None
...
,
 ...
 .set_conditional_operator(match &**dafny_value.ConditionalOperator() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::conditional_operator::from_dafny(value)
    ),
    _ => None,
}
)
 .set_scan_index_forward(crate::ddb::standard_library_conversions::obool_from_dafny(dafny_value.ScanIndexForward().clone()))
 .set_exclusive_start_key(match (*dafny_value.ExclusiveStartKey()).as_ref() {
    crate::Wrappers::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(k),
                |v| crate::ddb::conversions::attribute_value::from_dafny(v.clone())
,
            )
        ),
    _ => None
 ...
 .set_projection_expression(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.ProjectionExpression().clone()))
 .set_filter_expression(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.FilterExpression().clone()))
 .set_key_condition_expression(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.KeyConditionExpression().clone()))
