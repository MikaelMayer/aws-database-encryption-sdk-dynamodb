...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::UpdateItemInput>>)`](crate::operation::update_item_input_transform::builders::UpdateItemInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::UpdateItemInput>)`](crate::operation::update_item_input_transform::builders::UpdateItemInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::UpdateItemInput>)`](crate::operation::update_item_input_transform::UpdateItemInputTransformOutput::transformed_input): (undocumented)
