...
impl crate::client::Client {
    ...
    ///   - [`ecc_curve(impl Into<Option<primitives::types::EcdhCurveSpec>>)`](crate::operation::validate_public_key::builders::ValidatePublicKeyFluentBuilder::ecc_curve) / [`set_ecc_curve(Option<primitives::types::EcdhCurveSpec>)`](crate::operation::validate_public_key::builders::ValidatePublicKeyFluentBuilder::set_ecc_curve): (undocumented)<br>
    ...
    pub fn validate_public_key(&self) -> crate::operation::validate_public_key::builders::ValidatePublicKeyFluentBuilder {
        crate::operation::validate_public_key::builders::ValidatePublicKeyFluentBuilder::new(self.clone())
    }
}
