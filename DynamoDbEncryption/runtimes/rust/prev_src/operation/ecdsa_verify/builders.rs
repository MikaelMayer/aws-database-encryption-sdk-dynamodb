...
pub use crate::operation::ecdsa_verify::_ecdsa_verify_output::EcdsaVerifyOutputBuilder;

pub use crate::operation::ecdsa_verify::_ecdsa_verify_input::EcdsaVerifyInputBuilder;
...
pub struct EcdsaVerifyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder,
}
impl EcdsaVerifyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::ecdsa_verify::EcdsaVerify::send(&self.client, input).await
    }
