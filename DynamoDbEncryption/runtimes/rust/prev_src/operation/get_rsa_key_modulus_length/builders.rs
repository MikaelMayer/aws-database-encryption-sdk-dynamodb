...
pub use crate::operation::get_rsa_key_modulus_length::_get_rsa_key_modulus_length_output::GetRsaKeyModulusLengthOutputBuilder;

pub use crate::operation::get_rsa_key_modulus_length::_get_rsa_key_modulus_length_input::GetRsaKeyModulusLengthInputBuilder;
...
pub struct GetRsaKeyModulusLengthFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthInputBuilder,
}
impl GetRsaKeyModulusLengthFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_rsa_key_modulus_length::GetRsaKeyModulusLength::send(&self.client, input).await
    }
