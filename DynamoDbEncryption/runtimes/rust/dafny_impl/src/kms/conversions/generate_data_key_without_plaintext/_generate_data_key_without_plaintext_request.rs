...
,
 KeySpec: ::std::rc::Rc::new(match &value.key_spec {
    Some(x) => crate::Wrappers::Option::Some { value: crate::kms::conversions::data_key_spec::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
 NumberOfBytes: crate::kms::standard_library_conversions::oint_to_dafny(value.number_of_bytes),
...
pub fn from_dafny(
 ...
 .set_key_spec(match &**dafny_value.KeySpec() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::kms::conversions::data_key_spec::from_dafny(value)
    ),
    _ => None,
}
)
 .set_number_of_bytes(crate::kms::standard_library_conversions::oint_from_dafny(dafny_value.NumberOfBytes().clone()))
