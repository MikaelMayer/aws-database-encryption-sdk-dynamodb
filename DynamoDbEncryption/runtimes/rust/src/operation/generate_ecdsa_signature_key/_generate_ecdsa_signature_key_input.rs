...
impl GenerateEcdsaSignatureKeyInput {
    ...
    pub fn builder() -> crate::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyInputBuilder {
        crate::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyInputBuilder::default()
    }
}
...
pub fn get_signature_algorithm(&self) -> &::std::option::Option<primitives::types::EcdsaSignatureAlgorithm> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_ecdsa_signature_key::GenerateEcdsaSignatureKeyInput {
