...
,
 ComparisonOperator: crate::ddb::conversions::comparison_operator::to_dafny(value.comparison_operator.clone()),
    }
  )
} #[allow(dead_code)]
pub fn from_dafny(
...
,
 ...
 .set_comparison_operator(Some( crate::ddb::conversions::comparison_operator::from_dafny(dafny_value.ComparisonOperator()) ))
          .build()
          .unwrap()
}
