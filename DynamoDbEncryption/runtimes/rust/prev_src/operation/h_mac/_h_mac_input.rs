...
impl HMacInput {
    ...
    pub fn builder() -> crate::operation::h_mac::builders::HMacInputBuilder {
        crate::operation::h_mac::builders::HMacInputBuilder::default()
    }
}
...
pub fn get_message(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::h_mac::HMacInput {
