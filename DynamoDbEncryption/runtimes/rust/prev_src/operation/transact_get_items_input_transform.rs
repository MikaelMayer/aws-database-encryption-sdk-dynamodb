...
impl TransactGetItemsInputTransform {
    ...
    > {
        ...
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).TransactGetItemsInputTransform(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(
                crate::conversions::transact_get_items_input_transform::_transact_get_items_input_transform_output::from_dafny(
