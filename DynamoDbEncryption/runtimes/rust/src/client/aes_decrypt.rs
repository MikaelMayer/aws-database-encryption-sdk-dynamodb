...
impl crate::client::Client {
    ...
    ///   - [`enc_alg(impl Into<Option<primitives::types::AesGcm>>)`](crate::operation::aes_decrypt::builders::AESDecryptFluentBuilder::enc_alg) / [`set_enc_alg(Option<primitives::types::AesGcm>)`](crate::operation::aes_decrypt::builders::AESDecryptFluentBuilder::set_enc_alg): (undocumented)<br>
    ...
    pub fn aes_decrypt(&self) -> crate::operation::aes_decrypt::builders::AesDecryptFluentBuilder {
        crate::operation::aes_decrypt::builders::AesDecryptFluentBuilder::new(self.clone())
    }
}
