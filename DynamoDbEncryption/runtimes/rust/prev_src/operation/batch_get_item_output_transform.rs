...
impl BatchGetItemOutputTransform {
    ...
    > {
        ...
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).BatchGetItemOutputTransform(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(
                crate::conversions::batch_get_item_output_transform::_batch_get_item_output_transform_output::from_dafny(
