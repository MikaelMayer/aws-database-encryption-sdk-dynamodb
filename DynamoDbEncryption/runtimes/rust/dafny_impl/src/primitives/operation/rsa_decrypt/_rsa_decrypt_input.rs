...
#[allow(missing_docs)] // documentation missing in model
pub padding: ::std::option::Option<crate::primitives::types::RsaPaddingMode>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding(&self) -> &::std::option::Option<crate::primitives::types::RsaPaddingMode> {
    &self.padding
}
#[allow(missing_docs)] // documentation missing in model
...
impl RsaDecryptInput {
    /// Creates a new builder-style object to manufacture [`RsaDecryptInput`](crate::primitives::operation::rsa_decrypt::builders::RsaDecryptInput).
    pub fn builder() -> crate::primitives::operation::rsa_decrypt::builders::RsaDecryptInputBuilder {
        crate::primitives::operation::rsa_decrypt::builders::RsaDecryptInputBuilder::default()
    }
}

/// A builder for [`RsaDecryptInput`](crate::primitives::operation::operation::RsaDecryptInput).
#[non_exhaustive]
#[derive(
...
pub(crate) padding: ::std::option::Option<crate::primitives::types::RsaPaddingMode>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding(mut self, input: impl ::std::convert::Into<crate::primitives::types::RsaPaddingMode>) -> Self {
    self.padding = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_padding(mut self, input: ::std::option::Option<crate::primitives::types::RsaPaddingMode>) -> Self {
    self.padding = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_padding(&self) -> &::std::option::Option<crate::primitives::types::RsaPaddingMode> {
    &self.padding
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_private_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`RsaDecryptInput`](crate::primitives::operation::operation::RsaDecryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::rsa_decrypt::RsaDecryptInput {
