...
impl GetPublicKeyFromPrivateKeyInput {
    ...
    pub fn builder() -> crate::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInputBuilder {
        crate::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInputBuilder::default()
    }
}
...
pub fn get_private_key(&self) -> &::std::option::Option<primitives::types::EccPrivateKey> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_public_key_from_private_key::GetPublicKeyFromPrivateKeyInput {
