...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::verify_mac::VerifyMacRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::VerifyMacRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::VerifyMacRequest::VerifyMacRequest {
...
pub fn from_dafny(
    ...
    crate::operation::verify_mac::VerifyMacRequest::builder()
