...
impl crate::client::Client {
    ...
    pub fn get_rsa_key_modulus_length(&self) -> crate::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthFluentBuilder {
        crate::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthFluentBuilder::new(self.clone())
    }
}
