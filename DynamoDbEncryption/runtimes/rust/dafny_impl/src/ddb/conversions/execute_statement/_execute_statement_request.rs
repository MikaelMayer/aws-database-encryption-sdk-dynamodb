...
>{
    ::std::rc::Rc::new(crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::ExecuteStatementInput::ExecuteStatementInput {
        Statement: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.statement) .Extract(),
...
,
 ...
 NextToken: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.next_token),
