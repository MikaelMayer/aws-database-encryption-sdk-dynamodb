...
pub fn to_dafny(
 ...
 CapacityUnits: crate::ddb::standard_library_conversions::odouble_to_dafny(&value.capacity_units),
 ReadCapacityUnits: crate::ddb::standard_library_conversions::odouble_to_dafny(&value.read_capacity_units),
 WriteCapacityUnits: crate::ddb::standard_library_conversions::odouble_to_dafny(&value.write_capacity_units),
 Table: ::std::rc::Rc::new(match &value.table {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::capacity::to_dafny(x) },
...
::std::rc::Rc::new(match &value.local_secondary_indexes {
    Some(x) => crate::Wrappers::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::hashmap_to_dafny_map(x,
            ...
            |v| crate::ddb::conversions::capacity::to_dafny(v)
,
        )
    },
    None => crate::Wrappers::Option::None {}
...
pub fn from_dafny(
 ...
 .set_capacity_units(crate::ddb::standard_library_conversions::odouble_from_dafny(dafny_value.CapacityUnits().clone()))
 .set_read_capacity_units(crate::ddb::standard_library_conversions::odouble_from_dafny(dafny_value.ReadCapacityUnits().clone()))
 .set_write_capacity_units(crate::ddb::standard_library_conversions::odouble_from_dafny(dafny_value.WriteCapacityUnits().clone()))
 .set_table(match (*dafny_value.Table()).as_ref() {
    crate::Wrappers::Option::Some { value } =>
        Some(crate::ddb::conversions::capacity::from_dafny(value.clone())),
    _ => None,
}
)
    ...
    crate::Wrappers::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                ...
                |v| crate::ddb::conversions::capacity::from_dafny(v.clone())
,
            )
        ),
    _ => None
