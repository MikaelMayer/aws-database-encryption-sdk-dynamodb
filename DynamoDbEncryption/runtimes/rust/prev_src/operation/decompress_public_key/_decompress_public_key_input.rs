...
impl DecompressPublicKeyInput {
    ...
    pub fn builder() -> crate::operation::decompress_public_key::builders::DecompressPublicKeyInputBuilder {
        crate::operation::decompress_public_key::builders::DecompressPublicKeyInputBuilder::default()
    }
}
...
pub fn get_ecc_curve(&self) -> &::std::option::Option<primitives::types::EcdhCurveSpec> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decompress_public_key::DecompressPublicKeyInput {
