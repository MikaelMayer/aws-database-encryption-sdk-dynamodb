...
fn convert_algorithm(
    input: &_software_damazon_dcryptography_dprimitives_dinternaldafny_dtypes::DigestAlgorithm,
) -> hmac::Algorithm {
    match input {
...
impl crate::HMAC::_default {
    ...
    pub fn Digest(
        input: &::std::rc::Rc<
            crate::r#_software_damazon_dcryptography_dprimitives_dinternaldafny_dtypes::HMacInput,
        >,
    ) -> ::std::rc::Rc<
        Wrappers::Result<
...
pub mod HMAC {
    ...
    impl HMac {
        ...
        pub fn Build(
            input: &::std::rc::Rc<r#_software_damazon_dcryptography_dprimitives_dinternaldafny_dtypes::DigestAlgorithm>,
        ) -> ::std::rc::Rc<
            Wrappers::Result<
