...
impl CompressPublicKeyOutput {
    ...
    pub fn builder() -> crate::operation::compress_public_key::builders::CompressPublicKeyOutputBuilder {
        crate::operation::compress_public_key::builders::CompressPublicKeyOutputBuilder::default()
    }
}
...
pub fn get_compressed_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::compress_public_key::CompressPublicKeyOutput {
