...
pub use crate::operation::kdf_counter_mode::_kdf_ctr_output::KdfCtrOutputBuilder;

pub use crate::operation::kdf_counter_mode::_kdf_ctr_input::KdfCtrInputBuilder;
...
pub struct KdfCounterModeFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::kdf_counter_mode::builders::KdfCtrInputBuilder,
}
impl KdfCounterModeFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::kdf_counter_mode::builders::KdfCtrInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::kdf_counter_mode::KdfCounterMode::send(&self.client, input).await
    }
