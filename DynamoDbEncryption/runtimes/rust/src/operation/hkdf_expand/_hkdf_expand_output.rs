...
impl HkdfExpandOutput {
    ...
    pub fn builder() -> crate::operation::hkdf_expand::builders::HkdfExpandOutputBuilder {
        crate::operation::hkdf_expand::builders::HkdfExpandOutputBuilder::default()
    }
}
...
pub fn get_okm(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::hkdf_expand::HkdfExpandOutput {
            okm: self.okm,
        })
    }
}
