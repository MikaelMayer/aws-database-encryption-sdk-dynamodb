...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::encrypt::EncryptRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EncryptRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EncryptRequest::EncryptRequest {
...
pub fn from_dafny(
    ...
    crate::operation::encrypt::EncryptRequest::builder()
