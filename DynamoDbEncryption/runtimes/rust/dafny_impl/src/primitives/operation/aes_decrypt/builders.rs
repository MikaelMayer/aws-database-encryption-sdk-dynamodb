...
pub use crate::primitives::operation::aes_decrypt::_aes_decrypt_output::AesDecryptOutputBuilder;

pub use crate::primitives::operation::aes_decrypt::_aes_decrypt_input::AesDecryptInputBuilder;
...
pub struct AesDecryptFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::aes_decrypt::builders::AesDecryptInputBuilder,
}
impl AesDecryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::aes_decrypt::builders::AesDecryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::aes_decrypt::AesDecrypt::send(&self.client, input).await
    }
