...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_key_description::UpdateKeyDescriptionRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateKeyDescriptionRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateKeyDescriptionRequest::UpdateKeyDescriptionRequest {
...
pub fn from_dafny(
    ...
    crate::operation::update_key_description::UpdateKeyDescriptionRequest::builder()
