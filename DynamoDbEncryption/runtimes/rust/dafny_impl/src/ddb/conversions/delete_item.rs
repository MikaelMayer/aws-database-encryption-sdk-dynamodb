...
> {
    match value {
      aws_sdk_dynamodb::error::SdkError::ServiceError(service_error) => match service_error.err() {
            ...
            crate::ddb::conversions::error::internal_server_error::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::InvalidEndpointException(e) =>
            crate::ddb::conversions::error::invalid_endpoint_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::ResourceNotFoundException(e) =>
            crate::ddb::conversions::error::resource_not_found_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::RequestLimitExceeded(e) =>
            crate::ddb::conversions::error::request_limit_exceeded::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::TransactionConflictException(e) =>
            crate::ddb::conversions::error::transaction_conflict_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::ConditionalCheckFailedException(e) =>
            crate::ddb::conversions::error::conditional_check_failed_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::ItemCollectionSizeLimitExceededException(e) =>
            crate::ddb::conversions::error::item_collection_size_limit_exceeded_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::delete_item::DeleteItemError::ProvisionedThroughputExceededException(e) =>
            crate::ddb::conversions::error::provisioned_throughput_exceeded_exception::to_dafny(e.clone()),
        e => crate::ddb::conversions::error::to_opaque_error(e.to_string()),
      },
      _ => {
        crate::ddb::conversions::error::to_opaque_error(value.to_string())
      }
   }
}
