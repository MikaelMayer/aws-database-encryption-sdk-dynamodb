...
pub use crate::primitives::operation::ecdsa_verify::_ecdsa_verify_output::EcdsaVerifyOutputBuilder;

pub use crate::primitives::operation::ecdsa_verify::_ecdsa_verify_input::EcdsaVerifyInputBuilder;
...
pub struct EcdsaVerifyFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder,
}
impl EcdsaVerifyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::ecdsa_verify::EcdsaVerify::send(&self.client, input).await
    }
