...
pub use crate::operation::aes_encrypt::_aes_encrypt_output::AesEncryptOutputBuilder;

pub use crate::operation::aes_encrypt::_aes_encrypt_input::AesEncryptInputBuilder;
...
pub struct AesEncryptFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::aes_encrypt::builders::AesEncryptInputBuilder,
}
impl AesEncryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::aes_encrypt::builders::AesEncryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::aes_encrypt::AesEncrypt::send(&self.client, input).await
    }
...
#[allow(missing_docs)] // documentation missing in model
pub fn enc_alg(mut self, input: impl ::std::convert::Into<primitives::types::AesGcm>) -> Self {
    self.inner = self.inner.enc_alg(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_enc_alg(mut self, input: ::std::option::Option<primitives::types::AesGcm>) -> Self {
    self.inner = self.inner.set_enc_alg(input);
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_enc_alg(&self) -> &::std::option::Option<primitives::types::AesGcm> {
