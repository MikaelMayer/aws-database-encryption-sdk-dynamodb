...
impl AesKdfCtrOutput {
    ...
    pub fn builder() -> crate::operation::aes_kdf_counter_mode::builders::AesKdfCtrOutputBuilder {
        crate::operation::aes_kdf_counter_mode::builders::AesKdfCtrOutputBuilder::default()
    }
}
...
pub fn get_okm(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::aes_kdf_counter_mode::AesKdfCtrOutput {
            okm: self.okm,
        })
    }
}
