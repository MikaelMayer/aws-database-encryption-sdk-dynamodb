...
impl CreateAwsKmsMrkKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_mrk_keyring::builders::CreateAwsKmsMrkKeyringInputBuilder {
        crate::operation::create_aws_kms_mrk_keyring::builders::CreateAwsKmsMrkKeyringInputBuilder::default()
    }
}
...
pub fn get_kms_key_id(&self) -> &::std::option::Option<::std::string::String> {
    ...
    pub fn build(
        ...
        crate::operation::create_aws_kms_mrk_keyring::CreateAwsKmsMrkKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_mrk_keyring::CreateAwsKmsMrkKeyringInput {
