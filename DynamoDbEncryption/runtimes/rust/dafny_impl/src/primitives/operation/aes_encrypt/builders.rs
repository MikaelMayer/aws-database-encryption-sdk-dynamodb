...
pub use crate::primitives::operation::aes_encrypt::_aes_encrypt_output::AesEncryptOutputBuilder;

pub use crate::primitives::operation::aes_encrypt::_aes_encrypt_input::AesEncryptInputBuilder;
...
pub struct AesEncryptFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::aes_encrypt::builders::AesEncryptInputBuilder,
}
impl AesEncryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::aes_encrypt::builders::AesEncryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::aes_encrypt::AesEncrypt::send(&self.client, input).await
    }
