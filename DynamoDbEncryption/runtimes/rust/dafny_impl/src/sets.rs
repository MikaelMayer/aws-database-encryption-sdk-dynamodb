...
pub mod SortedSets {
  ...
  impl _default {
    ...
    pub fn SetToOrderedSequence2<T: ::dafny_runtime::DafnyTypeEq>(_elems: &::dafny_runtime::Set<::dafny_runtime::Sequence<T>>, less: &::std::rc::Rc<dyn Fn(&T, &T) -> bool>) -> ::dafny_runtime::Sequence<::dafny_runtime::Sequence<T>> {
