...
impl crate::client::Client {
    ...
    ///   - [`digest_algorithm(impl Into<Option<primitives::types::DigestAlgorithm>>)`](crate::operation::hkdf::builders::HkdfFluentBuilder::digest_algorithm) / [`set_digest_algorithm(Option<primitives::types::DigestAlgorithm>)`](crate::operation::hkdf::builders::HkdfFluentBuilder::set_digest_algorithm): (undocumented)<br>
    ...
    pub fn hkdf(&self) -> crate::operation::hkdf::builders::HkdfFluentBuilder {
        crate::operation::hkdf::builders::HkdfFluentBuilder::new(self.clone())
    }
}
