...
impl DecryptItemOutput {
    ...
    pub fn builder() -> crate::operation::decrypt_item::builders::DecryptItemOutputBuilder {
        crate::operation::decrypt_item::builders::DecryptItemOutputBuilder::default()
    }
}
...
pub fn get_plaintext_item(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, dynamodb::types::AttributeValue>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decrypt_item::DecryptItemOutput {
