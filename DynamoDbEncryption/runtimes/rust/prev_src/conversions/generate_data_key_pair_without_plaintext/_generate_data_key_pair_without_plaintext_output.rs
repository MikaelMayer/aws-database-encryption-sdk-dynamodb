...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyPairWithoutPlaintextResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyPairWithoutPlaintextResponse::GenerateDataKeyPairWithoutPlaintextResponse {
 ...
 KeyPairSpec: ::std::rc::Rc::new(match &value.key_pair_spec {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::data_key_pair_spec::to_dafny(x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextResponse::builder()
 ...
 .set_key_pair_spec(match &**dafny_value.KeyPairSpec() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        kms::conversions::data_key_pair_spec::from_dafny(value)
    ),
    _ => None,
}
)
