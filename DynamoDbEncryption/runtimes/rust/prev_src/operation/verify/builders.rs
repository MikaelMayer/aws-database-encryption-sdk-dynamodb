...
pub use crate::operation::verify::_verify_response::VerifyResponseBuilder;

pub use crate::operation::verify::_verify_request::VerifyRequestBuilder;
...
pub struct VerifyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::verify::builders::VerifyRequestBuilder,
}
impl VerifyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::verify::builders::VerifyRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::verify::Verify::send(&self.client, input).await
    }
