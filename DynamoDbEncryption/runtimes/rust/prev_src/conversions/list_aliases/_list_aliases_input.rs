...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_aliases::ListAliasesRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListAliasesRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListAliasesRequest::ListAliasesRequest {
...
pub fn from_dafny(
    ...
    crate::operation::list_aliases::ListAliasesRequest::builder()
