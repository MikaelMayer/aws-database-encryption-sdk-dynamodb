...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::primitives::operation::generate_random_bytes::GenerateRandomBytesInput,
) -> ::std::rc::Rc<
...
pub fn from_dafny(
    ...
    crate::primitives::operation::generate_random_bytes::GenerateRandomBytesInput::builder()
