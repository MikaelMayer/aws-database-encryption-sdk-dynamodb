...
pub struct ExecuteTransactionOutputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub original_input: ::std::option::Option<dynamodb::types::ExecuteTransactionInput>,
#[allow(missing_docs)] // documentation missing in model
pub sdk_output: ::std::option::Option<dynamodb::types::ExecuteTransactionOutput>,
}
impl ExecuteTransactionOutputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn original_input(&self) -> &::std::option::Option<dynamodb::types::ExecuteTransactionInput> {
    &self.original_input
}
#[allow(missing_docs)] // documentation missing in model
pub fn sdk_output(&self) -> &::std::option::Option<dynamodb::types::ExecuteTransactionOutput> {
    &self.sdk_output
}
}
impl ExecuteTransactionOutputTransformInput {
...
pub struct ExecuteTransactionOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<dynamodb::types::ExecuteTransactionInput>,
pub(crate) sdk_output: ::std::option::Option<dynamodb::types::ExecuteTransactionOutput>,
}
impl ExecuteTransactionOutputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn original_input(mut self, input: impl ::std::convert::Into<dynamodb::types::ExecuteTransactionInput>) -> Self {
    self.original_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_original_input(mut self, input: ::std::option::Option<dynamodb::types::ExecuteTransactionInput>) -> Self {
    self.original_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_original_input(&self) -> &::std::option::Option<dynamodb::types::ExecuteTransactionInput> {
    &self.original_input
}
#[allow(missing_docs)] // documentation missing in model
pub fn sdk_output(mut self, input: impl ::std::convert::Into<dynamodb::types::ExecuteTransactionOutput>) -> Self {
    self.sdk_output = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_output(mut self, input: ::std::option::Option<dynamodb::types::ExecuteTransactionOutput>) -> Self {
    self.sdk_output = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_output(&self) -> &::std::option::Option<dynamodb::types::ExecuteTransactionOutput> {
    &self.sdk_output
}
