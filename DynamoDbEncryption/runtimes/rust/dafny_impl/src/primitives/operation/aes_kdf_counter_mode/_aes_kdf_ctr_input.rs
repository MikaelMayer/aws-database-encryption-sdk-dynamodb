...
impl AesKdfCtrInput {
    /// Creates a new builder-style object to manufacture [`AesKdfCtrInput`](crate::primitives::operation::aes_kdf_counter_mode::builders::AesKdfCtrInput).
    pub fn builder() -> crate::primitives::operation::aes_kdf_counter_mode::builders::AesKdfCtrInputBuilder {
        crate::primitives::operation::aes_kdf_counter_mode::builders::AesKdfCtrInputBuilder::default()
    }
}

/// A builder for [`AesKdfCtrInput`](crate::primitives::operation::operation::AesKdfCtrInput).
#[non_exhaustive]
#[derive(
...
pub fn get_nonce(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`AesKdfCtrInput`](crate::primitives::operation::operation::AesKdfCtrInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::primitives::operation::aes_kdf_counter_mode::AesKdfCtrInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::primitives::operation::aes_kdf_counter_mode::AesKdfCtrInput {
