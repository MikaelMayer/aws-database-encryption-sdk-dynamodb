...
impl KdfCtrInput {
    /// Creates a new builder-style object to manufacture [`KdfCtrInput`](crate::primitives::operation::kdf_counter_mode::builders::KdfCtrInput).
    pub fn builder() -> crate::primitives::operation::kdf_counter_mode::builders::KdfCtrInputBuilder {
        crate::primitives::operation::kdf_counter_mode::builders::KdfCtrInputBuilder::default()
    }
}

/// A builder for [`KdfCtrInput`](crate::primitives::operation::operation::KdfCtrInput).
#[non_exhaustive]
#[derive(
...
pub fn get_purpose(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`KdfCtrInput`](crate::primitives::operation::operation::KdfCtrInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::kdf_counter_mode::KdfCtrInput {
