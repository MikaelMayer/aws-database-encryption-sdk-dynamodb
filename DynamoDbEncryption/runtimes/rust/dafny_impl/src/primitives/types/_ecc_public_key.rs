...
impl EccPublicKey {
    /// Creates a new builder-style object to manufacture [`EccPublicKey`](crate::primitives::types::EccPublicKey).
    pub fn builder() -> crate::primitives::types::builders::EccPublicKeyBuilder {
        crate::primitives::types::builders::EccPublicKeyBuilder::default()
    }
}

/// A builder for [`EccPublicKey`](crate::primitives::types::EccPublicKey).
#[non_exhaustive]
#[derive(
...
pub fn get_der(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`EccPublicKey`](crate::primitives::types::EccPublicKey).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::types::EccPublicKey {
            der: self.der,
        })
    }
}
