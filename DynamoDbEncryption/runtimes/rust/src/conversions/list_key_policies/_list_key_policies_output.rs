...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_key_policies::ListKeyPoliciesResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListKeyPoliciesResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListKeyPoliciesResponse::ListKeyPoliciesResponse {
...
pub fn from_dafny(
    ...
    crate::operation::list_key_policies::ListKeyPoliciesResponse::builder()
