...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::decrypt_structure::DecryptStructureOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptStructureOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptStructureOutput::DecryptStructureOutput {
...
pub fn from_dafny(
    ...
    crate::operation::decrypt_structure::DecryptStructureOutput::builder()
