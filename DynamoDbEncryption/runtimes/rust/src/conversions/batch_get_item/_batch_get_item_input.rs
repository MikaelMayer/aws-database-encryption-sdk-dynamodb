...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::batch_get_item::BatchGetItemInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchGetItemInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchGetItemInput::BatchGetItemInput {
...
pub fn from_dafny(
    ...
    crate::operation::batch_get_item::BatchGetItemInput::builder()
