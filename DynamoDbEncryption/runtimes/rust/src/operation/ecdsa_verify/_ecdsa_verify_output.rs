...
impl EcdsaVerifyOutput {
    ...
    pub fn builder() -> crate::operation::ecdsa_verify::builders::EcdsaVerifyOutputBuilder {
        crate::operation::ecdsa_verify::builders::EcdsaVerifyOutputBuilder::default()
    }
}
...
pub fn get_success(&self) -> &::std::option::Option<::std::primitive::bool> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::ecdsa_verify::EcdsaVerifyOutput {
