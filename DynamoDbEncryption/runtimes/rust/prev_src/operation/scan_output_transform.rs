...
impl ScanOutputTransform {
    ...
    > {
                let inner_input = crate::conversions::scan_output_transform::_scan_output_transform_input::to_dafny(input);
        let inner_result =
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::scan_output_transform::_scan_output_transform_output::from_dafny(
