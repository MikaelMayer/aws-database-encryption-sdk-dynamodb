...
pub use crate::operation::ecdsa_sign::_ecdsa_sign_output::EcdsaSignOutputBuilder;

pub use crate::operation::ecdsa_sign::_ecdsa_sign_input::EcdsaSignInputBuilder;
...
pub struct EcdsaSignFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::ecdsa_sign::builders::EcdsaSignInputBuilder,
}
impl EcdsaSignFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::ecdsa_sign::builders::EcdsaSignInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::ecdsa_sign::EcdsaSign::send(&self.client, input).await
    }
