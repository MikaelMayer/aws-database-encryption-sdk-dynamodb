...
impl DecryptPathStructureOutput {
    ...
    pub fn builder() -> crate::operation::decrypt_path_structure::builders::DecryptPathStructureOutputBuilder {
        crate::operation::decrypt_path_structure::builders::DecryptPathStructureOutputBuilder::default()
    }
}
...
pub fn get_plaintext_structure(&self) -> &::std::option::Option<::std::vec::Vec<structured_encryption::types::CryptoItem>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decrypt_path_structure::DecryptPathStructureOutput {
