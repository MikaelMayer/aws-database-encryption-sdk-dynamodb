...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::material_providers::types::client_supplier::ClientSupplierRef,
) -> ::dafny_runtime::Object<
  dyn crate::r#software::amazon::cryptography::keystore::internaldafny::types::IClientSupplier,
> {
...
pub struct ClientSupplierWrapper {
  obj: crate::material_providers::types::client_supplier::ClientSupplierRef,
}
...
pub fn from_dafny(
    ...
    >,
) -> crate::material_providers::types::client_supplier::ClientSupplierRef {
...
impl crate::software::amazon::cryptography::keystore::internaldafny::types::IClientSupplier
  for ClientSupplierWrapper
{
  fn r#_GetClient_k(
      &mut self,
      input: &::std::rc::Rc<
      crate::r#software::amazon::cryptography::keystore::internaldafny::types::GetClientInput,
      >,
  ) -> ::std::rc::Rc<
      crate::Wrappers::Result<
          ::std::rc::Rc<
          crate::r#software::amazon::cryptography::keystore::internaldafny::types::GetClientOutput,
          >,
  ...
  {
      let inner_input =
          crate::material_providers::conversions::get_client::_get_client_input::from_dafny(
              input.clone(),
          );
      let inner_result = self.obj.inner.borrow_mut().get_client(inner_input);
      let result = match inner_result {
          Ok(x) => crate::Wrappers::Result::Success {
              value: crate::material_providers::conversions::get_client::_get_client_output::to_dafny(
                  x,
              ),
          },
...
impl crate::material_providers::types::client_supplier::ClientSupplier for IClientSupplierDafnyWrapper {
  fn get_client(
      &mut self,
  ...
  > {
      let inner_input =
          crate::material_providers::conversions::get_client::_get_client_input::to_dafny(input);
      ...
      if matches!(
          ...
          Ok(
              crate::material_providers::conversions::get_client::_get_client_output::from_dafny(
