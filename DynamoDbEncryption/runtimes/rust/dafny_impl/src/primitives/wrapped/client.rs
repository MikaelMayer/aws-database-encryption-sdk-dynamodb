...
pub struct Client {
    wrapped: crate::primitives::client::Client
}
...
>> {
    ...
    match result {
      Ok(client) =>  {
        let wrap = crate::primitives::wrapped::client::Client {
          wrapped: client
        };
        std::rc::Rc::new(
      ...
      Err(error) => crate::primitives::conversions::error::to_opaque_error_result(error)
    }
  }
}
...
impl crate::r#software::amazon::cryptography::primitives::internaldafny::types::IAwsCryptographicPrimitivesClient for Client {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::aes_decrypt::AesDecrypt::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
                    error: crate::primitives::conversions::error::to_dafny(error),
                },
            ),
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::aes_encrypt::AesEncrypt::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::aes_encrypt::_aes_encrypt_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::aes_kdf_counter_mode::AesKdfCounterMode::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::compress_public_key::CompressPublicKey::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::compress_public_key::_compress_public_key_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::decompress_public_key::DecompressPublicKey::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::decompress_public_key::_decompress_public_key_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::derive_shared_secret::DeriveSharedSecret::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::derive_shared_secret::_derive_shared_secret_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::digest::Digest::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::ecdsa_sign::EcdsaSign::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::ecdsa_verify::EcdsaVerify::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::generate_ecc_key_pair::GenerateEccKeyPair::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::generate_ecc_key_pair::_generate_ecc_key_pair_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::generate_ecdsa_signature_key::GenerateEcdsaSignatureKey::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::generate_ecdsa_signature_key::_generate_ecdsa_signature_key_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::generate_random_bytes::GenerateRandomBytes::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::generate_rsa_key_pair::GenerateRsaKeyPair::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::generate_rsa_key_pair::_generate_rsa_key_pair_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::get_public_key_from_private_key::GetPublicKeyFromPrivateKey::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::get_public_key_from_private_key::_get_public_key_from_private_key_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::get_rsa_key_modulus_length::GetRsaKeyModulusLength::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::get_rsa_key_modulus_length::_get_rsa_key_modulus_length_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::hkdf::Hkdf::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::hkdf_expand::HkdfExpand::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::hkdf_extract::HkdfExtract::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::h_mac::HMac::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::kdf_counter_mode::KdfCounterMode::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::parse_public_key::ParsePublicKey::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::parse_public_key::_parse_public_key_output::to_dafny(inner_result),
                },
            ),
        }
    }
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::rsa_decrypt::RsaDecrypt::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::rsa_encrypt::RsaEncrypt::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
    ...
    >{
        ...
        let result = tokio::task::block_in_place(|| {
            dafny_tokio_runtime.block_on(crate::primitives::operation::validate_public_key::ValidatePublicKey::send(&self.wrapped, inner_input))
        });
        match result {
            Err(error) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Failure {
            ...
            Ok(inner_result) => ::std::rc::Rc::new(
                crate::Wrappers::Result::Success {
                    value: crate::primitives::conversions::validate_public_key::_validate_public_key_output::to_dafny(inner_result),
                },
            ),
        }
    }
