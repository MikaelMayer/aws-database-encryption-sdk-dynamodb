...
pub use crate::operation::initialize_encryption_materials::_encryption_materials::EncryptionMaterialsBuilder;

pub use crate::operation::initialize_encryption_materials::_initialize_encryption_materials_input::InitializeEncryptionMaterialsInputBuilder;
...
pub struct InitializeEncryptionMaterialsFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsInputBuilder,
}
impl InitializeEncryptionMaterialsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::initialize_encryption_materials::InitializeEncryptionMaterials::send(&self.client, input).await
    }
