...
impl crate::client::Client {
    ...
    ///   - [`digest_algorithm(impl Into<Option<primitives::types::DigestAlgorithm>>)`](crate::operation::kdf_counter_mode::builders::KdfCounterModeFluentBuilder::digest_algorithm) / [`set_digest_algorithm(Option<primitives::types::DigestAlgorithm>)`](crate::operation::kdf_counter_mode::builders::KdfCounterModeFluentBuilder::set_digest_algorithm): (undocumented)<br>
    ...
    pub fn kdf_counter_mode(&self) -> crate::operation::kdf_counter_mode::builders::KdfCounterModeFluentBuilder {
        crate::operation::kdf_counter_mode::builders::KdfCounterModeFluentBuilder::new(self.clone())
    }
}
