...
impl crate::client::Client {
    ...
    ///   - [`kms_client(impl Into<Option<kms::client::Client>>)`](crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringFluentBuilder::kms_client) / [`set_kms_client(Option<kms::client::Client>)`](crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringFluentBuilder::set_kms_client): (undocumented)<br>
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_keyring(&self) -> crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringFluentBuilder {
        crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringFluentBuilder::new(self.clone())
    }
}
