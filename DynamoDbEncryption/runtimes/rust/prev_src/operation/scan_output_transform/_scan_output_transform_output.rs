...
pub struct ScanOutputTransformOutput {
    #[allow(missing_docs)] // documentation missing in model
pub transformed_output: ::std::option::Option<dynamodb::types::ScanOutput>,
}
impl ScanOutputTransformOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn transformed_output(&self) -> &::std::option::Option<dynamodb::types::ScanOutput> {
...
impl ScanOutputTransformOutput {
    ...
    pub fn builder() -> crate::operation::scan_output_transform::builders::ScanOutputTransformOutputBuilder {
...
pub struct ScanOutputTransformOutputBuilder {
    pub(crate) transformed_output: ::std::option::Option<dynamodb::types::ScanOutput>,
}
impl ScanOutputTransformOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn transformed_output(mut self, input: impl ::std::convert::Into<dynamodb::types::ScanOutput>) -> Self {
    self.transformed_output = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_transformed_output(mut self, input: ::std::option::Option<dynamodb::types::ScanOutput>) -> Self {
    self.transformed_output = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_transformed_output(&self) -> &::std::option::Option<dynamodb::types::ScanOutput> {
    &self.transformed_output
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::scan_output_transform::ScanOutputTransformOutput {
