...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::ExecuteStatementInput>>)`](crate::operation::execute_statement_input_transform::builders::ExecuteStatementInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::ExecuteStatementInput>)`](crate::operation::execute_statement_input_transform::builders::ExecuteStatementInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::ExecuteStatementInput>)`](crate::operation::execute_statement_input_transform::ExecuteStatementInputTransformOutput::transformed_input): (undocumented)
