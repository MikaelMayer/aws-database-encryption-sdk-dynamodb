...
,
 ...
 DestinationKeyId: crate::kms::standard_library_conversions::ostring_to_dafny(&value.destination_key_id) .Extract(),
...
pub fn from_dafny(
 ...
 .set_source_key_id(crate::kms::standard_library_conversions::ostring_from_dafny(dafny_value.SourceKeyId().clone()))
