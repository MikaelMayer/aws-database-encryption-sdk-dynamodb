...
impl CompressPublicKeyOutput {
    /// Creates a new builder-style object to manufacture [`CompressPublicKeyOutput`](crate::primitives::operation::compress_public_key::builders::CompressPublicKeyOutput).
    pub fn builder() -> crate::primitives::operation::compress_public_key::builders::CompressPublicKeyOutputBuilder {
        crate::primitives::operation::compress_public_key::builders::CompressPublicKeyOutputBuilder::default()
    }
}

/// A builder for [`CompressPublicKeyOutput`](crate::primitives::operation::operation::CompressPublicKeyOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_compressed_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`CompressPublicKeyOutput`](crate::primitives::operation::operation::CompressPublicKeyOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::compress_public_key::CompressPublicKeyOutput {
