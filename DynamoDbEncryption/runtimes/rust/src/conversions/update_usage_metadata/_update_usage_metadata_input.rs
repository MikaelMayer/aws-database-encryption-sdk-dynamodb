...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_usage_metadata::UpdateUsageMetadataInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateUsageMetadataInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateUsageMetadataInput::UpdateUsageMetadataInput {
...
pub fn from_dafny(
    ...
    crate::operation::update_usage_metadata::UpdateUsageMetadataInput::builder()
