...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::encrypt_path_structure::EncryptPathStructureInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EncryptPathStructureInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EncryptPathStructureInput::EncryptPathStructureInput {
...
,
 algorithmSuiteId: ::std::rc::Rc::new(match &value.algorithm_suite_id {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: material_providers::conversions::dbe_algorithm_suite_id::to_dafny(x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::encrypt_path_structure::EncryptPathStructureInput::builder()
...
,
 ...
 .set_algorithm_suite_id(match &**dafny_value.algorithmSuiteId() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        material_providers::conversions::dbe_algorithm_suite_id::from_dafny(value)
    ),
    _ => None,
}
)
