...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::import_key_material::ImportKeyMaterialRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ImportKeyMaterialRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ImportKeyMaterialRequest::ImportKeyMaterialRequest {
 ...
 ExpirationModel: ::std::rc::Rc::new(match &value.expiration_model {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::expiration_model_type::to_dafny(x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::import_key_material::ImportKeyMaterialRequest::builder()
 ...
 .set_expiration_model(match &**dafny_value.ExpirationModel() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        kms::conversions::expiration_model_type::from_dafny(value)
    ),
    _ => None,
}
)
