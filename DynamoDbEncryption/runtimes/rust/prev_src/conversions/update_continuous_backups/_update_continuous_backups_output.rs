...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_continuous_backups::UpdateContinuousBackupsOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateContinuousBackupsOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateContinuousBackupsOutput::UpdateContinuousBackupsOutput {
...
pub fn from_dafny(
    ...
    crate::operation::update_continuous_backups::UpdateContinuousBackupsOutput::builder()
