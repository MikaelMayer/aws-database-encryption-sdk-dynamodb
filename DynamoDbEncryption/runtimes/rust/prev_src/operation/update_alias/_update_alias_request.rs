...
impl UpdateAliasRequest {
    /// Creates a new builder-style object to manufacture [`UpdateAliasRequest`](crate::operation::update_alias::builders::UpdateAliasRequest).
    pub fn builder() -> crate::operation::update_alias::builders::UpdateAliasRequestBuilder {
        crate::operation::update_alias::builders::UpdateAliasRequestBuilder::default()
    }
}

/// A builder for [`UpdateAliasRequest`](crate::operation::operation::UpdateAliasRequest).
#[non_exhaustive]
#[derive(
...
pub fn get_target_key_id(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`UpdateAliasRequest`](crate::operation::operation::UpdateAliasRequest).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::update_alias::UpdateAliasRequest,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::update_alias::UpdateAliasRequest {
