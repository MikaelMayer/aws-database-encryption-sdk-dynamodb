...
impl ValidatePublicKeyInput {
    /// Creates a new builder-style object to manufacture [`ValidatePublicKeyInput`](crate::primitives::operation::validate_public_key::builders::ValidatePublicKeyInput).
    pub fn builder() -> crate::primitives::operation::validate_public_key::builders::ValidatePublicKeyInputBuilder {
        crate::primitives::operation::validate_public_key::builders::ValidatePublicKeyInputBuilder::default()
    }
}

/// A builder for [`ValidatePublicKeyInput`](crate::primitives::operation::operation::ValidatePublicKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`ValidatePublicKeyInput`](crate::primitives::operation::operation::ValidatePublicKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::validate_public_key::ValidatePublicKeyInput {
