...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::decrypt::DecryptRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptRequest::DecryptRequest {
...
pub fn from_dafny(
    ...
    crate::operation::decrypt::DecryptRequest::builder()
