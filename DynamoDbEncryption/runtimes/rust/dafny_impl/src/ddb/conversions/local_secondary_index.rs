...
,
 Projection: crate::ddb::conversions::projection::to_dafny(&value.projection.clone().unwrap())
,
    }
  )
} #[allow(dead_code)]
...
,
 ...
 .set_projection(Some( crate::ddb::conversions::projection::from_dafny(dafny_value.Projection().clone())
 ))
          .build()
          .unwrap()
}
