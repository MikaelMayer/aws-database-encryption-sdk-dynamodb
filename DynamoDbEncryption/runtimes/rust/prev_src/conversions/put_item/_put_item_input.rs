...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::put_item::PutItemInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::PutItemInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::PutItemInput::PutItemInput {
...
pub fn from_dafny(
    ...
    crate::operation::put_item::PutItemInput::builder()
