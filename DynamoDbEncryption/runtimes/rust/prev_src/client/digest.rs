...
impl crate::client::Client {
    ...
    ///   - [`digest_algorithm(impl Into<Option<primitives::types::DigestAlgorithm>>)`](crate::operation::digest::builders::DigestFluentBuilder::digest_algorithm) / [`set_digest_algorithm(Option<primitives::types::DigestAlgorithm>)`](crate::operation::digest::builders::DigestFluentBuilder::set_digest_algorithm): (undocumented)<br>
    ...
    pub fn digest(&self) -> crate::operation::digest::builders::DigestFluentBuilder {
        crate::operation::digest::builders::DigestFluentBuilder::new(self.clone())
    }
}
