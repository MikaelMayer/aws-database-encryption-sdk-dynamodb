...
impl GenerateRandomBytesOutput {
    ...
    pub fn builder() -> crate::operation::generate_random_bytes::builders::GenerateRandomBytesOutputBuilder {
        crate::operation::generate_random_bytes::builders::GenerateRandomBytesOutputBuilder::default()
    }
}
...
pub fn get_data(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_random_bytes::GenerateRandomBytesOutput {
            data: self.data,
        })
    }
}
