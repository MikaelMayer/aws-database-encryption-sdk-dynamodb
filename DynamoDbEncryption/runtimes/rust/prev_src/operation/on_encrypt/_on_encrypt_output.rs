...
impl OnEncryptOutput {
    ...
    pub fn builder() -> crate::operation::on_encrypt::builders::OnEncryptOutputBuilder {
        crate::operation::on_encrypt::builders::OnEncryptOutputBuilder::default()
    }
}
...
pub fn get_materials(&self) -> &::std::option::Option<material_providers::types::EncryptionMaterials> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::on_encrypt::OnEncryptOutput {
