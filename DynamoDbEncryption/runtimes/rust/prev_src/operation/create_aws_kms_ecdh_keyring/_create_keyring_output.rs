...
impl CreateKeyringOutput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_ecdh_keyring::builders::CreateKeyringOutputBuilder {
        crate::operation::create_aws_kms_ecdh_keyring::builders::CreateKeyringOutputBuilder::default()
    }
}
...
pub fn get_keyring(&self) -> &::std::option::Option<material_providers::types::keyring::KeyringRef> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_ecdh_keyring::CreateKeyringOutput {
