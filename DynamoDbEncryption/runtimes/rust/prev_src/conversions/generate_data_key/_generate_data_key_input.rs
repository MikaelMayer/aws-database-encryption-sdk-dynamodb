...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_data_key::GenerateDataKeyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyRequest::GenerateDataKeyRequest {
...
pub fn from_dafny(
    ...
    crate::operation::generate_data_key::GenerateDataKeyRequest::builder()
