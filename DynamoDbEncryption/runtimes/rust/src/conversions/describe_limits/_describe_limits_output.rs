...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::describe_limits::DescribeLimitsOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DescribeLimitsOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DescribeLimitsOutput::DescribeLimitsOutput {
...
pub fn from_dafny(
    ...
    crate::operation::describe_limits::DescribeLimitsOutput::builder()
