...
impl GenerateEcdsaSignatureKeyOutput {
    /// Creates a new builder-style object to manufacture [`GenerateEcdsaSignatureKeyOutput`](crate::primitives::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyOutput).
    pub fn builder() -> crate::primitives::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyOutputBuilder {
        crate::primitives::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyOutputBuilder::default()
    }
}

/// A builder for [`GenerateEcdsaSignatureKeyOutput`](crate::primitives::operation::operation::GenerateEcdsaSignatureKeyOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`GenerateEcdsaSignatureKeyOutput`](crate::primitives::operation::operation::GenerateEcdsaSignatureKeyOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::generate_ecdsa_signature_key::GenerateEcdsaSignatureKeyOutput {
