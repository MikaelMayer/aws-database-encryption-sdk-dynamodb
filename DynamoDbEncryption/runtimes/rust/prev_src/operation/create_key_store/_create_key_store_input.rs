...
impl CreateKeyStoreInput {
    ...
    pub fn builder() -> crate::operation::create_key_store::builders::CreateKeyStoreInputBuilder {
        crate::operation::create_key_store::builders::CreateKeyStoreInputBuilder::default()
    }
}
...
impl CreateKeyStoreInputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_key_store::CreateKeyStoreInput {
