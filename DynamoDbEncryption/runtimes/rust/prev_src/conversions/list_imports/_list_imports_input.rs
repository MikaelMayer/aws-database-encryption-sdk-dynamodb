...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_imports::ListImportsInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListImportsInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListImportsInput::ListImportsInput {
...
pub fn from_dafny(
    ...
    crate::operation::list_imports::ListImportsInput::builder()
