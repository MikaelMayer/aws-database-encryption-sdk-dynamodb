...
pub mod RSAEncryption{
  pub mod RSA {
    ...
    #[allow(non_snake_case)]
    pub fn GetRSAKeyModulusLengthExtern(_publicKey: &::dafny_runtime::Sequence<u8>) -> ::std::rc::Rc<Wrappers::Result<u32, ::std::rc::Rc<software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
