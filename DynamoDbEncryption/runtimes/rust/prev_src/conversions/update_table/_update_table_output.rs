...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_table::UpdateTableOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateTableOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateTableOutput::UpdateTableOutput {
...
pub fn from_dafny(
    ...
    crate::operation::update_table::UpdateTableOutput::builder()
