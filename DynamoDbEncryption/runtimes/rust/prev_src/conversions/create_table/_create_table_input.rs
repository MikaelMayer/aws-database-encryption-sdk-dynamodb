...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_table::CreateTableInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateTableInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateTableInput::CreateTableInput {
    ...
    |e| dynamodb::conversions::attribute_definition::to_dafny(e.clone())
,
)
,
 ...
 KeySchema: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.key_schema.clone().unwrap(),
    |e| dynamodb::conversions::key_schema_element::to_dafny(e.clone())
,
)
,
 LocalSecondaryIndexes: ::std::rc::Rc::new(match &value.local_secondary_indexes {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| dynamodb::conversions::local_secondary_index::to_dafny(e.clone())
,
        )
    },
...
,
 GlobalSecondaryIndexes: ::std::rc::Rc::new(match &value.global_secondary_indexes {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| dynamodb::conversions::global_secondary_index::to_dafny(e.clone())
,
        )
    },
    None => crate::r#_Wrappers_Compile::Option::None {}
...
,
 BillingMode: ::std::rc::Rc::new(match &value.billing_mode {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::billing_mode::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 ProvisionedThroughput: ::std::rc::Rc::new(match &value.provisioned_throughput {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::provisioned_throughput::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 StreamSpecification: ::std::rc::Rc::new(match &value.stream_specification {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::stream_specification::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 SSESpecification: ::std::rc::Rc::new(match &value.sse_specification {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::sse_specification::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
,
 TableClass: ::std::rc::Rc::new(match &value.table_class {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::table_class::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
    })
...
pub fn from_dafny(
    ...
    crate::operation::create_table::CreateTableInput::builder()
    ...
    |e| dynamodb::conversions::attribute_definition::from_dafny(e.clone())
,
)
 ))
 ...
 .set_key_schema(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.KeySchema(),
    |e| dynamodb::conversions::key_schema_element::from_dafny(e.clone())
,
)
 ))
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| dynamodb::conversions::local_secondary_index::from_dafny(e.clone())
,
            )
        ),
    _ => None
 ...
 .set_global_secondary_indexes(match (*dafny_value.GlobalSecondaryIndexes()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| dynamodb::conversions::global_secondary_index::from_dafny(e.clone())
,
            )
        ),
    _ => None
 ...
 .set_billing_mode(match &**dafny_value.BillingMode() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::billing_mode::from_dafny(value)
    ),
    _ => None,
}
)
 .set_provisioned_throughput(match (*dafny_value.ProvisionedThroughput()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(dynamodb::conversions::provisioned_throughput::from_dafny(value.clone())),
    _ => None,
}
)
 .set_stream_specification(match (*dafny_value.StreamSpecification()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(dynamodb::conversions::stream_specification::from_dafny(value.clone())),
    _ => None,
}
)
 .set_sse_specification(match (*dafny_value.SSESpecification()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(dynamodb::conversions::sse_specification::from_dafny(value.clone())),
    _ => None,
}
)
...
,
 ...
 .set_table_class(match &**dafny_value.TableClass() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::table_class::from_dafny(value)
    ),
    _ => None,
}
)
