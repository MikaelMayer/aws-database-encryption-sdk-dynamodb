...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_global_table_settings::UpdateGlobalTableSettingsInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateGlobalTableSettingsInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateGlobalTableSettingsInput::UpdateGlobalTableSettingsInput {
...
,
 ...
 GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate: ::std::rc::Rc::new(match &value.global_table_provisioned_write_capacity_auto_scaling_settings_update {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::auto_scaling_settings_update::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 GlobalTableGlobalSecondaryIndexSettingsUpdate: ::std::rc::Rc::new(match &value.global_table_global_secondary_index_settings_update {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| dynamodb::conversions::global_table_global_secondary_index_settings_update::to_dafny(e.clone())
,
        )
    },
...
,
 ReplicaSettingsUpdate: ::std::rc::Rc::new(match &value.replica_settings_update {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| dynamodb::conversions::replica_settings_update::to_dafny(e.clone())
,
        )
    },
    None => crate::r#_Wrappers_Compile::Option::None {}
...
pub fn from_dafny(
    ...
    crate::operation::update_global_table_settings::UpdateGlobalTableSettingsInput::builder()
 ...
 .set_global_table_provisioned_write_capacity_auto_scaling_settings_update(match (*dafny_value.GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(dynamodb::conversions::auto_scaling_settings_update::from_dafny(value.clone())),
    _ => None,
}
)
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| dynamodb::conversions::global_table_global_secondary_index_settings_update::from_dafny(e.clone())
,
            )
        ),
    _ => None
 ...
 .set_replica_settings_update(match (*dafny_value.ReplicaSettingsUpdate()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| dynamodb::conversions::replica_settings_update::from_dafny(e.clone())
,
            )
        ),
    _ => None
