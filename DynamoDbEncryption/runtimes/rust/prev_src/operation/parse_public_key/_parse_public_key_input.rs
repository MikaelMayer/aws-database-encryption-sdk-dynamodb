...
impl ParsePublicKeyInput {
    ...
    pub fn builder() -> crate::operation::parse_public_key::builders::ParsePublicKeyInputBuilder {
        crate::operation::parse_public_key::builders::ParsePublicKeyInputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::parse_public_key::ParsePublicKeyInput {
