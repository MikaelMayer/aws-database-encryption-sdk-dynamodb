...
#[allow(missing_docs)] // documentation missing in model
pub underlying_cmm: ::std::option::Option<material_providers::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>,
}
...
#[allow(missing_docs)] // documentation missing in model
pub fn underlying_cmm(&self) -> &::std::option::Option<material_providers::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef> {
    &self.underlying_cmm
}
}
impl CreateRequiredEncryptionContextCmmInput {
    ...
    pub fn builder() -> crate::operation::create_required_encryption_context_cmm::builders::CreateRequiredEncryptionContextCmmInputBuilder {
        crate::operation::create_required_encryption_context_cmm::builders::CreateRequiredEncryptionContextCmmInputBuilder::default()
    }
}
...
pub(crate) underlying_cmm: ::std::option::Option<material_providers::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>,
}
...
pub fn get_underlying_cmm(&self) -> &::std::option::Option<material_providers::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_required_encryption_context_cmm::CreateRequiredEncryptionContextCmmInput {
