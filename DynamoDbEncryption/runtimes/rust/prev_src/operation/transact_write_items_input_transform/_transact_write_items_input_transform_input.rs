...
pub struct TransactWriteItemsInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::TransactWriteItemsInput>,
}
impl TransactWriteItemsInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::TransactWriteItemsInput> {
    &self.sdk_input
}
}
impl TransactWriteItemsInputTransformInput {
...
pub struct TransactWriteItemsInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::TransactWriteItemsInput>,
}
impl TransactWriteItemsInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::TransactWriteItemsInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::TransactWriteItemsInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::TransactWriteItemsInput> {
    &self.sdk_input
}
