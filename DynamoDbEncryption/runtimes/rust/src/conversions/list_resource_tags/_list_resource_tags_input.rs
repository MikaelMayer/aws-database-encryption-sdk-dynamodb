...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_resource_tags::ListResourceTagsRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListResourceTagsRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListResourceTagsRequest::ListResourceTagsRequest {
...
pub fn from_dafny(
    ...
    crate::operation::list_resource_tags::ListResourceTagsRequest::builder()
