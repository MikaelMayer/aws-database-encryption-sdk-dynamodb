...
impl DigestOutput {
    ...
    pub fn builder() -> crate::operation::digest::builders::DigestOutputBuilder {
        crate::operation::digest::builders::DigestOutputBuilder::default()
    }
}
...
pub fn get_digest(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::digest::DigestOutput {
            digest: self.digest,
        })
    }
}
