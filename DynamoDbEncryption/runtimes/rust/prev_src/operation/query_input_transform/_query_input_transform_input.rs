...
pub struct QueryInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::QueryInput>,
}
impl QueryInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::QueryInput> {
    &self.sdk_input
}
}
impl QueryInputTransformInput {
    ...
    pub fn builder() -> crate::operation::query_input_transform::builders::QueryInputTransformInputBuilder {
...
pub struct QueryInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::QueryInput>,
}
impl QueryInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::QueryInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::QueryInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::QueryInput> {
    &self.sdk_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::query_input_transform::QueryInputTransformInput {
