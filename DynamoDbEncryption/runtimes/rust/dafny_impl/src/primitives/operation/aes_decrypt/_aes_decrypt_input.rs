...
#[allow(missing_docs)] // documentation missing in model
pub enc_alg: ::std::option::Option<crate::primitives::types::AesGcm>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn enc_alg(&self) -> &::std::option::Option<crate::primitives::types::AesGcm> {
    &self.enc_alg
}
#[allow(missing_docs)] // documentation missing in model
...
impl AesDecryptInput {
    /// Creates a new builder-style object to manufacture [`AesDecryptInput`](crate::primitives::operation::aes_decrypt::builders::AesDecryptInput).
    pub fn builder() -> crate::primitives::operation::aes_decrypt::builders::AesDecryptInputBuilder {
        crate::primitives::operation::aes_decrypt::builders::AesDecryptInputBuilder::default()
    }
}

/// A builder for [`AesDecryptInput`](crate::primitives::operation::operation::AesDecryptInput).
#[non_exhaustive]
#[derive(
...
pub(crate) enc_alg: ::std::option::Option<crate::primitives::types::AesGcm>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn enc_alg(mut self, input: impl ::std::convert::Into<crate::primitives::types::AesGcm>) -> Self {
    self.enc_alg = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_enc_alg(mut self, input: ::std::option::Option<crate::primitives::types::AesGcm>) -> Self {
    self.enc_alg = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_enc_alg(&self) -> &::std::option::Option<crate::primitives::types::AesGcm> {
    &self.enc_alg
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`AesDecryptInput`](crate::primitives::operation::operation::AesDecryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::aes_decrypt::AesDecryptInput {
            aad: self.aad,
