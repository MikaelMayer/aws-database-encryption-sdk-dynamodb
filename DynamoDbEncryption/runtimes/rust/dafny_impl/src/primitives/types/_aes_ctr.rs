...
impl AesCtr {
    /// Creates a new builder-style object to manufacture [`AesCtr`](crate::primitives::types::AesCtr).
    pub fn builder() -> crate::primitives::types::builders::AesCtrBuilder {
        crate::primitives::types::builders::AesCtrBuilder::default()
    }
}

/// A builder for [`AesCtr`](crate::primitives::types::AesCtr).
#[non_exhaustive]
#[derive(
...
pub fn get_nonce_length(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    /// Consumes the builder and constructs a [`AesCtr`](crate::primitives::types::AesCtr).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::types::AesCtr {
