...
impl GetBranchKeyIdFromDdbKeyOutput {
    ...
    pub fn builder() -> crate::operation::get_branch_key_id_from_ddb_key::builders::GetBranchKeyIdFromDdbKeyOutputBuilder {
        crate::operation::get_branch_key_id_from_ddb_key::builders::GetBranchKeyIdFromDdbKeyOutputBuilder::default()
    }
}
...
pub fn get_branch_key_id(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_branch_key_id_from_ddb_key::GetBranchKeyIdFromDdbKeyOutput {
