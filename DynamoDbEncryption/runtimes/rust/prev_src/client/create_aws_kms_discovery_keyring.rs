...
impl crate::client::Client {
    ...
    ///   - [`discovery_filter(impl Into<Option<material_providers::types::DiscoveryFilter>>)`](crate::operation::create_aws_kms_discovery_keyring::builders::CreateAwsKmsDiscoveryKeyringFluentBuilder::discovery_filter) / [`set_discovery_filter(Option<material_providers::types::DiscoveryFilter>)`](crate::operation::create_aws_kms_discovery_keyring::builders::CreateAwsKmsDiscoveryKeyringFluentBuilder::set_discovery_filter): (undocumented)<br>
    ...
    ///   - [`kms_client(impl Into<Option<kms::client::Client>>)`](crate::operation::create_aws_kms_discovery_keyring::builders::CreateAwsKmsDiscoveryKeyringFluentBuilder::kms_client) / [`set_kms_client(Option<kms::client::Client>)`](crate::operation::create_aws_kms_discovery_keyring::builders::CreateAwsKmsDiscoveryKeyringFluentBuilder::set_kms_client): (undocumented)<br>
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_discovery_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_discovery_keyring(&self) -> crate::operation::create_aws_kms_discovery_keyring::builders::CreateAwsKmsDiscoveryKeyringFluentBuilder {
        crate::operation::create_aws_kms_discovery_keyring::builders::CreateAwsKmsDiscoveryKeyringFluentBuilder::new(self.clone())
    }
}
