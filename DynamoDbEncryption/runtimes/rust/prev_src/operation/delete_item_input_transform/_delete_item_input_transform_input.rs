...
pub struct DeleteItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::DeleteItemInput>,
}
impl DeleteItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::DeleteItemInput> {
    &self.sdk_input
}
}
impl DeleteItemInputTransformInput {
    ...
    pub fn builder() -> crate::operation::delete_item_input_transform::builders::DeleteItemInputTransformInputBuilder {
...
pub struct DeleteItemInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::DeleteItemInput>,
}
impl DeleteItemInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::DeleteItemInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::DeleteItemInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::DeleteItemInput> {
    &self.sdk_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::delete_item_input_transform::DeleteItemInputTransformInput {
