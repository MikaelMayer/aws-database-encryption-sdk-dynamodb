...
impl CreateKeyStoreOutput {
    ...
    pub fn builder() -> crate::operation::create_key_store::builders::CreateKeyStoreOutputBuilder {
        crate::operation::create_key_store::builders::CreateKeyStoreOutputBuilder::default()
    }
}
...
pub fn get_table_arn(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_key_store::CreateKeyStoreOutput {
