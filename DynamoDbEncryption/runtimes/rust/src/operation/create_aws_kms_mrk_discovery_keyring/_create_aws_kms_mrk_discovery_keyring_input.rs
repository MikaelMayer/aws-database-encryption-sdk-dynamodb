...
pub struct CreateAwsKmsMrkDiscoveryKeyringInput {
    #[allow(missing_docs)] // documentation missing in model
pub discovery_filter: ::std::option::Option<material_providers::types::DiscoveryFilter>,
#[allow(missing_docs)] // documentation missing in model
...
impl CreateAwsKmsMrkDiscoveryKeyringInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn discovery_filter(&self) -> &::std::option::Option<material_providers::types::DiscoveryFilter> {
...
impl CreateAwsKmsMrkDiscoveryKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringInputBuilder {
        crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringInputBuilder::default()
    }
}
...
pub struct CreateAwsKmsMrkDiscoveryKeyringInputBuilder {
    pub(crate) discovery_filter: ::std::option::Option<material_providers::types::DiscoveryFilter>,
...
pub fn get_region(&self) -> &::std::option::Option<::std::string::String> {
    ...
    pub fn build(
        ...
        crate::operation::create_aws_kms_mrk_discovery_keyring::CreateAwsKmsMrkDiscoveryKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_mrk_discovery_keyring::CreateAwsKmsMrkDiscoveryKeyringInput {
