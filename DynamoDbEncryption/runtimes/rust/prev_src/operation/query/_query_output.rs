...
impl QueryOutput {
    /// Creates a new builder-style object to manufacture [`QueryOutput`](crate::operation::query::builders::QueryOutput).
...
/// A builder for [`QueryOutput`](crate::operation::operation::QueryOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_scanned_count(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    /// Consumes the builder and constructs a [`QueryOutput`](crate::operation::operation::QueryOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
