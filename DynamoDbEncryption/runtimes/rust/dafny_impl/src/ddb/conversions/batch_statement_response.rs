...
pub fn to_dafny(
  ...
  ::std::rc::Rc::new(
    ...
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::batch_statement_error::to_dafny(x) },
...
pub fn from_dafny(
    ...
    crate::Wrappers::Option::Some { value } =>
        Some(crate::ddb::conversions::batch_statement_error::from_dafny(value.clone())),
    _ => None,
}
)
