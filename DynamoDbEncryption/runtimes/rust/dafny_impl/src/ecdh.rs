...
pub mod ECDH {
  pub mod KeyGeneration {
    pub fn GenerateKeyPair(_input: &::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::ECDHCurveSpec>)
      -> ::std::rc::Rc<crate::Wrappers::Result<::std::rc::Rc<crate::ECDH::EccKeyPair>, ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
  ...
  pub mod ECCUtils {
    ...
    -> ::std::rc::Rc<crate::Wrappers::Result<::dafny_runtime::Sequence<u8>, ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
    ...
    -> ::std::rc::Rc<crate::Wrappers::Result<bool, ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
