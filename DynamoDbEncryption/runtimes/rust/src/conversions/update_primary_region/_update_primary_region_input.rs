...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_primary_region::UpdatePrimaryRegionRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdatePrimaryRegionRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdatePrimaryRegionRequest::UpdatePrimaryRegionRequest {
...
pub fn from_dafny(
    ...
    crate::operation::update_primary_region::UpdatePrimaryRegionRequest::builder()
