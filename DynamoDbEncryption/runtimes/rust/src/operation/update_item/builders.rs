...
pub struct UpdateItemFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::update_item::builders::UpdateItemInputBuilder,
}
impl UpdateItemFluentBuilder {
    ...
    > {
        ...
        crate::operation::update_item::UpdateItem::send(&self.client, input).await
    }
...
pub fn attribute_updates(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, dynamodb::types::AttributeValueUpdate>>) -> Self {
    self.inner = self.inner.attribute_updates(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
