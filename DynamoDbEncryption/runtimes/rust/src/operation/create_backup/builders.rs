...
pub struct CreateBackupFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_backup::builders::CreateBackupInputBuilder,
}
impl CreateBackupFluentBuilder {
    ...
    > {
        ...
        crate::operation::create_backup::CreateBackup::send(&self.client, input).await
    }
