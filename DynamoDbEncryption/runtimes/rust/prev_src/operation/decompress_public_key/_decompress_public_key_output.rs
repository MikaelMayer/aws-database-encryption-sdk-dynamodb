...
impl DecompressPublicKeyOutput {
    ...
    pub fn builder() -> crate::operation::decompress_public_key::builders::DecompressPublicKeyOutputBuilder {
        crate::operation::decompress_public_key::builders::DecompressPublicKeyOutputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<primitives::types::EccPublicKey> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decompress_public_key::DecompressPublicKeyOutput {
