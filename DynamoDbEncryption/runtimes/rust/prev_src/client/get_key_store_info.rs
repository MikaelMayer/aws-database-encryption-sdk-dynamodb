...
impl crate::client::Client {
    ...
    ///   - [`kms_configuration(Option<key_store::types::KmsConfiguration>)`](crate::operation::get_key_store_info::GetKeyStoreInfoOutput::kms_configuration): (undocumented)
    ...
    pub fn get_key_store_info(&self) -> crate::operation::get_key_store_info::builders::GetKeyStoreInfoFluentBuilder {
        crate::operation::get_key_store_info::builders::GetKeyStoreInfoFluentBuilder::new(self.clone())
    }
}
