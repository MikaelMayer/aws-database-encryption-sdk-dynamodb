...
pub struct DescribeExportFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::describe_export::builders::DescribeExportInputBuilder,
}
impl DescribeExportFluentBuilder {
    ...
    > {
        ...
        crate::operation::describe_export::DescribeExport::send(&self.client, input).await
    }
