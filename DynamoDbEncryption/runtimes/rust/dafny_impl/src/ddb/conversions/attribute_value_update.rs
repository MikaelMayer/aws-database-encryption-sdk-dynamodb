...
,
 Action: ::std::rc::Rc::new(match &value.action {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::attribute_action::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
    }
...
pub fn from_dafny(
 ...
 .set_action(match &**dafny_value.Action() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::attribute_action::from_dafny(value)
    ),
    _ => None,
}
)
