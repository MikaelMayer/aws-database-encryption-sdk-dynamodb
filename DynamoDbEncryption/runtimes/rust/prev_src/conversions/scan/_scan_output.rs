...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::scan::ScanOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ScanOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ScanOutput::ScanOutput {
...
pub fn from_dafny(
    ...
    crate::operation::scan::ScanOutput::builder()
