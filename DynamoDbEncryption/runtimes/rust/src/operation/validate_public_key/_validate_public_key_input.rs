...
impl ValidatePublicKeyInput {
    ...
    pub fn builder() -> crate::operation::validate_public_key::builders::ValidatePublicKeyInputBuilder {
        crate::operation::validate_public_key::builders::ValidatePublicKeyInputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::validate_public_key::ValidatePublicKeyInput {
