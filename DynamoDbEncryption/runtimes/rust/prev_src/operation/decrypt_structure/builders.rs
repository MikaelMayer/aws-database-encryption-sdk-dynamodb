...
pub use crate::operation::decrypt_structure::_decrypt_structure_output::DecryptStructureOutputBuilder;

pub use crate::operation::decrypt_structure::_decrypt_structure_input::DecryptStructureInputBuilder;
...
pub struct DecryptStructureFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::decrypt_structure::builders::DecryptStructureInputBuilder,
}
impl DecryptStructureFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::decrypt_structure::builders::DecryptStructureInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::decrypt_structure::DecryptStructure::send(&self.client, input).await
    }
