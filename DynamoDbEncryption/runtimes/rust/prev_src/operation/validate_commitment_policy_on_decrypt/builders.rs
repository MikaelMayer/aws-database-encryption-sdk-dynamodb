...
pub use crate::operation::validate_commitment_policy_on_decrypt::_unit::UnitBuilder;

pub use crate::operation::validate_commitment_policy_on_decrypt::_validate_commitment_policy_on_decrypt_input::ValidateCommitmentPolicyOnDecryptInputBuilder;
...
impl ValidateCommitmentPolicyOnDecryptInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::validate_commitment_policy_on_decrypt::Unit,
...
pub struct ValidateCommitmentPolicyOnDecryptFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::validate_commitment_policy_on_decrypt::builders::ValidateCommitmentPolicyOnDecryptInputBuilder,
}
impl ValidateCommitmentPolicyOnDecryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::validate_commitment_policy_on_decrypt::builders::ValidateCommitmentPolicyOnDecryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::validate_commitment_policy_on_decrypt::ValidateCommitmentPolicyOnDecrypt::send(&self.client, input).await
    }
