...
pub use crate::operation::get_encryption_materials::_get_encryption_materials_output::GetEncryptionMaterialsOutputBuilder;

pub use crate::operation::get_encryption_materials::_get_encryption_materials_input::GetEncryptionMaterialsInputBuilder;
...
pub struct GetEncryptionMaterialsFluentBuilder {
    cryptographic_materials_manager: crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef,
    pub(crate) inner: crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsInputBuilder,
}
impl GetEncryptionMaterialsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_encryption_materials::GetEncryptionMaterials::send(&self.cryptographic_materials_manager, input).await
    }
