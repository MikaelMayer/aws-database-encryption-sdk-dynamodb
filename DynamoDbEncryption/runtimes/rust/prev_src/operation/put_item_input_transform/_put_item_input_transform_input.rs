...
pub struct PutItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::PutItemInput>,
}
impl PutItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::PutItemInput> {
    &self.sdk_input
}
}
impl PutItemInputTransformInput {
    ...
    pub fn builder() -> crate::operation::put_item_input_transform::builders::PutItemInputTransformInputBuilder {
...
pub struct PutItemInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::PutItemInput>,
}
impl PutItemInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::PutItemInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::PutItemInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::PutItemInput> {
    &self.sdk_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::put_item_input_transform::PutItemInputTransformInput {
