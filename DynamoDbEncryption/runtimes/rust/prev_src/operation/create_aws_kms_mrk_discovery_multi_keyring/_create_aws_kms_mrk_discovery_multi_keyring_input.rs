...
impl CreateAwsKmsMrkDiscoveryMultiKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder {
        crate::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder::default()
    }
}
...
pub fn get_regions(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_mrk_discovery_multi_keyring::CreateAwsKmsMrkDiscoveryMultiKeyringInput {
