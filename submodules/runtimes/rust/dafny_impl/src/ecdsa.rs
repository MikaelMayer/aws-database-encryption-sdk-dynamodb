...
pub mod Signature {
  pub mod ECDSA {
    ...
    pub fn ExternKeyGen(_self: &::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::ECDSASignatureAlgorithm>)
      -> ::std::rc::Rc<Wrappers::Result<::std::rc::Rc<Signature::SignatureKeyPair>, ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>>>
    {
      todo!("Signature::ExternKeyGen not implemented");
    }
    pub fn Sign(_self: &::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::ECDSASignatureAlgorithm>,
                _key: &::dafny_runtime::Sequence<u8>,
                _msg: &::dafny_runtime::Sequence<u8>
    ) -> ::std::rc::Rc<Wrappers::Result<::dafny_runtime::Sequence<u8>, ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
    ...
    /*
      pub fn ECDSAVerify(config: &::std::rc::Rc<AwsCryptographyPrimitivesOperations::Config>, input: &::std::rc::Rc<software::amazon::cryptography::primitives::internaldafny::types::ECDSAVerifyInput>) -> ::std::rc::Rc<Wrappers::Result<bool, ::std::rc::Rc<software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
        ...
        return output.read(); */
    pub fn Verify(_self: &::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::ECDSASignatureAlgorithm>,
                  _key: &::dafny_runtime::Sequence<u8>,
                  _msg: &::dafny_runtime::Sequence<u8>,
                  _sig: &::dafny_runtime::Sequence<u8>
    ) -> ::std::rc::Rc<Wrappers::Result<bool, ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>>> {
