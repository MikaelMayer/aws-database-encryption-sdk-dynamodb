...
impl EccPrivateKey {
    /// Creates a new builder-style object to manufacture [`EccPrivateKey`](crate::primitives::types::EccPrivateKey).
    pub fn builder() -> crate::primitives::types::builders::EccPrivateKeyBuilder {
        crate::primitives::types::builders::EccPrivateKeyBuilder::default()
    }
}

/// A builder for [`EccPrivateKey`](crate::primitives::types::EccPrivateKey).
#[non_exhaustive]
#[derive(
...
pub fn get_pem(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`EccPrivateKey`](crate::primitives::types::EccPrivateKey).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::types::EccPrivateKey {
            pem: self.pem,
        })
    }
}
