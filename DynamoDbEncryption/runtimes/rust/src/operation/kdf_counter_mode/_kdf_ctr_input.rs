...
impl KdfCtrInput {
    ...
    pub fn builder() -> crate::operation::kdf_counter_mode::builders::KdfCtrInputBuilder {
        crate::operation::kdf_counter_mode::builders::KdfCtrInputBuilder::default()
    }
}
...
pub fn get_purpose(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::kdf_counter_mode::KdfCtrInput {
