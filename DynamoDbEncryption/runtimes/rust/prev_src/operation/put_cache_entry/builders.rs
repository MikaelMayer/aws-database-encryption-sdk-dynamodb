...
pub use crate::operation::put_cache_entry::_unit::UnitBuilder;

pub use crate::operation::put_cache_entry::_put_cache_entry_input::PutCacheEntryInputBuilder;
...
pub struct PutCacheEntryFluentBuilder {
    cryptographic_materials_cache: crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef,
    pub(crate) inner: crate::operation::put_cache_entry::builders::PutCacheEntryInputBuilder,
}
impl PutCacheEntryFluentBuilder {
    /// Creates a new `PutCacheEntry`.
    pub(crate) fn new(cryptographic_materials_cache: crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef) -> Self {
        Self {
    ...
    pub fn as_input(&self) -> &crate::operation::put_cache_entry::builders::PutCacheEntryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::put_cache_entry::PutCacheEntry::send(&self.cryptographic_materials_cache, input).await
    }
...
#[allow(missing_docs)] // documentation missing in model
pub fn materials(mut self, input: impl ::std::convert::Into<material_providers::types::Materials>) -> Self {
    self.inner = self.inner.materials(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_materials(mut self, input: ::std::option::Option<material_providers::types::Materials>) -> Self {
    self.inner = self.inner.set_materials(input);
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_materials(&self) -> &::std::option::Option<material_providers::types::Materials> {
