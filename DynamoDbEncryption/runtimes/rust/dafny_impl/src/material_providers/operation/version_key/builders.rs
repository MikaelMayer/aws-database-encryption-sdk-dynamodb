...
pub use crate::material_providers::operation::version_key::_version_key_output::VersionKeyOutputBuilder;

pub use crate::material_providers::operation::version_key::_version_key_input::VersionKeyInputBuilder;
...
pub struct VersionKeyFluentBuilder {
    client: crate::material_providers::client::Client,
    pub(crate) inner: crate::material_providers::operation::version_key::builders::VersionKeyInputBuilder,
}
impl VersionKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::material_providers::operation::version_key::builders::VersionKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::material_providers::operation::version_key::VersionKey::send(&self.client, input).await
    }
