...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::transact_get_items::TransactGetItemsOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::TransactGetItemsOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::TransactGetItemsOutput::TransactGetItemsOutput {
...
pub fn from_dafny(
    ...
    crate::operation::transact_get_items::TransactGetItemsOutput::builder()
