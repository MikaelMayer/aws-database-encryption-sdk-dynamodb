...
pub use crate::primitives::operation::hkdf_expand::_hkdf_expand_output::HkdfExpandOutputBuilder;

pub use crate::primitives::operation::hkdf_expand::_hkdf_expand_input::HkdfExpandInputBuilder;
...
pub struct HkdfExpandFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::hkdf_expand::builders::HkdfExpandInputBuilder,
}
impl HkdfExpandFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::hkdf_expand::builders::HkdfExpandInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::hkdf_expand::HkdfExpand::send(&self.client, input).await
    }
