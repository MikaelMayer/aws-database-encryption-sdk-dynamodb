...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::batch_write_item::BatchWriteItemOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchWriteItemOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchWriteItemOutput::BatchWriteItemOutput {
        UnprocessedItems:
...
pub fn from_dafny(
    ...
    crate::operation::batch_write_item::BatchWriteItemOutput::builder()
