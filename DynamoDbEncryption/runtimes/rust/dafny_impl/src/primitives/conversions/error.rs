    ...
    ::std::rc::Rc<crate::software::amazon::cryptography::primitives::internaldafny::types::Error>
{
    ...
    ::std::rc::Rc::new(
        crate::software::amazon::cryptography::primitives::internaldafny::types::Error::Opaque {
            obj: error_obj,
        },
    )
}
...
pub fn to_dafny(
    ...
    crate::software::amazon::cryptography::primitives::internaldafny::types::Error::AwsCryptographicPrimitivesError {
        ...
        crate::primitives::types::error::Error::CollectionOfErrors { list, message } =>
            crate::software::amazon::cryptography::primitives::internaldafny::types::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&message),
...
pub fn from_dafny(
    ...
    match ::std::borrow::Borrow::borrow(&dafny_value) {
        crate::software::amazon::cryptography::primitives::internaldafny::types::Error::AwsCryptographicPrimitivesError { message } =>
    crate::primitives::types::error::Error::AwsCryptographicPrimitivesError {
        ...
        crate::software::amazon::cryptography::primitives::internaldafny::types::Error::CollectionOfErrors { list, message } =>
        ...
        crate::software::amazon::cryptography::primitives::internaldafny::types::Error::Opaque { obj } =>
