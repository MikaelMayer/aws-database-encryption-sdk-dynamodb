...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::BatchGetItemInput>>)`](crate::operation::batch_get_item_input_transform::builders::BatchGetItemInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::BatchGetItemInput>)`](crate::operation::batch_get_item_input_transform::builders::BatchGetItemInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::BatchGetItemInput>)`](crate::operation::batch_get_item_input_transform::BatchGetItemInputTransformOutput::transformed_input): (undocumented)
