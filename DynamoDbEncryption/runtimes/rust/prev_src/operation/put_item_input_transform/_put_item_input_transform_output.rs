...
pub struct PutItemInputTransformOutput {
    #[allow(missing_docs)] // documentation missing in model
pub transformed_input: ::std::option::Option<dynamodb::types::PutItemInput>,
}
impl PutItemInputTransformOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn transformed_input(&self) -> &::std::option::Option<dynamodb::types::PutItemInput> {
...
impl PutItemInputTransformOutput {
    ...
    pub fn builder() -> crate::operation::put_item_input_transform::builders::PutItemInputTransformOutputBuilder {
...
pub struct PutItemInputTransformOutputBuilder {
    pub(crate) transformed_input: ::std::option::Option<dynamodb::types::PutItemInput>,
}
impl PutItemInputTransformOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn transformed_input(mut self, input: impl ::std::convert::Into<dynamodb::types::PutItemInput>) -> Self {
    self.transformed_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_transformed_input(mut self, input: ::std::option::Option<dynamodb::types::PutItemInput>) -> Self {
    self.transformed_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_transformed_input(&self) -> &::std::option::Option<dynamodb::types::PutItemInput> {
    &self.transformed_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::put_item_input_transform::PutItemInputTransformOutput {
