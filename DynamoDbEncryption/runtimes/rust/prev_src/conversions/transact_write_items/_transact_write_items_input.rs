...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::transact_write_items::TransactWriteItemsInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::TransactWriteItemsInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::TransactWriteItemsInput::TransactWriteItemsInput {
        TransactItems: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.transact_items.clone().unwrap(),
    |e| dynamodb::conversions::transact_write_item::to_dafny(e.clone())
,
)
,
...
pub fn from_dafny(
    ...
    crate::operation::transact_write_items::TransactWriteItemsInput::builder()
        .set_transact_items(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.TransactItems(),
    |e| dynamodb::conversions::transact_write_item::from_dafny(e.clone())
,
)
 ))
