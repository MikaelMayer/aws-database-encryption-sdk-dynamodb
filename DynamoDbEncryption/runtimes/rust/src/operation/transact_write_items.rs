...
impl TransactWriteItems {
    ...
    > {
                let inner_input = crate::conversions::transact_write_items::_transact_write_items_input::to_dafny(input);
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).TransactWriteItems(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(
                crate::conversions::transact_write_items::_transact_write_items_output::from_dafny(inner_result.value().clone()),
            )
        } else {
...
pub(crate) mod _transact_write_items_output;

pub(crate) mod _transact_write_items_input;
