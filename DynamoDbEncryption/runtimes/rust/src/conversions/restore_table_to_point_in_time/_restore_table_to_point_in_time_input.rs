...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::restore_table_to_point_in_time::RestoreTableToPointInTimeInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::RestoreTableToPointInTimeInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::RestoreTableToPointInTimeInput::RestoreTableToPointInTimeInput {
...
pub fn from_dafny(
    ...
    crate::operation::restore_table_to_point_in_time::RestoreTableToPointInTimeInput::builder()
