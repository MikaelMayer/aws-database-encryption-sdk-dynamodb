...
pub use crate::primitives::operation::get_rsa_key_modulus_length::_get_rsa_key_modulus_length_output::GetRsaKeyModulusLengthOutputBuilder;

pub use crate::primitives::operation::get_rsa_key_modulus_length::_get_rsa_key_modulus_length_input::GetRsaKeyModulusLengthInputBuilder;
...
pub struct GetRsaKeyModulusLengthFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthInputBuilder,
}
impl GetRsaKeyModulusLengthFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::get_rsa_key_modulus_length::GetRsaKeyModulusLength::send(&self.client, input).await
    }
