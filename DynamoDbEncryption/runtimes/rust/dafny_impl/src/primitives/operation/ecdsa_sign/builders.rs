...
pub use crate::primitives::operation::ecdsa_sign::_ecdsa_sign_output::EcdsaSignOutputBuilder;

pub use crate::primitives::operation::ecdsa_sign::_ecdsa_sign_input::EcdsaSignInputBuilder;
...
pub struct EcdsaSignFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::ecdsa_sign::builders::EcdsaSignInputBuilder,
}
impl EcdsaSignFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::ecdsa_sign::builders::EcdsaSignInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::ecdsa_sign::EcdsaSign::send(&self.client, input).await
    }
