...
impl crate::client::Client {
    ...
    pub fn validate_commitment_policy_on_encrypt(&self) -> crate::operation::validate_commitment_policy_on_encrypt::builders::ValidateCommitmentPolicyOnEncryptFluentBuilder {
        crate::operation::validate_commitment_policy_on_encrypt::builders::ValidateCommitmentPolicyOnEncryptFluentBuilder::new(self.clone())
    }
}
