...
impl GenerateDataKeyWithoutPlaintextRequest {
    /// Creates a new builder-style object to manufacture [`GenerateDataKeyWithoutPlaintextRequest`](crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextRequest).
    pub fn builder() -> crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextRequestBuilder {
        crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextRequestBuilder::default()
    }
}

/// A builder for [`GenerateDataKeyWithoutPlaintextRequest`](crate::operation::operation::GenerateDataKeyWithoutPlaintextRequest).
#[non_exhaustive]
#[derive(
...
pub fn get_number_of_bytes(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    /// Consumes the builder and constructs a [`GenerateDataKeyWithoutPlaintextRequest`](crate::operation::operation::GenerateDataKeyWithoutPlaintextRequest).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextRequest,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextRequest {
