...
impl crate::client::Client {
    ...
    ///   - [`original_input(impl Into<Option<dynamodb::types::UpdateItemInput>>)`](crate::operation::update_item_output_transform::builders::UpdateItemOutputTransformFluentBuilder::original_input) / [`set_original_input(Option<dynamodb::types::UpdateItemInput>)`](crate::operation::update_item_output_transform::builders::UpdateItemOutputTransformFluentBuilder::set_original_input): (undocumented)<br>
    ///   - [`sdk_output(impl Into<Option<dynamodb::types::UpdateItemOutput>>)`](crate::operation::update_item_output_transform::builders::UpdateItemOutputTransformFluentBuilder::sdk_output) / [`set_sdk_output(Option<dynamodb::types::UpdateItemOutput>)`](crate::operation::update_item_output_transform::builders::UpdateItemOutputTransformFluentBuilder::set_sdk_output): (undocumented)<br>
    ...
    ///   - [`transformed_output(Option<dynamodb::types::UpdateItemOutput>)`](crate::operation::update_item_output_transform::UpdateItemOutputTransformOutput::transformed_output): (undocumented)
