...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_aws_kms_mrk_multi_keyring::CreateKeyringOutput,
) -> ::std::rc::Rc<
...
pub fn from_dafny(
    ...
    crate::operation::create_aws_kms_mrk_multi_keyring::CreateKeyringOutput::builder()
