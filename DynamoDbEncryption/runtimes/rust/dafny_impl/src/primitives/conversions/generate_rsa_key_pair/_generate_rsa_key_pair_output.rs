...
pub fn from_dafny(
    ...
    crate::primitives::operation::generate_rsa_key_pair::GenerateRsaKeyPairOutput::builder()
        .set_public_key(Some( crate::primitives::conversions::rsa_public_key::from_dafny(dafny_value.publicKey().clone())
 ))
 .set_private_key(Some( crate::primitives::conversions::rsa_private_key::from_dafny(dafny_value.privateKey().clone())
 ))
        .build()
        .unwrap()
}
