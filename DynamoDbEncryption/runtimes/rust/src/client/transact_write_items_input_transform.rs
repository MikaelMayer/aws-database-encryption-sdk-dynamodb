...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::TransactWriteItemsInput>>)`](crate::operation::transact_write_items_input_transform::builders::TransactWriteItemsInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::TransactWriteItemsInput>)`](crate::operation::transact_write_items_input_transform::builders::TransactWriteItemsInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::TransactWriteItemsInput>)`](crate::operation::transact_write_items_input_transform::TransactWriteItemsInputTransformOutput::transformed_input): (undocumented)
