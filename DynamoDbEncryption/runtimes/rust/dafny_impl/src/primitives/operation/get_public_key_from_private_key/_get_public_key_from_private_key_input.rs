...
impl GetPublicKeyFromPrivateKeyInput {
    /// Creates a new builder-style object to manufacture [`GetPublicKeyFromPrivateKeyInput`](crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInput).
    pub fn builder() -> crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInputBuilder {
        crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyInputBuilder::default()
    }
}

/// A builder for [`GetPublicKeyFromPrivateKeyInput`](crate::primitives::operation::operation::GetPublicKeyFromPrivateKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_private_key(&self) -> &::std::option::Option<crate::primitives::types::EccPrivateKey> {
    ...
    /// Consumes the builder and constructs a [`GetPublicKeyFromPrivateKeyInput`](crate::primitives::operation::operation::GetPublicKeyFromPrivateKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::get_public_key_from_private_key::GetPublicKeyFromPrivateKeyInput {
