...
pub struct GetItemOutputTransformFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_item_output_transform::builders::GetItemOutputTransformInputBuilder,
}
impl GetItemOutputTransformFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_item_output_transform::builders::GetItemOutputTransformInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_item_output_transform::GetItemOutputTransform::send(&self.client, input).await
    }
