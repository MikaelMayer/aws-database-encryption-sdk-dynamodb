...
impl crate::client::Client {
    ...
    ///   - [`item(impl Into<Option<::std::collections::HashMap<::std::string::String, dynamodb::types::AttributeValue>>>)`](crate::operation::resolve_attributes::builders::ResolveAttributesFluentBuilder::item) / [`set_item(Option<::std::collections::HashMap<::std::string::String, dynamodb::types::AttributeValue>>)`](crate::operation::resolve_attributes::builders::ResolveAttributesFluentBuilder::set_item): (undocumented)<br>
