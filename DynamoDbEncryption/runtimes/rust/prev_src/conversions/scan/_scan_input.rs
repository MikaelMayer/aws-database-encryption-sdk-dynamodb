...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::scan::ScanInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ScanInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ScanInput::ScanInput {
...
pub fn from_dafny(
    ...
    crate::operation::scan::ScanInput::builder()
