...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::delete_item::DeleteItemOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DeleteItemOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DeleteItemOutput::DeleteItemOutput {
        Attributes:
...
pub fn from_dafny(
    ...
    crate::operation::delete_item::DeleteItemOutput::builder()
