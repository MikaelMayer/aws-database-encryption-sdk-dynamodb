...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_grant::CreateGrantRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateGrantRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateGrantRequest::CreateGrantRequest {
 ...
 Operations: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.operations.clone().unwrap(),
    |e| kms::conversions::grant_operation::to_dafny(e.clone()),
)
,
 Constraints: ::std::rc::Rc::new(match &value.constraints {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::grant_constraints::to_dafny(x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::create_grant::CreateGrantRequest::builder()
 ...
 .set_operations(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.Operations(),
    |e| kms::conversions::grant_operation::from_dafny(e),
)
 ))
 .set_constraints(match (*dafny_value.Constraints()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(kms::conversions::grant_constraints::from_dafny(value.clone())),
    _ => None,
}
)
