...
pub use crate::operation::initialize_decryption_materials::_decryption_materials::DecryptionMaterialsBuilder;

pub use crate::operation::initialize_decryption_materials::_initialize_decryption_materials_input::InitializeDecryptionMaterialsInputBuilder;
...
pub struct InitializeDecryptionMaterialsFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInputBuilder,
}
impl InitializeDecryptionMaterialsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::initialize_decryption_materials::InitializeDecryptionMaterials::send(&self.client, input).await
    }
