...
pub use crate::operation::encrypt_structure::_encrypt_structure_output::EncryptStructureOutputBuilder;

pub use crate::operation::encrypt_structure::_encrypt_structure_input::EncryptStructureInputBuilder;
...
pub struct EncryptStructureFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::encrypt_structure::builders::EncryptStructureInputBuilder,
}
impl EncryptStructureFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::encrypt_structure::builders::EncryptStructureInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::encrypt_structure::EncryptStructure::send(&self.client, input).await
    }
