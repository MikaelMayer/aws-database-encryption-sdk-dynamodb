...
impl crate::client::Client {
    ...
    ///   - [`algorithm_suite_id(impl Into<Option<material_providers::types::AlgorithmSuiteId>>)`](crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsFluentBuilder::algorithm_suite_id) / [`set_algorithm_suite_id(Option<material_providers::types::AlgorithmSuiteId>)`](crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsFluentBuilder::set_algorithm_suite_id): (undocumented)<br>
    ...
    ///   - [`algorithm_suite(Option<material_providers::types::AlgorithmSuiteInfo>)`](crate::operation::initialize_decryption_materials::DecryptionMaterials::algorithm_suite): (undocumented)
    ...
    pub fn initialize_decryption_materials(&self) -> crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsFluentBuilder {
        crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsFluentBuilder::new(self.clone())
    }
}
