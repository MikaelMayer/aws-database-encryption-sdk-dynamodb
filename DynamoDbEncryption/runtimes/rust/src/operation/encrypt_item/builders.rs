...
pub use crate::operation::encrypt_item::_encrypt_item_output::EncryptItemOutputBuilder;

pub use crate::operation::encrypt_item::_encrypt_item_input::EncryptItemInputBuilder;
...
pub struct EncryptItemFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::encrypt_item::builders::EncryptItemInputBuilder,
}
impl EncryptItemFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::encrypt_item::builders::EncryptItemInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::encrypt_item::EncryptItem::send(&self.client, input).await
    }
