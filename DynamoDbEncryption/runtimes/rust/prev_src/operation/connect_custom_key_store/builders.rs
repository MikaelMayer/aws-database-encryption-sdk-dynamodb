...
pub use crate::operation::connect_custom_key_store::_connect_custom_key_store_response::ConnectCustomKeyStoreResponseBuilder;

pub use crate::operation::connect_custom_key_store::_connect_custom_key_store_request::ConnectCustomKeyStoreRequestBuilder;
...
pub struct ConnectCustomKeyStoreFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreRequestBuilder,
}
impl ConnectCustomKeyStoreFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::connect_custom_key_store::ConnectCustomKeyStore::send(&self.client, input).await
    }
