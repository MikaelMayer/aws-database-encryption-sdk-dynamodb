...
pub use crate::operation::retire_grant::_unit::UnitBuilder;

pub use crate::operation::retire_grant::_retire_grant_request::RetireGrantRequestBuilder;
...
pub struct RetireGrantFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::retire_grant::builders::RetireGrantRequestBuilder,
}
impl RetireGrantFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::retire_grant::builders::RetireGrantRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::retire_grant::RetireGrant::send(&self.client, input).await
    }
