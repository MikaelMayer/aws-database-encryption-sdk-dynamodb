...
pub use crate::operation::hkdf_expand::_hkdf_expand_output::HkdfExpandOutputBuilder;

pub use crate::operation::hkdf_expand::_hkdf_expand_input::HkdfExpandInputBuilder;
...
pub struct HkdfExpandFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::hkdf_expand::builders::HkdfExpandInputBuilder,
}
impl HkdfExpandFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::hkdf_expand::builders::HkdfExpandInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::hkdf_expand::HkdfExpand::send(&self.client, input).await
    }
