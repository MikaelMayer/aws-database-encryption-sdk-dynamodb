...
impl crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef {
    ...
    ///   - [`encryption_materials(Option<material_providers::types::EncryptionMaterials>)`](crate::operation::get_encryption_materials::GetEncryptionMaterialsOutput::encryption_materials): (undocumented)
    ...
    pub fn get_encryption_materials(&self) -> crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder {
        crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder::new(self.clone())
    }
}
