...
pub use crate::operation::get_parameters_for_import::_get_parameters_for_import_response::GetParametersForImportResponseBuilder;

pub use crate::operation::get_parameters_for_import::_get_parameters_for_import_request::GetParametersForImportRequestBuilder;
...
pub struct GetParametersForImportFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_parameters_for_import::builders::GetParametersForImportRequestBuilder,
}
impl GetParametersForImportFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_parameters_for_import::builders::GetParametersForImportRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_parameters_for_import::GetParametersForImport::send(&self.client, input).await
    }
...
pub fn wrapping_algorithm(mut self, input: impl ::std::convert::Into<kms::types::AlgorithmSpec>) -> Self {
    self.inner = self.inner.wrapping_algorithm(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn wrapping_key_spec(mut self, input: impl ::std::convert::Into<kms::types::WrappingKeySpec>) -> Self {
    self.inner = self.inner.wrapping_key_spec(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
