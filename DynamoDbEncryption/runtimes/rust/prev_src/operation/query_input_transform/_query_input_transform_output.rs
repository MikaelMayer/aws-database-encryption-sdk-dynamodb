...
pub struct QueryInputTransformOutput {
    #[allow(missing_docs)] // documentation missing in model
pub transformed_input: ::std::option::Option<dynamodb::types::QueryInput>,
}
impl QueryInputTransformOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn transformed_input(&self) -> &::std::option::Option<dynamodb::types::QueryInput> {
...
impl QueryInputTransformOutput {
    ...
    pub fn builder() -> crate::operation::query_input_transform::builders::QueryInputTransformOutputBuilder {
...
pub struct QueryInputTransformOutputBuilder {
    pub(crate) transformed_input: ::std::option::Option<dynamodb::types::QueryInput>,
}
impl QueryInputTransformOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn transformed_input(mut self, input: impl ::std::convert::Into<dynamodb::types::QueryInput>) -> Self {
    self.transformed_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_transformed_input(mut self, input: ::std::option::Option<dynamodb::types::QueryInput>) -> Self {
    self.transformed_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_transformed_input(&self) -> &::std::option::Option<dynamodb::types::QueryInput> {
    &self.transformed_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::query_input_transform::QueryInputTransformOutput {
