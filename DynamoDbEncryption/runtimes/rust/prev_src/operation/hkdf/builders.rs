...
pub use crate::operation::hkdf::_hkdf_output::HkdfOutputBuilder;

pub use crate::operation::hkdf::_hkdf_input::HkdfInputBuilder;
...
impl HkdfInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::hkdf::HkdfOutput,
...
pub struct HkdfFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::hkdf::builders::HkdfInputBuilder,
}
impl HkdfFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::hkdf::builders::HkdfInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::hkdf::Hkdf::send(&self.client, input).await
    }
