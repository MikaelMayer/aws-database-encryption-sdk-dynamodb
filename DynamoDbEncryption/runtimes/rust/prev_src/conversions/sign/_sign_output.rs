...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::sign::SignResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::SignResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::SignResponse::SignResponse {
...
pub fn from_dafny(
    ...
    crate::operation::sign::SignResponse::builder()
