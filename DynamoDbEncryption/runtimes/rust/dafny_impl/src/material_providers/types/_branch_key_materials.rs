...
impl BranchKeyMaterials {
    /// Creates a new builder-style object to manufacture [`BranchKeyMaterials`](crate::material_providers::types::BranchKeyMaterials).
    pub fn builder() -> crate::material_providers::types::builders::BranchKeyMaterialsBuilder {
        crate::material_providers::types::builders::BranchKeyMaterialsBuilder::default()
    }
}

/// A builder for [`BranchKeyMaterials`](crate::material_providers::types::BranchKeyMaterials).
#[non_exhaustive]
#[derive(
...
pub fn get_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`BranchKeyMaterials`](crate::material_providers::types::BranchKeyMaterials).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::material_providers::types::BranchKeyMaterials {
