...
impl CreateRawAesKeyring {
    ...
    > {
                let inner_input = crate::conversions::create_raw_aes_keyring::_create_raw_aes_keyring_input::to_dafny(input);
        let inner_result =
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::create_raw_aes_keyring::_create_raw_aes_keyring_output::from_dafny(
