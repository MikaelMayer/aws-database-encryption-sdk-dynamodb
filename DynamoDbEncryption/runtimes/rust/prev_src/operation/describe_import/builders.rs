...
pub struct DescribeImportFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::describe_import::builders::DescribeImportInputBuilder,
}
impl DescribeImportFluentBuilder {
    ...
    > {
        ...
        crate::operation::describe_import::DescribeImport::send(&self.client, input).await
    }
