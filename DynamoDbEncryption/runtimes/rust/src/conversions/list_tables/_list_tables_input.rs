...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_tables::ListTablesInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListTablesInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListTablesInput::ListTablesInput {
...
pub fn from_dafny(
    ...
    crate::operation::list_tables::ListTablesInput::builder()
