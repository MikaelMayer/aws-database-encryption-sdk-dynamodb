...
pub struct ExecuteTransactionInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::ExecuteTransactionInput>,
}
impl ExecuteTransactionInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::ExecuteTransactionInput> {
    &self.sdk_input
}
}
impl ExecuteTransactionInputTransformInput {
...
pub struct ExecuteTransactionInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::ExecuteTransactionInput>,
}
impl ExecuteTransactionInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::ExecuteTransactionInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::ExecuteTransactionInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::ExecuteTransactionInput> {
    &self.sdk_input
}
