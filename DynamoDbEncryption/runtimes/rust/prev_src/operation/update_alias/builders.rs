...
pub use crate::operation::update_alias::_unit::UnitBuilder;

pub use crate::operation::update_alias::_update_alias_request::UpdateAliasRequestBuilder;
...
pub struct UpdateAliasFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::update_alias::builders::UpdateAliasRequestBuilder,
}
impl UpdateAliasFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::update_alias::builders::UpdateAliasRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::update_alias::UpdateAlias::send(&self.client, input).await
    }
