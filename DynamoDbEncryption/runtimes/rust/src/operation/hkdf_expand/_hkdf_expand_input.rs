...
pub struct HkdfExpandInput {
    #[allow(missing_docs)] // documentation missing in model
pub digest_algorithm: ::std::option::Option<primitives::types::DigestAlgorithm>,
#[allow(missing_docs)] // documentation missing in model
...
impl HkdfExpandInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn digest_algorithm(&self) -> &::std::option::Option<primitives::types::DigestAlgorithm> {
...
impl HkdfExpandInput {
    ...
    pub fn builder() -> crate::operation::hkdf_expand::builders::HkdfExpandInputBuilder {
        crate::operation::hkdf_expand::builders::HkdfExpandInputBuilder::default()
    }
}
...
pub struct HkdfExpandInputBuilder {
    pub(crate) digest_algorithm: ::std::option::Option<primitives::types::DigestAlgorithm>,
...
impl HkdfExpandInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn digest_algorithm(mut self, input: impl ::std::convert::Into<primitives::types::DigestAlgorithm>) -> Self {
    self.digest_algorithm = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_digest_algorithm(mut self, input: ::std::option::Option<primitives::types::DigestAlgorithm>) -> Self {
    self.digest_algorithm = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_digest_algorithm(&self) -> &::std::option::Option<primitives::types::DigestAlgorithm> {
    &self.digest_algorithm
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_prk(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    pub fn build(
        ...
        crate::operation::hkdf_expand::HkdfExpandInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::hkdf_expand::HkdfExpandInput {
