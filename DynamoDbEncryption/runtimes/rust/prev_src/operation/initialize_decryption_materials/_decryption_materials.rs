...
impl DecryptionMaterials {
    ...
    pub fn builder() -> crate::operation::initialize_decryption_materials::builders::DecryptionMaterialsBuilder {
        crate::operation::initialize_decryption_materials::builders::DecryptionMaterialsBuilder::default()
    }
}
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::initialize_decryption_materials::DecryptionMaterials {
