...
pub struct TransactGetItemsOutputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub original_input: ::std::option::Option<dynamodb::types::TransactGetItemsInput>,
#[allow(missing_docs)] // documentation missing in model
pub sdk_output: ::std::option::Option<dynamodb::types::TransactGetItemsOutput>,
}
impl TransactGetItemsOutputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn original_input(&self) -> &::std::option::Option<dynamodb::types::TransactGetItemsInput> {
    &self.original_input
}
#[allow(missing_docs)] // documentation missing in model
pub fn sdk_output(&self) -> &::std::option::Option<dynamodb::types::TransactGetItemsOutput> {
    &self.sdk_output
}
}
impl TransactGetItemsOutputTransformInput {
...
pub struct TransactGetItemsOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<dynamodb::types::TransactGetItemsInput>,
pub(crate) sdk_output: ::std::option::Option<dynamodb::types::TransactGetItemsOutput>,
}
