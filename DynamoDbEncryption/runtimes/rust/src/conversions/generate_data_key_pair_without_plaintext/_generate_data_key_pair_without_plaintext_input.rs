...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyPairWithoutPlaintextRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyPairWithoutPlaintextRequest::GenerateDataKeyPairWithoutPlaintextRequest {
        EncryptionContext:
...
pub fn from_dafny(
    ...
    crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextRequest::builder()
