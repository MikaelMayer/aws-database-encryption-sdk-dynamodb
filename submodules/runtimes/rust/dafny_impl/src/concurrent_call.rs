...
pub mod ConcurrentCall {
  ...
  fn de_const(p: *const dafny_runtime::Object<(dyn Callee + 'static)>) -> *mut dafny_runtime::Object<(dyn Callee + 'static)>
  {
    p as _
  }
  ...
  impl FakeCallee {
    fn new(callee : &dafny_runtime::Object<(dyn Callee + 'static)>) -> Self {
      Self{callee : std::ptr::from_ref(callee)}
    }
  ...
  impl _default {
    pub fn ConcurrentCall(callee : &dafny_runtime::Object<(dyn Callee + 'static)>, serial_iters : u32, concurrent_iters : u32)
    {
