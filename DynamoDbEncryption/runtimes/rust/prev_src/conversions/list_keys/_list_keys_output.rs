...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_keys::ListKeysResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListKeysResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListKeysResponse::ListKeysResponse {
        Keys: ::std::rc::Rc::new(match &value.keys {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(x,
            |e| kms::conversions::key_list_entry::to_dafny(e.clone())
,
        )
    },
...
pub fn from_dafny(
    ...
    crate::operation::list_keys::ListKeysResponse::builder()
        .set_keys(match (*dafny_value.Keys()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e| kms::conversions::key_list_entry::from_dafny(e.clone())
,
            )
        ),
    _ => None
