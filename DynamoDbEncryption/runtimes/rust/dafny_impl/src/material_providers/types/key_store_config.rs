...
pub struct KeyStoreConfig {
    #[allow(missing_docs)] // documentation missing in model
pub ddb_client: ::std::option::Option<dynamodb::client::Client>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub kms_client: ::std::option::Option<kms::client::Client>,
#[allow(missing_docs)] // documentation missing in model
pub kms_configuration: ::std::option::Option<crate::material_providers::types::KmsConfiguration>,
#[allow(missing_docs)] // documentation missing in model
pub logical_key_store_name: ::std::option::Option<::std::string::String>,
}
impl KeyStoreConfig {
    #[allow(missing_docs)] // documentation missing in model
pub fn ddb_client(&self) -> &::std::option::Option<dynamodb::client::Client> {
    &self.ddb_client
}
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn kms_client(&self) -> &::std::option::Option<kms::client::Client> {
    &self.kms_client
}
#[allow(missing_docs)] // documentation missing in model
pub fn kms_configuration(&self) -> &::std::option::Option<crate::material_providers::types::KmsConfiguration> {
...
impl KeyStoreConfig {
    /// Creates a new builder-style object to manufacture [`KeyStoreConfig`](crate::material_providers::types::KeyStoreConfig).
    pub fn builder() -> crate::material_providers::types::key_store_config::KeyStoreConfigBuilder {
        crate::material_providers::types::key_store_config::KeyStoreConfigBuilder::default()
    }
}

/// A builder for [`KeyStoreConfig`](crate::material_providers::types::KeyStoreConfig).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct KeyStoreConfigBuilder {
    pub(crate) ddb_client: ::std::option::Option<dynamodb::client::Client>,
pub(crate) ddb_table_name: ::std::option::Option<::std::string::String>,
pub(crate) grant_tokens: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
pub(crate) id: ::std::option::Option<::std::string::String>,
pub(crate) kms_client: ::std::option::Option<kms::client::Client>,
pub(crate) kms_configuration: ::std::option::Option<crate::material_providers::types::KmsConfiguration>,
pub(crate) logical_key_store_name: ::std::option::Option<::std::string::String>,
}
impl KeyStoreConfigBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn ddb_client(mut self, input: impl ::std::convert::Into<dynamodb::client::Client>) -> Self {
    self.ddb_client = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_ddb_client(mut self, input: ::std::option::Option<dynamodb::client::Client>) -> Self {
    self.ddb_client = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_ddb_client(&self) -> &::std::option::Option<dynamodb::client::Client> {
    &self.ddb_client
}
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn kms_configuration(mut self, input: impl ::std::convert::Into<crate::material_providers::types::KmsConfiguration>) -> Self {
    self.kms_configuration = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_kms_configuration(mut self, input: ::std::option::Option<crate::material_providers::types::KmsConfiguration>) -> Self {
    self.kms_configuration = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_kms_configuration(&self) -> &::std::option::Option<crate::material_providers::types::KmsConfiguration> {
    &self.kms_configuration
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_logical_key_store_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`KeyStoreConfig`](crate::material_providers::types::KeyStoreConfig).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::material_providers::types::key_store_config::KeyStoreConfig {
