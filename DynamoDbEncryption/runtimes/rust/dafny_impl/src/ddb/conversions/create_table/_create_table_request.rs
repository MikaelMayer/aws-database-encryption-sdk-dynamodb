...
pub fn from_dafny(
    ...
    client
        ...
        .set_local_secondary_indexes(match (*dafny_value.LocalSecondaryIndexes()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::local_secondary_index::from_dafny(e.clone())
                }),
            ),
            _ => None,
        })
        .set_global_secondary_indexes(match (*dafny_value.GlobalSecondaryIndexes()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::global_secondary_index::from_dafny(e.clone())
                }),
            ),
            _ => None,
        })
        .set_billing_mode(match &**dafny_value.BillingMode() {
            crate::Wrappers::Option::Some { value } => {
                Some(crate::ddb::conversions::billing_mode::from_dafny(value))
            }
            _ => None,
        })
        .set_provisioned_throughput(match (*dafny_value.ProvisionedThroughput()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::provisioned_throughput::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_stream_specification(match (*dafny_value.StreamSpecification()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::stream_specification::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_sse_specification(match (*dafny_value.SSESpecification()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                crate::ddb::conversions::sse_specification::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_tags(match (*dafny_value.Tags()).as_ref() {
            crate::Wrappers::Option::Some { value } => Some(
                ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value, |e| {
                    crate::ddb::conversions::tag::from_dafny(e.clone())
                }),
            ),
            _ => None,
        })
