...
impl EncryptionMaterials {
    ...
    pub fn builder() -> crate::operation::initialize_encryption_materials::builders::EncryptionMaterialsBuilder {
        crate::operation::initialize_encryption_materials::builders::EncryptionMaterialsBuilder::default()
    }
}
...
pub fn get_symmetric_signing_keys(&self) -> &::std::option::Option<::std::vec::Vec<::aws_smithy_types::Blob>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::initialize_encryption_materials::EncryptionMaterials {
