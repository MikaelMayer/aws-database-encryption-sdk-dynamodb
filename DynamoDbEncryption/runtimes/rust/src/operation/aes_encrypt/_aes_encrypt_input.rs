...
#[allow(missing_docs)] // documentation missing in model
pub enc_alg: ::std::option::Option<primitives::types::AesGcm>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn enc_alg(&self) -> &::std::option::Option<primitives::types::AesGcm> {
    &self.enc_alg
}
#[allow(missing_docs)] // documentation missing in model
...
impl AesEncryptInput {
    ...
    pub fn builder() -> crate::operation::aes_encrypt::builders::AesEncryptInputBuilder {
        crate::operation::aes_encrypt::builders::AesEncryptInputBuilder::default()
    }
}
...
pub(crate) enc_alg: ::std::option::Option<primitives::types::AesGcm>,
...
pub fn get_msg(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::aes_encrypt::AesEncryptInput {
            aad: self.aad,
