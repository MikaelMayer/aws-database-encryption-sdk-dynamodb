...
impl crate::client::Client {
    ...
    ///   - [`kms_client(impl Into<Option<kms::client::Client>>)`](crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringFluentBuilder::kms_client) / [`set_kms_client(Option<kms::client::Client>)`](crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringFluentBuilder::set_kms_client): (undocumented)<br>
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_mrk_discovery_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_mrk_discovery_keyring(&self) -> crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringFluentBuilder {
        crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringFluentBuilder::new(self.clone())
    }
}
