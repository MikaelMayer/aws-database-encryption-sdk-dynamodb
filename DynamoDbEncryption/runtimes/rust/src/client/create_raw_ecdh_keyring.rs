...
impl crate::client::Client {
    ...
    pub fn create_raw_ecdh_keyring(&self) -> crate::operation::create_raw_ecdh_keyring::builders::CreateRawEcdhKeyringFluentBuilder {
        crate::operation::create_raw_ecdh_keyring::builders::CreateRawEcdhKeyringFluentBuilder::new(self.clone())
    }
}
