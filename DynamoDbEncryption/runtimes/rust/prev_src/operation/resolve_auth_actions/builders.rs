...
pub use crate::operation::resolve_auth_actions::_resolve_auth_actions_output::ResolveAuthActionsOutputBuilder;

pub use crate::operation::resolve_auth_actions::_resolve_auth_actions_input::ResolveAuthActionsInputBuilder;
...
pub struct ResolveAuthActionsFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::resolve_auth_actions::builders::ResolveAuthActionsInputBuilder,
}
impl ResolveAuthActionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::resolve_auth_actions::builders::ResolveAuthActionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::resolve_auth_actions::ResolveAuthActions::send(&self.client, input).await
    }
