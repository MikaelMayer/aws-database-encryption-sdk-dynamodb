...
impl GenerateEccKeyPairInput {
    ...
    pub fn builder() -> crate::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairInputBuilder {
        crate::operation::generate_ecc_key_pair::builders::GenerateEccKeyPairInputBuilder::default()
    }
}
...
pub fn get_ecc_curve(&self) -> &::std::option::Option<primitives::types::EcdhCurveSpec> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_ecc_key_pair::GenerateEccKeyPairInput {
