...
impl crate::client::Client {
    ...
    ///   - [`beacon_key_materials(Option<key_store::types::BeaconKeyMaterials>)`](crate::operation::get_beacon_key::GetBeaconKeyOutput::beacon_key_materials): (undocumented)
    /// - On failure, responds with [`SdkError<GetBeaconKeyError>`](crate::operation::get_beacon_key::GetBeaconKeyError)
    pub fn get_beacon_key(&self) -> crate::operation::get_beacon_key::builders::GetBeaconKeyFluentBuilder {
        crate::operation::get_beacon_key::builders::GetBeaconKeyFluentBuilder::new(self.clone())
    }
}
