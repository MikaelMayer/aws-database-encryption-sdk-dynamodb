...
impl GenerateRsaKeyPairInput {
    ...
    pub fn builder() -> crate::operation::generate_rsa_key_pair::builders::GenerateRsaKeyPairInputBuilder {
        crate::operation::generate_rsa_key_pair::builders::GenerateRsaKeyPairInputBuilder::default()
    }
}
...
pub fn get_length_bits(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_rsa_key_pair::GenerateRsaKeyPairInput {
