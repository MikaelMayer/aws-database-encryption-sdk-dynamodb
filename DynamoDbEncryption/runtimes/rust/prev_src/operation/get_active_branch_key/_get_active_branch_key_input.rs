...
impl GetActiveBranchKeyInput {
    ...
    pub fn builder() -> crate::operation::get_active_branch_key::builders::GetActiveBranchKeyInputBuilder {
        crate::operation::get_active_branch_key::builders::GetActiveBranchKeyInputBuilder::default()
    }
}
...
pub fn get_branch_key_identifier(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_active_branch_key::GetActiveBranchKeyInput {
