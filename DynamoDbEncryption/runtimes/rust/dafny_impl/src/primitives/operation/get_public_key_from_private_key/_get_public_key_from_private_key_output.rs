...
impl GetPublicKeyFromPrivateKeyOutput {
    /// Creates a new builder-style object to manufacture [`GetPublicKeyFromPrivateKeyOutput`](crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyOutput).
    pub fn builder() -> crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyOutputBuilder {
        crate::primitives::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyOutputBuilder::default()
    }
}

/// A builder for [`GetPublicKeyFromPrivateKeyOutput`](crate::primitives::operation::operation::GetPublicKeyFromPrivateKeyOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`GetPublicKeyFromPrivateKeyOutput`](crate::primitives::operation::operation::GetPublicKeyFromPrivateKeyOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::get_public_key_from_private_key::GetPublicKeyFromPrivateKeyOutput {
