...
impl crate::client::Client {
    ...
    ///   - [`digest_algorithm(impl Into<Option<primitives::types::DigestAlgorithm>>)`](crate::operation::hkdf_extract::builders::HkdfExtractFluentBuilder::digest_algorithm) / [`set_digest_algorithm(Option<primitives::types::DigestAlgorithm>)`](crate::operation::hkdf_extract::builders::HkdfExtractFluentBuilder::set_digest_algorithm): (undocumented)<br>
    ...
    pub fn hkdf_extract(&self) -> crate::operation::hkdf_extract::builders::HkdfExtractFluentBuilder {
        crate::operation::hkdf_extract::builders::HkdfExtractFluentBuilder::new(self.clone())
    }
}
