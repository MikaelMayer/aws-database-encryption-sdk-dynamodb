...
pub use crate::primitives::operation::hkdf::_hkdf_output::HkdfOutputBuilder;

pub use crate::primitives::operation::hkdf::_hkdf_input::HkdfInputBuilder;
...
pub struct HkdfFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::hkdf::builders::HkdfInputBuilder,
}
impl HkdfFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::hkdf::builders::HkdfInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::hkdf::Hkdf::send(&self.client, input).await
    }
