...
impl CompressPublicKey {
    ...
    pub(crate) async fn send(
        ...
        input: crate::primitives::operation::compress_public_key::CompressPublicKeyInput,
    ) -> ::std::result::Result<
        crate::primitives::operation::compress_public_key::CompressPublicKeyOutput,
        crate::primitives::types::error::Error,
    > {
                let inner_input = crate::primitives::conversions::compress_public_key::_compress_public_key_input::to_dafny(input);
        let inner_result =
        ...
        if matches!(
            ...
            Ok(
                crate::primitives::conversions::compress_public_key::_compress_public_key_output::from_dafny(inner_result.value().clone()),
            )
        } else {
...
pub use crate::primitives::operation::compress_public_key::_compress_public_key_output::CompressPublicKeyOutput;

pub use crate::primitives::operation::compress_public_key::_compress_public_key_input::CompressPublicKeyInput;
