...
impl AesEncryptOutput {
    /// Creates a new builder-style object to manufacture [`AesEncryptOutput`](crate::primitives::operation::aes_encrypt::builders::AesEncryptOutput).
    pub fn builder() -> crate::primitives::operation::aes_encrypt::builders::AesEncryptOutputBuilder {
        crate::primitives::operation::aes_encrypt::builders::AesEncryptOutputBuilder::default()
    }
}

/// A builder for [`AesEncryptOutput`](crate::primitives::operation::operation::AesEncryptOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_cipher_text(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`AesEncryptOutput`](crate::primitives::operation::operation::AesEncryptOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::aes_encrypt::AesEncryptOutput {
