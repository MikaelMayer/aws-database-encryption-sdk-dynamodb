...
pub use crate::operation::version_key::_version_key_output::VersionKeyOutputBuilder;

pub use crate::operation::version_key::_version_key_input::VersionKeyInputBuilder;
...
impl VersionKeyInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::version_key::VersionKeyOutput,
...
pub struct VersionKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::version_key::builders::VersionKeyInputBuilder,
}
impl VersionKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::version_key::builders::VersionKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::version_key::VersionKey::send(&self.client, input).await
    }
