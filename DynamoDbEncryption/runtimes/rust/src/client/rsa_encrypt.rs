...
impl crate::client::Client {
    ...
    ///   - [`padding(impl Into<Option<primitives::types::RsaPaddingMode>>)`](crate::operation::rsa_encrypt::builders::RSAEncryptFluentBuilder::padding) / [`set_padding(Option<primitives::types::RsaPaddingMode>)`](crate::operation::rsa_encrypt::builders::RSAEncryptFluentBuilder::set_padding): (undocumented)<br>
    ...
    pub fn rsa_encrypt(&self) -> crate::operation::rsa_encrypt::builders::RsaEncryptFluentBuilder {
        crate::operation::rsa_encrypt::builders::RsaEncryptFluentBuilder::new(self.clone())
    }
}
