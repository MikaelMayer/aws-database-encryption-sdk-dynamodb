...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_custom_key_store::UpdateCustomKeyStoreRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateCustomKeyStoreRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateCustomKeyStoreRequest::UpdateCustomKeyStoreRequest {
...
pub fn from_dafny(
    ...
    crate::operation::update_custom_key_store::UpdateCustomKeyStoreRequest::builder()
