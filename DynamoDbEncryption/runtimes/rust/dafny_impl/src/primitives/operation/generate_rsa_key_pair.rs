...
impl GenerateRsaKeyPair {
    ...
    pub(crate) async fn send(
        ...
        input: crate::primitives::operation::generate_rsa_key_pair::GenerateRsaKeyPairInput,
    ) -> ::std::result::Result<
        crate::primitives::operation::generate_rsa_key_pair::GenerateRsaKeyPairOutput,
        crate::primitives::types::error::Error,
    > {
                let inner_input = crate::primitives::conversions::generate_rsa_key_pair::_generate_rsa_key_pair_input::to_dafny(input);
        let inner_result =
        ...
        if matches!(
            ...
            Ok(
                crate::primitives::conversions::generate_rsa_key_pair::_generate_rsa_key_pair_output::from_dafny(inner_result.value().clone()),
            )
        } else {
...
pub use crate::primitives::operation::generate_rsa_key_pair::_generate_rsa_key_pair_output::GenerateRsaKeyPairOutput;

pub use crate::primitives::operation::generate_rsa_key_pair::_generate_rsa_key_pair_input::GenerateRsaKeyPairInput;
