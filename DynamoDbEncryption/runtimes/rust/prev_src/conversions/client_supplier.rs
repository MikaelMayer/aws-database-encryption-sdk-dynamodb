...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::types::client_supplier::ClientSupplierRef,
) -> ::dafny_runtime::Object<
  dyn crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IClientSupplier,
> {
...
pub struct ClientSupplierWrapper {
  obj: crate::types::client_supplier::ClientSupplierRef,
}
...
impl crate::aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IClientSupplier
  for ClientSupplierWrapper
{
  fn r#_GetResourceData_k(
      &mut self,
      input: &::std::rc::Rc<
      crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetClientInput,
      >,
  ) -> ::std::rc::Rc<
  ...
  {
      let inner_input =
          crate::conversions::get_client::_get_client_input::from_dafny(
              input.clone(),
          );
      let inner_result = self.obj.inner.borrow_mut().get_client(inner_input);
      let result = match inner_result {
          Ok(x) => crate::r#_Wrappers_Compile::Result::Success {
              value: crate::conversions::get_client::_get_client_output::to_dafny(
                  x,
              ),
          },
...
impl crate::types::client_supplier::ClientSupplier for IClientSupplierDafnyWrapper {
  ...
  > {
      let inner_input =
          crate::conversions::get_client::_get_client_input::to_dafny(input);
      ...
      if matches!(
          ...
          Ok(
              crate::conversions::get_client::_get_client_output::from_dafny(
