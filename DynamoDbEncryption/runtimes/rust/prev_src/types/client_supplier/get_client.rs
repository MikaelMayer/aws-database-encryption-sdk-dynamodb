...
impl crate::types::client_supplier::ClientSupplierRef {
    ...
    ///   - [`client(Option<kms::client::Client>)`](crate::operation::get_client::GetClientOutput::client): (undocumented)
    /// - On failure, responds with [`SdkError<GetClientError>`](crate::operation::get_client::GetClientError)
    pub fn get_client(&self) -> crate::operation::get_client::builders::GetClientFluentBuilder {
        crate::operation::get_client::builders::GetClientFluentBuilder::new(self.clone())
    }
}
