...
impl VerifyRequest {
    /// Creates a new builder-style object to manufacture [`VerifyRequest`](crate::operation::verify::builders::VerifyRequest).
    pub fn builder() -> crate::operation::verify::builders::VerifyRequestBuilder {
        crate::operation::verify::builders::VerifyRequestBuilder::default()
    }
}

/// A builder for [`VerifyRequest`](crate::operation::operation::VerifyRequest).
#[non_exhaustive]
#[derive(
...
pub fn get_signing_algorithm(&self) -> &::std::option::Option<kms::types::SigningAlgorithmSpec> {
    ...
    /// Consumes the builder and constructs a [`VerifyRequest`](crate::operation::operation::VerifyRequest).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::verify::VerifyRequest {
