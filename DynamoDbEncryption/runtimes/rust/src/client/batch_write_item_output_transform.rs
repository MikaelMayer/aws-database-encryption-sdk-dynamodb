...
impl crate::client::Client {
    ...
    ///   - [`original_input(impl Into<Option<dynamodb::types::BatchWriteItemInput>>)`](crate::operation::batch_write_item_output_transform::builders::BatchWriteItemOutputTransformFluentBuilder::original_input) / [`set_original_input(Option<dynamodb::types::BatchWriteItemInput>)`](crate::operation::batch_write_item_output_transform::builders::BatchWriteItemOutputTransformFluentBuilder::set_original_input): (undocumented)<br>
    ///   - [`sdk_output(impl Into<Option<dynamodb::types::BatchWriteItemOutput>>)`](crate::operation::batch_write_item_output_transform::builders::BatchWriteItemOutputTransformFluentBuilder::sdk_output) / [`set_sdk_output(Option<dynamodb::types::BatchWriteItemOutput>)`](crate::operation::batch_write_item_output_transform::builders::BatchWriteItemOutputTransformFluentBuilder::set_sdk_output): (undocumented)<br>
    ...
    ///   - [`transformed_output(Option<dynamodb::types::BatchWriteItemOutput>)`](crate::operation::batch_write_item_output_transform::BatchWriteItemOutputTransformOutput::transformed_output): (undocumented)
