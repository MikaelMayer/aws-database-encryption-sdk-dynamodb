...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_random::GenerateRandomRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateRandomRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateRandomRequest::GenerateRandomRequest {
...
pub fn from_dafny(
    ...
    crate::operation::generate_random::GenerateRandomRequest::builder()
