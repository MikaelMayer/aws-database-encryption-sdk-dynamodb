...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_branch_key_id::GetBranchKeyIdOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetBranchKeyIdOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetBranchKeyIdOutput::GetBranchKeyIdOutput {
...
pub fn from_dafny(
    ...
    crate::operation::get_branch_key_id::GetBranchKeyIdOutput::builder()
