...
pub fn to_dafny(
    ...
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateRawRsaKeyringInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateRawRsaKeyringInput::CreateRawRsaKeyringInput {
 ...
 paddingScheme: material_providers::conversions::padding_scheme::to_dafny(value.padding_scheme.clone().unwrap()),
...
pub fn from_dafny(
 ...
 .set_padding_scheme(Some( material_providers::conversions::padding_scheme::from_dafny(dafny_value.paddingScheme()) ))
