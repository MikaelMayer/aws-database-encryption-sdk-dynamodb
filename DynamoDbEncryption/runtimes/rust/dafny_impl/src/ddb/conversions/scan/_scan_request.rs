...
,
 TotalSegments: crate::ddb::standard_library_conversions::oint_to_dafny(value.total_segments),
 Segment: crate::ddb::standard_library_conversions::oint_to_dafny(value.segment),
...
,
 ...
 .set_total_segments(crate::ddb::standard_library_conversions::oint_from_dafny(dafny_value.TotalSegments().clone()))
 .set_segment(crate::ddb::standard_library_conversions::oint_from_dafny(dafny_value.Segment().clone()))
