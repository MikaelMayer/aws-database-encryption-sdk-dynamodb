...
impl RsaEncryptInput {
    ...
    pub fn builder() -> crate::operation::rsa_encrypt::builders::RsaEncryptInputBuilder {
        crate::operation::rsa_encrypt::builders::RsaEncryptInputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::rsa_encrypt::RsaEncryptInput {
