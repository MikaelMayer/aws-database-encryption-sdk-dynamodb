...
pub use crate::operation::list_aliases::_list_aliases_response::ListAliasesResponseBuilder;

pub use crate::operation::list_aliases::_list_aliases_request::ListAliasesRequestBuilder;
...
pub struct ListAliasesFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::list_aliases::builders::ListAliasesRequestBuilder,
}
impl ListAliasesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_aliases::builders::ListAliasesRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_aliases::ListAliases::send(&self.client, input).await
    }
