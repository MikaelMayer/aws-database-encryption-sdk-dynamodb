...
pub struct GetItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::GetItemInput>,
}
impl GetItemInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::GetItemInput> {
    &self.sdk_input
}
}
impl GetItemInputTransformInput {
    ...
    pub fn builder() -> crate::operation::get_item_input_transform::builders::GetItemInputTransformInputBuilder {
...
pub struct GetItemInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::GetItemInput>,
}
impl GetItemInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::GetItemInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::GetItemInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::GetItemInput> {
    &self.sdk_input
}
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_item_input_transform::GetItemInputTransformInput {
