...
impl HkdfExtractOutput {
    ...
    pub fn builder() -> crate::operation::hkdf_extract::builders::HkdfExtractOutputBuilder {
        crate::operation::hkdf_extract::builders::HkdfExtractOutputBuilder::default()
    }
}
...
pub fn get_prk(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::hkdf_extract::HkdfExtractOutput {
            prk: self.prk,
        })
    }
}
