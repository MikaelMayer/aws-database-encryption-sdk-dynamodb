...
impl DecryptItemInput {
    /// Creates a new builder-style object to manufacture [`DecryptItemInput`](crate::operation::decrypt_item::builders::DecryptItemInput).
    pub fn builder() -> crate::operation::decrypt_item::builders::DecryptItemInputBuilder {
        crate::operation::decrypt_item::builders::DecryptItemInputBuilder::default()
    }
}

/// A builder for [`DecryptItemInput`](crate::operation::operation::DecryptItemInput).
#[non_exhaustive]
#[derive(
...
pub fn get_encrypted_item(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, dynamodb::types::AttributeValue>> {
    ...
    /// Consumes the builder and constructs a [`DecryptItemInput`](crate::operation::operation::DecryptItemInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decrypt_item::DecryptItemInput {
