...
pub fn from_dafny(
    ...
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::sse_status::from_dafny(value)
    ),
    _ => None,
}
)
 ...
 .set_kms_master_key_arn(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.KMSMasterKeyArn().clone()))
 .set_inaccessible_encryption_date_time(crate::ddb::standard_library_conversions::otimestamp_from_dafny(dafny_value.InaccessibleEncryptionDateTime().clone()))
          .build()
