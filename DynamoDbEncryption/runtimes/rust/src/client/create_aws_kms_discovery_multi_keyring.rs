...
impl crate::client::Client {
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_discovery_multi_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_discovery_multi_keyring(&self) -> crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringFluentBuilder {
        crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringFluentBuilder::new(self.clone())
    }
}
