...
impl EcdsaSignOutput {
    ...
    pub fn builder() -> crate::operation::ecdsa_sign::builders::EcdsaSignOutputBuilder {
        crate::operation::ecdsa_sign::builders::EcdsaSignOutputBuilder::default()
    }
}
...
pub fn get_signature(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::ecdsa_sign::EcdsaSignOutput {
