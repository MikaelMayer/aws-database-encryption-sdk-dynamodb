...
impl CreateAwsKmsKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringInputBuilder {
        crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringInputBuilder::default()
    }
}
...
pub fn get_kms_key_id(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_keyring::CreateAwsKmsKeyringInput {
