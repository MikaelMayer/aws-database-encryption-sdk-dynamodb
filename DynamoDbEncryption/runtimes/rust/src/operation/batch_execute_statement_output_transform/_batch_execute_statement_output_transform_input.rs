...
pub struct BatchExecuteStatementOutputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub original_input: ::std::option::Option<dynamodb::types::BatchExecuteStatementInput>,
#[allow(missing_docs)] // documentation missing in model
pub sdk_output: ::std::option::Option<dynamodb::types::BatchExecuteStatementOutput>,
}
impl BatchExecuteStatementOutputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn original_input(&self) -> &::std::option::Option<dynamodb::types::BatchExecuteStatementInput> {
    &self.original_input
}
#[allow(missing_docs)] // documentation missing in model
pub fn sdk_output(&self) -> &::std::option::Option<dynamodb::types::BatchExecuteStatementOutput> {
    &self.sdk_output
}
}
impl BatchExecuteStatementOutputTransformInput {
...
pub struct BatchExecuteStatementOutputTransformInputBuilder {
    pub(crate) original_input: ::std::option::Option<dynamodb::types::BatchExecuteStatementInput>,
pub(crate) sdk_output: ::std::option::Option<dynamodb::types::BatchExecuteStatementOutput>,
}
impl BatchExecuteStatementOutputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn original_input(mut self, input: impl ::std::convert::Into<dynamodb::types::BatchExecuteStatementInput>) -> Self {
    self.original_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_original_input(mut self, input: ::std::option::Option<dynamodb::types::BatchExecuteStatementInput>) -> Self {
    self.original_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_original_input(&self) -> &::std::option::Option<dynamodb::types::BatchExecuteStatementInput> {
    &self.original_input
}
#[allow(missing_docs)] // documentation missing in model
pub fn sdk_output(mut self, input: impl ::std::convert::Into<dynamodb::types::BatchExecuteStatementOutput>) -> Self {
    self.sdk_output = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_output(mut self, input: ::std::option::Option<dynamodb::types::BatchExecuteStatementOutput>) -> Self {
    self.sdk_output = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_output(&self) -> &::std::option::Option<dynamodb::types::BatchExecuteStatementOutput> {
    &self.sdk_output
}
