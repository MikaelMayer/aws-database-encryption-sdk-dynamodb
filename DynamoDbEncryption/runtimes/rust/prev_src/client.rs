...
pub struct Client {
    pub(crate) dafny_client: ::dafny_runtime::Object<dyn crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IDynamoDbEncryptionTransformsClient>
}
...
impl Client {
    ...
    pub fn from_conf(
        ...
        let inner =
            crate::aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::_default::DynamoDbEncryptionTransforms(
