...
impl TransactWriteItemsOutputTransform {
    ...
    > {
        ...
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).TransactWriteItemsOutputTransform(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(
                crate::conversions::transact_write_items_output_transform::_transact_write_items_output_transform_output::from_dafny(
