...
pub use crate::primitives::operation::aes_kdf_counter_mode::_aes_kdf_ctr_output::AesKdfCtrOutputBuilder;

pub use crate::primitives::operation::aes_kdf_counter_mode::_aes_kdf_ctr_input::AesKdfCtrInputBuilder;
...
pub struct AesKdfCounterModeFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::aes_kdf_counter_mode::builders::AesKdfCtrInputBuilder,
}
impl AesKdfCounterModeFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::aes_kdf_counter_mode::builders::AesKdfCtrInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::aes_kdf_counter_mode::AesKdfCounterMode::send(&self.client, input).await
    }
