...
impl DeriveSharedSecretOutput {
    /// Creates a new builder-style object to manufacture [`DeriveSharedSecretOutput`](crate::primitives::operation::derive_shared_secret::builders::DeriveSharedSecretOutput).
    pub fn builder() -> crate::primitives::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder {
        crate::primitives::operation::derive_shared_secret::builders::DeriveSharedSecretOutputBuilder::default()
    }
}

/// A builder for [`DeriveSharedSecretOutput`](crate::primitives::operation::operation::DeriveSharedSecretOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_shared_secret(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`DeriveSharedSecretOutput`](crate::primitives::operation::operation::DeriveSharedSecretOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::derive_shared_secret::DeriveSharedSecretOutput {
