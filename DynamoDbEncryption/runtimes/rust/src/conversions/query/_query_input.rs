...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::query::QueryInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::QueryInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::QueryInput::QueryInput {
 ...
 Select: ::std::rc::Rc::new(match &value.select {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: dynamodb::conversions::select::to_dafny(x.clone()) },
...
::std::rc::Rc::new(match &value.key_conditions {
    Some(x) => crate::r#_Wrappers_Compile::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::hashmap_to_dafny_map(x,
            ...
            |v| dynamodb::conversions::condition::to_dafny(v.clone())
,
        )
    },
    None => crate::r#_Wrappers_Compile::Option::None {}
...
pub fn from_dafny(
    ...
    crate::operation::query::QueryInput::builder()
 ...
 .set_select(match &**dafny_value.Select() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        dynamodb::conversions::select::from_dafny(value)
    ),
    _ => None,
}
)
    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                ...
                |v| dynamodb::conversions::condition::from_dafny(v.clone())
,
            )
        ),
    _ => None
