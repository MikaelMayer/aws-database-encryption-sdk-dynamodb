...
impl crate::client::Client {
    ...
    ///   - [`original_input(impl Into<Option<dynamodb::types::TransactGetItemsInput>>)`](crate::operation::transact_get_items_output_transform::builders::TransactGetItemsOutputTransformFluentBuilder::original_input) / [`set_original_input(Option<dynamodb::types::TransactGetItemsInput>)`](crate::operation::transact_get_items_output_transform::builders::TransactGetItemsOutputTransformFluentBuilder::set_original_input): (undocumented)<br>
    ///   - [`sdk_output(impl Into<Option<dynamodb::types::TransactGetItemsOutput>>)`](crate::operation::transact_get_items_output_transform::builders::TransactGetItemsOutputTransformFluentBuilder::sdk_output) / [`set_sdk_output(Option<dynamodb::types::TransactGetItemsOutput>)`](crate::operation::transact_get_items_output_transform::builders::TransactGetItemsOutputTransformFluentBuilder::set_sdk_output): (undocumented)<br>
    ...
    ///   - [`transformed_output(Option<dynamodb::types::TransactGetItemsOutput>)`](crate::operation::transact_get_items_output_transform::TransactGetItemsOutputTransformOutput::transformed_output): (undocumented)
