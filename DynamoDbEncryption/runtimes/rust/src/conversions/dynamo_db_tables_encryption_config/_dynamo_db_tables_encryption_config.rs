...
pub fn to_dafny_plain(
    ...
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DynamoDbTablesEncryptionConfig::DynamoDbTablesEncryptionConfig {
    ...
    |v| dynamo_db::conversions::dynamo_db_table_encryption_config::to_dafny(v.clone())
,
)
,
    }
...
pub fn plain_from_dafny(
    dafny_value: &crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DynamoDbTablesEncryptionConfig,
) -> crate::types::dynamo_db_tables_encryption_config::DynamoDbTablesEncryptionConfig {
    match dafny_value {
        crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DynamoDbTablesEncryptionConfig::DynamoDbTablesEncryptionConfig {..} =>
    ...
    |v| dynamo_db::conversions::dynamo_db_table_encryption_config::from_dafny(v.clone())
,
)
 ))
                .build()
