...
impl CreateKeyringOutput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_discovery_keyring::builders::CreateKeyringOutputBuilder {
        crate::operation::create_aws_kms_discovery_keyring::builders::CreateKeyringOutputBuilder::default()
    }
}
...
pub fn get_keyring(&self) -> &::std::option::Option<material_providers::types::keyring::KeyringRef> {
    ...
    pub fn build(
        ...
        crate::operation::create_aws_kms_discovery_keyring::CreateKeyringOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_discovery_keyring::CreateKeyringOutput {
