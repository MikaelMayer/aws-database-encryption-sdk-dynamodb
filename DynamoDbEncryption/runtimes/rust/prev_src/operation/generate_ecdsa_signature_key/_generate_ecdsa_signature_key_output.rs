...
pub struct GenerateEcdsaSignatureKeyOutput {
    #[allow(missing_docs)] // documentation missing in model
pub signature_algorithm: ::std::option::Option<primitives::types::EcdsaSignatureAlgorithm>,
#[allow(missing_docs)] // documentation missing in model
...
impl GenerateEcdsaSignatureKeyOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn signature_algorithm(&self) -> &::std::option::Option<primitives::types::EcdsaSignatureAlgorithm> {
...
impl GenerateEcdsaSignatureKeyOutput {
    ...
    pub fn builder() -> crate::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyOutputBuilder {
        crate::operation::generate_ecdsa_signature_key::builders::GenerateEcdsaSignatureKeyOutputBuilder::default()
    }
}
...
pub struct GenerateEcdsaSignatureKeyOutputBuilder {
    pub(crate) signature_algorithm: ::std::option::Option<primitives::types::EcdsaSignatureAlgorithm>,
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_ecdsa_signature_key::GenerateEcdsaSignatureKeyOutput {
