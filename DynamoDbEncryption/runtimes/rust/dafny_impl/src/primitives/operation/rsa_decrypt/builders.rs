...
pub use crate::primitives::operation::rsa_decrypt::_rsa_decrypt_output::RsaDecryptOutputBuilder;

pub use crate::primitives::operation::rsa_decrypt::_rsa_decrypt_input::RsaDecryptInputBuilder;
...
pub struct RsaDecryptFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::rsa_decrypt::builders::RsaDecryptInputBuilder,
}
impl RsaDecryptFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::rsa_decrypt::builders::RsaDecryptInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::rsa_decrypt::RsaDecrypt::send(&self.client, input).await
    }
