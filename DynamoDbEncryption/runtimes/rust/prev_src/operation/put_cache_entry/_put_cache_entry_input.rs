...
#[allow(missing_docs)] // documentation missing in model
pub materials: ::std::option::Option<material_providers::types::Materials>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn materials(&self) -> &::std::option::Option<material_providers::types::Materials> {
    &self.materials
}
#[allow(missing_docs)] // documentation missing in model
...
impl PutCacheEntryInput {
    ...
    pub fn builder() -> crate::operation::put_cache_entry::builders::PutCacheEntryInputBuilder {
        crate::operation::put_cache_entry::builders::PutCacheEntryInputBuilder::default()
    }
}
...
pub(crate) materials: ::std::option::Option<material_providers::types::Materials>,
...
pub fn get_messages_used(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    pub fn build(
        ...
        crate::operation::put_cache_entry::PutCacheEntryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::put_cache_entry::PutCacheEntryInput {
