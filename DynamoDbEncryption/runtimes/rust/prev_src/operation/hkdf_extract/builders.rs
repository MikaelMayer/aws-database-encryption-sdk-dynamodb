...
pub use crate::operation::hkdf_extract::_hkdf_extract_output::HkdfExtractOutputBuilder;

pub use crate::operation::hkdf_extract::_hkdf_extract_input::HkdfExtractInputBuilder;
...
impl HkdfExtractInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::hkdf_extract::HkdfExtractOutput,
...
pub struct HkdfExtractFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::hkdf_extract::builders::HkdfExtractInputBuilder,
}
impl HkdfExtractFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::hkdf_extract::builders::HkdfExtractInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::hkdf_extract::HkdfExtract::send(&self.client, input).await
    }
