...
pub use crate::operation::list_key_policies::_list_key_policies_response::ListKeyPoliciesResponseBuilder;

pub use crate::operation::list_key_policies::_list_key_policies_request::ListKeyPoliciesRequestBuilder;
...
pub struct ListKeyPoliciesFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::list_key_policies::builders::ListKeyPoliciesRequestBuilder,
}
impl ListKeyPoliciesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_key_policies::builders::ListKeyPoliciesRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_key_policies::ListKeyPolicies::send(&self.client, input).await
    }
