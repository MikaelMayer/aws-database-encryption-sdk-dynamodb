...
#[allow(missing_docs)] // documentation missing in model
pub padding: ::std::option::Option<primitives::types::RsaPaddingMode>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding(&self) -> &::std::option::Option<primitives::types::RsaPaddingMode> {
    &self.padding
}
#[allow(missing_docs)] // documentation missing in model
...
impl RsaDecryptInput {
    ...
    pub fn builder() -> crate::operation::rsa_decrypt::builders::RsaDecryptInputBuilder {
        crate::operation::rsa_decrypt::builders::RsaDecryptInputBuilder::default()
    }
}
...
pub(crate) padding: ::std::option::Option<primitives::types::RsaPaddingMode>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding(mut self, input: impl ::std::convert::Into<primitives::types::RsaPaddingMode>) -> Self {
    self.padding = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_padding(mut self, input: ::std::option::Option<primitives::types::RsaPaddingMode>) -> Self {
    self.padding = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_padding(&self) -> &::std::option::Option<primitives::types::RsaPaddingMode> {
    &self.padding
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_private_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::rsa_decrypt::RsaDecryptInput {
