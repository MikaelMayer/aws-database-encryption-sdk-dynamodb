...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_public_key::GetPublicKeyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetPublicKeyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetPublicKeyRequest::GetPublicKeyRequest {
...
pub fn from_dafny(
    ...
    crate::operation::get_public_key::GetPublicKeyRequest::builder()
