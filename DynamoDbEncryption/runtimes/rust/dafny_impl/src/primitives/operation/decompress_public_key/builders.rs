...
pub use crate::primitives::operation::decompress_public_key::_decompress_public_key_output::DecompressPublicKeyOutputBuilder;

pub use crate::primitives::operation::decompress_public_key::_decompress_public_key_input::DecompressPublicKeyInputBuilder;
...
pub struct DecompressPublicKeyFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::decompress_public_key::builders::DecompressPublicKeyInputBuilder,
}
impl DecompressPublicKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::decompress_public_key::builders::DecompressPublicKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::decompress_public_key::DecompressPublicKey::send(&self.client, input).await
    }
