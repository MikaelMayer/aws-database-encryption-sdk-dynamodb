...
impl AesEncryptInput {
    /// Creates a new builder-style object to manufacture [`AesEncryptInput`](crate::primitives::operation::aes_encrypt::builders::AesEncryptInput).
    pub fn builder() -> crate::primitives::operation::aes_encrypt::builders::AesEncryptInputBuilder {
        crate::primitives::operation::aes_encrypt::builders::AesEncryptInputBuilder::default()
    }
}

/// A builder for [`AesEncryptInput`](crate::primitives::operation::operation::AesEncryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_msg(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`AesEncryptInput`](crate::primitives::operation::operation::AesEncryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::aes_encrypt::AesEncryptInput {
            aad: self.aad,
