...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_item::GetItemOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetItemOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetItemOutput::GetItemOutput {
        Item:
...
pub fn from_dafny(
    ...
    crate::operation::get_item::GetItemOutput::builder()
