...
pub use crate::primitives::operation::kdf_counter_mode::_kdf_ctr_output::KdfCtrOutputBuilder;

pub use crate::primitives::operation::kdf_counter_mode::_kdf_ctr_input::KdfCtrInputBuilder;
...
pub struct KdfCounterModeFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::kdf_counter_mode::builders::KdfCtrInputBuilder,
}
impl KdfCounterModeFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::kdf_counter_mode::builders::KdfCtrInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::kdf_counter_mode::KdfCounterMode::send(&self.client, input).await
    }
