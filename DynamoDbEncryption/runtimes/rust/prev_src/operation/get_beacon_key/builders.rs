...
pub use crate::operation::get_beacon_key::_get_beacon_key_output::GetBeaconKeyOutputBuilder;

pub use crate::operation::get_beacon_key::_get_beacon_key_input::GetBeaconKeyInputBuilder;
...
pub struct GetBeaconKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_beacon_key::builders::GetBeaconKeyInputBuilder,
}
impl GetBeaconKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_beacon_key::builders::GetBeaconKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_beacon_key::GetBeaconKey::send(&self.client, input).await
    }
