...
pub use crate::primitives::operation::hkdf_extract::_hkdf_extract_output::HkdfExtractOutputBuilder;

pub use crate::primitives::operation::hkdf_extract::_hkdf_extract_input::HkdfExtractInputBuilder;
...
pub struct HkdfExtractFluentBuilder {
    client: crate::primitives::client::Client,
    pub(crate) inner: crate::primitives::operation::hkdf_extract::builders::HkdfExtractInputBuilder,
}
impl HkdfExtractFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::primitives::operation::hkdf_extract::builders::HkdfExtractInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::primitives::operation::hkdf_extract::HkdfExtract::send(&self.client, input).await
    }
