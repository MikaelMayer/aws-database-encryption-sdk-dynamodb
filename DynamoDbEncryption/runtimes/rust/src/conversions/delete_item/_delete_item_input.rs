...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::delete_item::DeleteItemInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DeleteItemInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DeleteItemInput::DeleteItemInput {
...
pub fn from_dafny(
    ...
    crate::operation::delete_item::DeleteItemInput::builder()
