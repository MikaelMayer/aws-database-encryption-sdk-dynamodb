...
#[allow(missing_docs)] // documentation missing in model
pub kms_configuration: ::std::option::Option<key_store::types::KmsConfiguration>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn kms_configuration(&self) -> &::std::option::Option<key_store::types::KmsConfiguration> {
...
impl GetKeyStoreInfoOutput {
    ...
    pub fn builder() -> crate::operation::get_key_store_info::builders::GetKeyStoreInfoOutputBuilder {
        crate::operation::get_key_store_info::builders::GetKeyStoreInfoOutputBuilder::default()
    }
}
...
pub(crate) kms_configuration: ::std::option::Option<key_store::types::KmsConfiguration>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn kms_configuration(mut self, input: impl ::std::convert::Into<key_store::types::KmsConfiguration>) -> Self {
    self.kms_configuration = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_kms_configuration(mut self, input: ::std::option::Option<key_store::types::KmsConfiguration>) -> Self {
    self.kms_configuration = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_kms_configuration(&self) -> &::std::option::Option<key_store::types::KmsConfiguration> {
    &self.kms_configuration
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_logical_key_store_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    pub fn build(
        ...
        crate::operation::get_key_store_info::GetKeyStoreInfoOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::get_key_store_info::GetKeyStoreInfoOutput {
