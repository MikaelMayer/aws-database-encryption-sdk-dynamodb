...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_data_key_pair::GenerateDataKeyPairResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyPairResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateDataKeyPairResponse::GenerateDataKeyPairResponse {
...
pub fn from_dafny(
    ...
    crate::operation::generate_data_key_pair::GenerateDataKeyPairResponse::builder()
