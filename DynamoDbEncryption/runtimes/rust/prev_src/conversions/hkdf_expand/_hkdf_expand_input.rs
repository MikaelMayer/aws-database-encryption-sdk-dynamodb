...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::hkdf_expand::HkdfExpandInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::HkdfExpandInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::HkdfExpandInput::HkdfExpandInput {
...
pub fn from_dafny(
    ...
    crate::operation::hkdf_expand::HkdfExpandInput::builder()
