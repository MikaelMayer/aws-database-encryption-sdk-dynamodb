...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::decrypt_item::DecryptItemOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptItemOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptItemOutput::DecryptItemOutput {
...
pub fn from_dafny(
    ...
    crate::operation::decrypt_item::DecryptItemOutput::builder()
