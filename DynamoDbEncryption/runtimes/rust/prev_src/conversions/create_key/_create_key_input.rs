...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_key::CreateKeyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateKeyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateKeyRequest::CreateKeyRequest {
...
pub fn from_dafny(
    ...
    crate::operation::create_key::CreateKeyRequest::builder()
