...
::std::rc::Rc::new(match &value.attribute_updates {
    Some(x) => crate::Wrappers::Option::Some { value :
        ::dafny_runtime::dafny_runtime_conversions::hashmap_to_dafny_map(x,
            |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::string_to_dafny_string(&k),
            |v| crate::ddb::conversions::attribute_value_update::to_dafny(v)
,
        )
    },
...
,
 ReturnValues: ::std::rc::Rc::new(match &value.return_values {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::return_value::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
...
,
 ReturnItemCollectionMetrics: ::std::rc::Rc::new(match &value.return_item_collection_metrics {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::return_item_collection_metrics::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
 UpdateExpression: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.update_expression),
 ConditionExpression: crate::ddb::standard_library_conversions::ostring_to_dafny(&value.condition_expression),
    ...
    crate::Wrappers::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(k),
                |v| crate::ddb::conversions::attribute_value_update::from_dafny(v.clone())
,
            )
        ),
    _ => None
 ...
 .set_expected(match (*dafny_value.Expected()).as_ref() {
    crate::Wrappers::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(value,
                |k| dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(k),
                |v| crate::ddb::conversions::expected_attribute_value::from_dafny(v.clone())
,
            )
        ),
    _ => None
 ...
 .set_return_values(match &**dafny_value.ReturnValues() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::return_value::from_dafny(value)
    ),
    _ => None,
}
)
 ...
 .set_return_item_collection_metrics(match &**dafny_value.ReturnItemCollectionMetrics() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::return_item_collection_metrics::from_dafny(value)
    ),
    _ => None,
}
)
 .set_update_expression(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.UpdateExpression().clone()))
 .set_condition_expression(crate::ddb::standard_library_conversions::ostring_from_dafny(dafny_value.ConditionExpression().clone()))
