...
impl AesKdfCtrInput {
    ...
    pub fn builder() -> crate::operation::aes_kdf_counter_mode::builders::AesKdfCtrInputBuilder {
        crate::operation::aes_kdf_counter_mode::builders::AesKdfCtrInputBuilder::default()
    }
}
...
pub fn get_nonce(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::aes_kdf_counter_mode::AesKdfCtrInput {
