...
impl GetEncryptionMaterialsInput {
    ...
    pub fn builder() -> crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsInputBuilder {
        crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsInputBuilder::default()
    }
}
...
pub fn get_required_encryption_context_keys(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_encryption_materials::GetEncryptionMaterialsInput {
