...
>{
 ...
 KeyAgreementAlgorithm: crate::kms::conversions::key_agreement_algorithm_spec::to_dafny(value.key_agreement_algorithm.clone().unwrap()),
 PublicKey: crate::kms::standard_library_conversions::oblob_to_dafny(&value.public_key).Extract(),
...
pub fn from_dafny(
 ...
 .set_key_agreement_algorithm(Some( crate::kms::conversions::key_agreement_algorithm_spec::from_dafny(dafny_value.KeyAgreementAlgorithm()) ))
 .set_public_key(Some(crate::kms::standard_library_conversions::blob_from_dafny(dafny_value.PublicKey().clone())))
