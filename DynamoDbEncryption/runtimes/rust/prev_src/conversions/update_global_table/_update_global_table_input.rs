...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::update_global_table::UpdateGlobalTableInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateGlobalTableInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateGlobalTableInput::UpdateGlobalTableInput {
 ...
 ReplicaUpdates: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.replica_updates.clone().unwrap(),
    |e| dynamodb::conversions::replica_update::to_dafny(e.clone())
,
)
,
    })
...
pub fn from_dafny(
    ...
    crate::operation::update_global_table::UpdateGlobalTableInput::builder()
 ...
 .set_replica_updates(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.ReplicaUpdates(),
    |e| dynamodb::conversions::replica_update::from_dafny(e.clone())
,
)
 ))
        .build()
