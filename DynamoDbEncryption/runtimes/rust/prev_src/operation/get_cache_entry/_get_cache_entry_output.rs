...
impl GetCacheEntryOutput {
    ...
    pub fn builder() -> crate::operation::get_cache_entry::builders::GetCacheEntryOutputBuilder {
        crate::operation::get_cache_entry::builders::GetCacheEntryOutputBuilder::default()
    }
}
...
pub fn get_messages_used(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_cache_entry::GetCacheEntryOutput {
