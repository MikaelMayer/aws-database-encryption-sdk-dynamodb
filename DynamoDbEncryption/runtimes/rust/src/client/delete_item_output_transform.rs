...
impl crate::client::Client {
    ...
    ///   - [`original_input(impl Into<Option<dynamodb::types::DeleteItemInput>>)`](crate::operation::delete_item_output_transform::builders::DeleteItemOutputTransformFluentBuilder::original_input) / [`set_original_input(Option<dynamodb::types::DeleteItemInput>)`](crate::operation::delete_item_output_transform::builders::DeleteItemOutputTransformFluentBuilder::set_original_input): (undocumented)<br>
    ///   - [`sdk_output(impl Into<Option<dynamodb::types::DeleteItemOutput>>)`](crate::operation::delete_item_output_transform::builders::DeleteItemOutputTransformFluentBuilder::sdk_output) / [`set_sdk_output(Option<dynamodb::types::DeleteItemOutput>)`](crate::operation::delete_item_output_transform::builders::DeleteItemOutputTransformFluentBuilder::set_sdk_output): (undocumented)<br>
    ...
    ///   - [`transformed_output(Option<dynamodb::types::DeleteItemOutput>)`](crate::operation::delete_item_output_transform::DeleteItemOutputTransformOutput::transformed_output): (undocumented)
