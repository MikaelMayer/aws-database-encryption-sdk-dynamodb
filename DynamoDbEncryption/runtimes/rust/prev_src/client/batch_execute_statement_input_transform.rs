...
impl crate::client::Client {
    ...
    ///   - [`sdk_input(impl Into<Option<dynamodb::types::BatchExecuteStatementInput>>)`](crate::operation::batch_execute_statement_input_transform::builders::BatchExecuteStatementInputTransformFluentBuilder::sdk_input) / [`set_sdk_input(Option<dynamodb::types::BatchExecuteStatementInput>)`](crate::operation::batch_execute_statement_input_transform::builders::BatchExecuteStatementInputTransformFluentBuilder::set_sdk_input): (undocumented)<br>
    ...
    ///   - [`transformed_input(Option<dynamodb::types::BatchExecuteStatementInput>)`](crate::operation::batch_execute_statement_input_transform::BatchExecuteStatementInputTransformOutput::transformed_input): (undocumented)
