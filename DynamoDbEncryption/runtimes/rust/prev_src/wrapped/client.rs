...
impl dafny_runtime::UpcastObject<dyn crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IDynamoDbEncryptionTransformsClient> for Client {
  ::dafny_runtime::UpcastObjectFn!(dyn crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IDynamoDbEncryptionTransformsClient);
}
...
impl Client {
  pub fn from_conf(config: &::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DynamoDbTablesEncryptionConfig,
  >) ->
::std::rc::Rc<crate::r#_Wrappers_Compile::Result<
  ::dafny_runtime::Object<dyn crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IDynamoDbEncryptionTransformsClient>,
...
impl crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::IDynamoDbEncryptionTransformsClient for Client {
    ...
    >{
        let inner_input =
            crate::conversions::batch_execute_statement_input_transform::_batch_execute_statement_input_transform_input::from_dafny(input.clone());
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::batch_execute_statement_input_transform::_batch_execute_statement_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn BatchExecuteStatementOutputTransform(
        &mut self,
        input: &std::rc::Rc<
            crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchExecuteStatementOutputTransformInput,
        >,
    ) -> std::rc::Rc<
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
    ...
    >{
        let inner_input =
            crate::conversions::batch_execute_statement_output_transform::_batch_execute_statement_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::batch_execute_statement_output_transform::_batch_execute_statement_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::batch_get_item_input_transform::_batch_get_item_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::batch_get_item_input_transform::_batch_get_item_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn BatchGetItemOutputTransform(
        &mut self,
        input: &std::rc::Rc<
            crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchGetItemOutputTransformInput,
        >,
    ) -> std::rc::Rc<
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
    ...
    >{
        let inner_input =
            crate::conversions::batch_get_item_output_transform::_batch_get_item_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::batch_get_item_output_transform::_batch_get_item_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::batch_write_item_input_transform::_batch_write_item_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::batch_write_item_input_transform::_batch_write_item_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn BatchWriteItemOutputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::BatchWriteItemOutputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::batch_write_item_output_transform::_batch_write_item_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::batch_write_item_output_transform::_batch_write_item_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn DeleteItemInputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DeleteItemInputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::delete_item_input_transform::_delete_item_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::delete_item_input_transform::_delete_item_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::delete_item_output_transform::_delete_item_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::delete_item_output_transform::_delete_item_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn ExecuteStatementInputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExecuteStatementInputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::execute_statement_input_transform::_execute_statement_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::execute_statement_input_transform::_execute_statement_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::execute_statement_output_transform::_execute_statement_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::execute_statement_output_transform::_execute_statement_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn ExecuteTransactionInputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExecuteTransactionInputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::execute_transaction_input_transform::_execute_transaction_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::execute_transaction_input_transform::_execute_transaction_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::execute_transaction_output_transform::_execute_transaction_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::execute_transaction_output_transform::_execute_transaction_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::get_item_input_transform::_get_item_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::get_item_input_transform::_get_item_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::get_item_output_transform::_get_item_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::get_item_output_transform::_get_item_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn PutItemInputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::PutItemInputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::put_item_input_transform::_put_item_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::put_item_input_transform::_put_item_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::put_item_output_transform::_put_item_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::put_item_output_transform::_put_item_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::query_input_transform::_query_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::query_input_transform::_query_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::query_output_transform::_query_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::query_output_transform::_query_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn ResolveAttributes(
        &mut self,
        input: &std::rc::Rc<
            crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ResolveAttributesInput,
        >,
    ) -> std::rc::Rc<
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ResolveAttributesOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::resolve_attributes::_resolve_attributes_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::resolve_attributes::_resolve_attributes_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::scan_input_transform::_scan_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::scan_input_transform::_scan_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::scan_output_transform::_scan_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::scan_output_transform::_scan_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn TransactGetItemsInputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::TransactGetItemsInputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::transact_get_items_input_transform::_transact_get_items_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::transact_get_items_input_transform::_transact_get_items_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::transact_get_items_output_transform::_transact_get_items_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::transact_get_items_output_transform::_transact_get_items_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn TransactWriteItemsInputTransform(
        ...
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
                crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::TransactWriteItemsInputTransformOutput,
            >,
            std::rc::Rc<crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::Error>,
        >,
    >{
        let inner_input =
            crate::conversions::transact_write_items_input_transform::_transact_write_items_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::transact_write_items_input_transform::_transact_write_items_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::transact_write_items_output_transform::_transact_write_items_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::transact_write_items_output_transform::_transact_write_items_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    fn UpdateItemInputTransform(
        &mut self,
        input: &std::rc::Rc<
            crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::UpdateItemInputTransformInput,
        >,
    ) -> std::rc::Rc<
        crate::r#_Wrappers_Compile::Result<
            std::rc::Rc<
    ...
    >{
        let inner_input =
            crate::conversions::update_item_input_transform::_update_item_input_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::update_item_input_transform::_update_item_input_transform_output::to_dafny(client),
                },
            ),
        }
    }
    ...
    >{
        let inner_input =
            crate::conversions::update_item_output_transform::_update_item_output_transform_input::from_dafny(input.clone());
        let result = tokio::task::block_in_place(|| {
        ...
        match result {
            ...
            Ok(client) => ::std::rc::Rc::new(
                crate::_Wrappers_Compile::Result::Success {
                    value: crate::conversions::update_item_output_transform::_update_item_output_transform_output::to_dafny(client),
                },
            ),
        }
    }
