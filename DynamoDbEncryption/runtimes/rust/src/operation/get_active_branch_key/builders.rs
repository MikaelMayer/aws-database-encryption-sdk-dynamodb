...
pub use crate::operation::get_active_branch_key::_get_active_branch_key_output::GetActiveBranchKeyOutputBuilder;

pub use crate::operation::get_active_branch_key::_get_active_branch_key_input::GetActiveBranchKeyInputBuilder;
...
pub struct GetActiveBranchKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_active_branch_key::builders::GetActiveBranchKeyInputBuilder,
}
impl GetActiveBranchKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_active_branch_key::builders::GetActiveBranchKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_active_branch_key::GetActiveBranchKey::send(&self.client, input).await
    }
