...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_aws_kms_mrk_multi_keyring::CreateAwsKmsMrkMultiKeyringInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateAwsKmsMrkMultiKeyringInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateAwsKmsMrkMultiKeyringInput::CreateAwsKmsMrkMultiKeyringInput {
...
pub fn from_dafny(
    ...
    crate::operation::create_aws_kms_mrk_multi_keyring::CreateAwsKmsMrkMultiKeyringInput::builder()
