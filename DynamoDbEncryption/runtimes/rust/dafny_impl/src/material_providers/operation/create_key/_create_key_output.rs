...
impl CreateKeyOutput {
    /// Creates a new builder-style object to manufacture [`CreateKeyOutput`](crate::material_providers::operation::create_key::builders::CreateKeyOutput).
    pub fn builder() -> crate::material_providers::operation::create_key::builders::CreateKeyOutputBuilder {
        crate::material_providers::operation::create_key::builders::CreateKeyOutputBuilder::default()
    }
}

/// A builder for [`CreateKeyOutput`](crate::material_providers::operation::operation::CreateKeyOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_branch_key_identifier(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`CreateKeyOutput`](crate::material_providers::operation::operation::CreateKeyOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::material_providers::operation::create_key::CreateKeyOutput {
