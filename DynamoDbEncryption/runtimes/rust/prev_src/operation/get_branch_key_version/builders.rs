...
pub use crate::operation::get_branch_key_version::_get_branch_key_version_output::GetBranchKeyVersionOutputBuilder;

pub use crate::operation::get_branch_key_version::_get_branch_key_version_input::GetBranchKeyVersionInputBuilder;
...
pub struct GetBranchKeyVersionFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::get_branch_key_version::builders::GetBranchKeyVersionInputBuilder,
}
impl GetBranchKeyVersionFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_branch_key_version::builders::GetBranchKeyVersionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_branch_key_version::GetBranchKeyVersion::send(&self.client, input).await
    }
