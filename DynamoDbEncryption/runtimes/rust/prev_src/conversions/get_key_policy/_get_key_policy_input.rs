...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_key_policy::GetKeyPolicyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetKeyPolicyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetKeyPolicyRequest::GetKeyPolicyRequest {
...
pub fn from_dafny(
    ...
    crate::operation::get_key_policy::GetKeyPolicyRequest::builder()
