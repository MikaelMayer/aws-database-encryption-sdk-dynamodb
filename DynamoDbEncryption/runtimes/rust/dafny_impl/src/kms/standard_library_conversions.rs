pub fn ostring_to_dafny(
    ...
    crate::Wrappers::Option<::dafny_runtime::Sequence<::dafny_runtime::DafnyCharUTF16>>,
> {
    let dafny_value = match input {
  Some(b) => crate::Wrappers::Option::Some { value:
...
pub fn ostring_from_dafny(
    ...
    if matches!(input.as_ref(), crate::Wrappers::Option::Some { .. }) {
        Some(
...
pub fn obool_to_dafny(input: &Option<bool>) -> ::std::rc::Rc<crate::Wrappers::Option<bool>> {
    let dafny_value = match input {
        Some(b) => crate::Wrappers::Option::Some { value: *b },
        None => crate::Wrappers::Option::None {},
    };
    ::std::rc::Rc::new(dafny_value)
}

pub fn obool_from_dafny(input: ::std::rc::Rc<crate::Wrappers::Option<bool>>) -> Option<bool> {
    if matches!(input.as_ref(), crate::Wrappers::Option::Some { .. }) {
        Some(input.Extract())
    } else {
        None
...
pub fn oint_to_dafny(input: Option<i32>) -> ::std::rc::Rc<crate::Wrappers::Option<i32>> {
    let dafny_value = match input {
        Some(b) => crate::Wrappers::Option::Some { value: b },
        None => crate::Wrappers::Option::None {},
    };
...
pub fn oint_from_dafny(input: ::std::rc::Rc<crate::Wrappers::Option<i32>>) -> Option<i32> {
    if matches!(input.as_ref(), crate::Wrappers::Option::Some { .. }) {
        Some(input.Extract())
    } else {
        None
...
pub fn olong_to_dafny(input: &Option<i64>) -> ::std::rc::Rc<crate::Wrappers::Option<i64>> {
    let dafny_value = match input {
        Some(b) => crate::Wrappers::Option::Some { value: *b },
        None => crate::Wrappers::Option::None {},
    };
...
pub fn olong_from_dafny(input: ::std::rc::Rc<crate::Wrappers::Option<i64>>) -> Option<i64> {
    if matches!(input.as_ref(), crate::Wrappers::Option::Some { .. }) {
        Some(input.Extract())
    } else {
        None
...
) -> ::std::rc::Rc<crate::Wrappers::Option<::dafny_runtime::Sequence<u8>>> {
    let dafny_value = match input {
        Some(b) => crate::Wrappers::Option::Some {
...
pub fn oblob_from_dafny(
    input: ::std::rc::Rc<crate::Wrappers::Option<::dafny_runtime::Sequence<u8>>>,
...
pub fn odouble_to_dafny(
    ...
    let dafny_value = match input {
        Some(f) => crate::Wrappers::Option::Some {
...
pub fn option_from_dafny<T: ::dafny_runtime::DafnyType, TR>(
    input: ::std::rc::Rc<crate::Wrappers::Option<T>>,
    converter: fn(&T) -> TR,
) -> Option<TR> {
    match &*input {
        crate::Wrappers::Option::Some { value } => Some(converter(value)),
        crate::Wrappers::Option::None {} => None,
    }
}
...
pub fn option_to_dafny<T: ::dafny_runtime::DafnyType, TR>(
    input: &Option<TR>,
    converter: fn(&TR) -> T,
) -> ::std::rc::Rc<crate::Wrappers::Option<T>> {
    match input {
        Some(value) => ::std::rc::Rc::new(crate::Wrappers::Option::Some {
            value: converter(&value),
        }),
        None => ::std::rc::Rc::new(crate::Wrappers::Option::None {}),
    }
}

pub fn result_from_dafny<T: ::dafny_runtime::DafnyType, TR, E: ::dafny_runtime::DafnyType, ER>(
    input: ::std::rc::Rc<crate::Wrappers::Result<T, E>>,
    converter_t: fn(&T) -> TR,
    converter_e: fn(&E) -> ER,
) -> Result<TR, ER> {
    match &*input {
        crate::Wrappers::Result::Success { value } => Ok(converter_t(value)),
        crate::Wrappers::Result::Failure { error } => Err(converter_e(error)),
    }
}
...
pub fn result_to_dafny<T: ::dafny_runtime::DafnyType, TR, E: ::dafny_runtime::DafnyType, ER>(
    ...
    converter_t: fn(&TR) -> T,
    converter_e: fn(&ER) -> E,
) -> ::std::rc::Rc<crate::Wrappers::Result<T, E>> {
    match input {
        Ok(value) => ::std::rc::Rc::new(crate::Wrappers::Result::Success {
            value: converter_t(&value),
        }),
        Err(error) => ::std::rc::Rc::new(crate::Wrappers::Result::Failure {
