...
impl GetBranchKeyVersionInput {
    ...
    pub fn builder() -> crate::operation::get_branch_key_version::builders::GetBranchKeyVersionInputBuilder {
        crate::operation::get_branch_key_version::builders::GetBranchKeyVersionInputBuilder::default()
    }
}
...
pub fn get_branch_key_version(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_branch_key_version::GetBranchKeyVersionInput {
