...
impl CompressPublicKeyInput {
    /// Creates a new builder-style object to manufacture [`CompressPublicKeyInput`](crate::primitives::operation::compress_public_key::builders::CompressPublicKeyInput).
    pub fn builder() -> crate::primitives::operation::compress_public_key::builders::CompressPublicKeyInputBuilder {
        crate::primitives::operation::compress_public_key::builders::CompressPublicKeyInputBuilder::default()
    }
}

/// A builder for [`CompressPublicKeyInput`](crate::primitives::operation::operation::CompressPublicKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<crate::primitives::types::EccPublicKey> {
    ...
    /// Consumes the builder and constructs a [`CompressPublicKeyInput`](crate::primitives::operation::operation::CompressPublicKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::compress_public_key::CompressPublicKeyInput {
