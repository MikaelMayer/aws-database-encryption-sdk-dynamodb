...
,
 Count: crate::ddb::standard_library_conversions::oint_to_dafny(Some(value.count)),
 ScannedCount: crate::ddb::standard_library_conversions::oint_to_dafny(Some(value.scanned_count)),
 LastEvaluatedKey:
