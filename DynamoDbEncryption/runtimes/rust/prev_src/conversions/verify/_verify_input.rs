...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::verify::VerifyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::VerifyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::VerifyRequest::VerifyRequest {
 ...
 MessageType: ::std::rc::Rc::new(match &value.message_type {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::message_type::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 Signature: crate::standard_library_conversions::oblob_to_dafny(&value.signature).Extract(),
 SigningAlgorithm: kms::conversions::signing_algorithm_spec::to_dafny(value.signing_algorithm.clone().unwrap()),
...
pub fn from_dafny(
    dafny_value: ::std::rc::Rc<
        crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::VerifyRequest,
    >,
) -> crate::operation::verify::VerifyRequest {
    crate::operation::verify::VerifyRequest::builder()
 ...
 .set_message_type(match &**dafny_value.MessageType() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        kms::conversions::message_type::from_dafny(value)
    ),
    _ => None,
}
)
 .set_signature(Some(crate::standard_library_conversions::blob_from_dafny(dafny_value.Signature().clone())))
 .set_signing_algorithm(Some( kms::conversions::signing_algorithm_spec::from_dafny(dafny_value.SigningAlgorithm()) ))
