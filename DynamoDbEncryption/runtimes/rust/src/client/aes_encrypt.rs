...
impl crate::client::Client {
    ...
    ///   - [`enc_alg(impl Into<Option<primitives::types::AesGcm>>)`](crate::operation::aes_encrypt::builders::AESEncryptFluentBuilder::enc_alg) / [`set_enc_alg(Option<primitives::types::AesGcm>)`](crate::operation::aes_encrypt::builders::AESEncryptFluentBuilder::set_enc_alg): (undocumented)<br>
    ...
    pub fn aes_encrypt(&self) -> crate::operation::aes_encrypt::builders::AesEncryptFluentBuilder {
        crate::operation::aes_encrypt::builders::AesEncryptFluentBuilder::new(self.clone())
    }
}
