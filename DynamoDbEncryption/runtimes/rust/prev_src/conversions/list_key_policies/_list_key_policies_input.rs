...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_key_policies::ListKeyPoliciesRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListKeyPoliciesRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListKeyPoliciesRequest::ListKeyPoliciesRequest {
...
pub fn from_dafny(
    ...
    crate::operation::list_key_policies::ListKeyPoliciesRequest::builder()
