...
pub use crate::operation::create_aws_kms_discovery_multi_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_aws_kms_discovery_multi_keyring::_create_aws_kms_discovery_multi_keyring_input::CreateAwsKmsDiscoveryMultiKeyringInputBuilder;
...
impl CreateAwsKmsDiscoveryMultiKeyringInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::create_aws_kms_discovery_multi_keyring::CreateKeyringOutput,
...
pub struct CreateAwsKmsDiscoveryMultiKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringInputBuilder,
}
impl CreateAwsKmsDiscoveryMultiKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_aws_kms_discovery_multi_keyring::CreateAwsKmsDiscoveryMultiKeyring::send(&self.client, input).await
    }
