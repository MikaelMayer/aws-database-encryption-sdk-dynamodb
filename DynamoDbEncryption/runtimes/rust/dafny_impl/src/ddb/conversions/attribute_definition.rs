...
pub fn to_dafny(
 ...
 AttributeType: crate::ddb::conversions::scalar_attribute_type::to_dafny(value.attribute_type.clone()),
    }
  )
} #[allow(dead_code)]
pub fn from_dafny(
 ...
 .set_attribute_type(Some( crate::ddb::conversions::scalar_attribute_type::from_dafny(dafny_value.AttributeType()) ))
          .build()
          .unwrap()
}
