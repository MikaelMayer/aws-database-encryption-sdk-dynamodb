...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::encryption_materials_has_plaintext_data_key::EncryptionMaterials,
) -> ::std::rc::Rc<
...
pub fn from_dafny(
    ...
    crate::operation::encryption_materials_has_plaintext_data_key::EncryptionMaterials::builder()
