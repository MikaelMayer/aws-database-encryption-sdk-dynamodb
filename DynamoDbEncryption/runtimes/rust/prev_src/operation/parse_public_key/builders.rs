...
pub use crate::operation::parse_public_key::_parse_public_key_output::ParsePublicKeyOutputBuilder;

pub use crate::operation::parse_public_key::_parse_public_key_input::ParsePublicKeyInputBuilder;
...
pub struct ParsePublicKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::parse_public_key::builders::ParsePublicKeyInputBuilder,
}
impl ParsePublicKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::parse_public_key::builders::ParsePublicKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::parse_public_key::ParsePublicKey::send(&self.client, input).await
    }
