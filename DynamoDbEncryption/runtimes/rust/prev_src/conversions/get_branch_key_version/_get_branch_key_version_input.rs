...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_branch_key_version::GetBranchKeyVersionInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetBranchKeyVersionInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetBranchKeyVersionInput::GetBranchKeyVersionInput {
...
pub fn from_dafny(
    dafny_value: ::std::rc::Rc<
        crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetBranchKeyVersionInput,
    >,
) -> crate::operation::get_branch_key_version::GetBranchKeyVersionInput {
    crate::operation::get_branch_key_version::GetBranchKeyVersionInput::builder()
