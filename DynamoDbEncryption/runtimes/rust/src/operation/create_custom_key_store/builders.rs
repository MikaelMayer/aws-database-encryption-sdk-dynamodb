...
pub use crate::operation::create_custom_key_store::_create_custom_key_store_response::CreateCustomKeyStoreResponseBuilder;

pub use crate::operation::create_custom_key_store::_create_custom_key_store_request::CreateCustomKeyStoreRequestBuilder;
...
pub struct CreateCustomKeyStoreFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_custom_key_store::builders::CreateCustomKeyStoreRequestBuilder,
}
impl CreateCustomKeyStoreFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_custom_key_store::builders::CreateCustomKeyStoreRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_custom_key_store::CreateCustomKeyStore::send(&self.client, input).await
    }
...
pub fn custom_key_store_type(mut self, input: impl ::std::convert::Into<kms::types::CustomKeyStoreType>) -> Self {
    self.inner = self.inner.custom_key_store_type(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
