...
impl EcdsaSignInput {
    /// Creates a new builder-style object to manufacture [`EcdsaSignInput`](crate::primitives::operation::ecdsa_sign::builders::EcdsaSignInput).
    pub fn builder() -> crate::primitives::operation::ecdsa_sign::builders::EcdsaSignInputBuilder {
        crate::primitives::operation::ecdsa_sign::builders::EcdsaSignInputBuilder::default()
    }
}

/// A builder for [`EcdsaSignInput`](crate::primitives::operation::operation::EcdsaSignInput).
#[non_exhaustive]
#[derive(
...
pub fn get_signing_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`EcdsaSignInput`](crate::primitives::operation::operation::EcdsaSignInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::ecdsa_sign::EcdsaSignInput {
