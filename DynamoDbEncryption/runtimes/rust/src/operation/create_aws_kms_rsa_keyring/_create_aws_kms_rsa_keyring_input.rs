...
impl CreateAwsKmsRsaKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_rsa_keyring::builders::CreateAwsKmsRsaKeyringInputBuilder {
        crate::operation::create_aws_kms_rsa_keyring::builders::CreateAwsKmsRsaKeyringInputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_rsa_keyring::CreateAwsKmsRsaKeyringInput {
