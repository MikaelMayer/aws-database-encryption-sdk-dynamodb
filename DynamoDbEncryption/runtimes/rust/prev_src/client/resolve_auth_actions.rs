...
impl crate::client::Client {
    ...
    ///   - [`auth_actions(impl Into<Option<::std::vec::Vec<structured_encryption::types::AuthItem>>>)`](crate::operation::resolve_auth_actions::builders::ResolveAuthActionsFluentBuilder::auth_actions) / [`set_auth_actions(Option<::std::vec::Vec<structured_encryption::types::AuthItem>>)`](crate::operation::resolve_auth_actions::builders::ResolveAuthActionsFluentBuilder::set_auth_actions): (undocumented)<br>
    ...
    ///   - [`crypto_actions(Option<::std::vec::Vec<structured_encryption::types::CryptoItem>>)`](crate::operation::resolve_auth_actions::ResolveAuthActionsOutput::crypto_actions): (undocumented)
    /// - On failure, responds with [`SdkError<ResolveAuthActionsError>`](crate::operation::resolve_auth_actions::ResolveAuthActionsError)
    pub fn resolve_auth_actions(&self) -> crate::operation::resolve_auth_actions::builders::ResolveAuthActionsFluentBuilder {
        crate::operation::resolve_auth_actions::builders::ResolveAuthActionsFluentBuilder::new(self.clone())
    }
}
