...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::decrypt_path_structure::DecryptPathStructureInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptPathStructureInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DecryptPathStructureInput::DecryptPathStructureInput {
...
pub fn from_dafny(
    ...
    crate::operation::decrypt_path_structure::DecryptPathStructureInput::builder()
