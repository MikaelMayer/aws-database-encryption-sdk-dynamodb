...
pub use crate::material_providers::operation::get_active_branch_key::_get_active_branch_key_output::GetActiveBranchKeyOutputBuilder;

pub use crate::material_providers::operation::get_active_branch_key::_get_active_branch_key_input::GetActiveBranchKeyInputBuilder;
...
pub struct GetActiveBranchKeyFluentBuilder {
    client: crate::material_providers::client::Client,
    pub(crate) inner: crate::material_providers::operation::get_active_branch_key::builders::GetActiveBranchKeyInputBuilder,
}
impl GetActiveBranchKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::material_providers::operation::get_active_branch_key::builders::GetActiveBranchKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::material_providers::operation::get_active_branch_key::GetActiveBranchKey::send(&self.client, input).await
    }
