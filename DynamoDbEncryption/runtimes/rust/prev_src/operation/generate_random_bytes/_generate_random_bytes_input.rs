...
impl GenerateRandomBytesInput {
    ...
    pub fn builder() -> crate::operation::generate_random_bytes::builders::GenerateRandomBytesInputBuilder {
        crate::operation::generate_random_bytes::builders::GenerateRandomBytesInputBuilder::default()
    }
}
...
pub fn get_length(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::generate_random_bytes::GenerateRandomBytesInput {
            length: self.length,
        })
    }
}
