...
pub use crate::operation::decompress_public_key::_decompress_public_key_output::DecompressPublicKeyOutputBuilder;

pub use crate::operation::decompress_public_key::_decompress_public_key_input::DecompressPublicKeyInputBuilder;
...
pub struct DecompressPublicKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::decompress_public_key::builders::DecompressPublicKeyInputBuilder,
}
impl DecompressPublicKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::decompress_public_key::builders::DecompressPublicKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::decompress_public_key::DecompressPublicKey::send(&self.client, input).await
    }
