...
impl EcdsaVerifyInput {
    ...
    pub fn builder() -> crate::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder {
        crate::operation::ecdsa_verify::builders::EcdsaVerifyInputBuilder::default()
    }
}
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::ecdsa_verify::EcdsaVerifyInput {
