...
impl crate::client::Client {
    ...
    ///   - [`digest_algorithm(impl Into<Option<primitives::types::DigestAlgorithm>>)`](crate::operation::hkdf_expand::builders::HkdfExpandFluentBuilder::digest_algorithm) / [`set_digest_algorithm(Option<primitives::types::DigestAlgorithm>)`](crate::operation::hkdf_expand::builders::HkdfExpandFluentBuilder::set_digest_algorithm): (undocumented)<br>
    ...
    pub fn hkdf_expand(&self) -> crate::operation::hkdf_expand::builders::HkdfExpandFluentBuilder {
        crate::operation::hkdf_expand::builders::HkdfExpandFluentBuilder::new(self.clone())
    }
}
