...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_random::GenerateRandomResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateRandomResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateRandomResponse::GenerateRandomResponse {
...
pub fn from_dafny(
    ...
    crate::operation::generate_random::GenerateRandomResponse::builder()
