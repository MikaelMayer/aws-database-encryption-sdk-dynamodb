...
> {
  ...
  crate::ddb::standard_library_conversions::result_to_dafny(&native_result,
...
impl crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::_default {
  pub fn DynamoDBClient() -> ::std::rc::Rc<
    ...
    std::rc::Rc::new(crate::Wrappers::Result::Success { value: dafny_client })
  }
}
