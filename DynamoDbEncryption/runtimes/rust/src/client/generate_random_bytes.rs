...
impl crate::client::Client {
    ...
    pub fn generate_random_bytes(&self) -> crate::operation::generate_random_bytes::builders::GenerateRandomBytesFluentBuilder {
        crate::operation::generate_random_bytes::builders::GenerateRandomBytesFluentBuilder::new(self.clone())
    }
}
