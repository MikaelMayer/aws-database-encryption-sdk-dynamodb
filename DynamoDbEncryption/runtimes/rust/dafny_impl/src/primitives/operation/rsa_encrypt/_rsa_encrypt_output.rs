...
impl RsaEncryptOutput {
    /// Creates a new builder-style object to manufacture [`RsaEncryptOutput`](crate::primitives::operation::rsa_encrypt::builders::RsaEncryptOutput).
    pub fn builder() -> crate::primitives::operation::rsa_encrypt::builders::RsaEncryptOutputBuilder {
        crate::primitives::operation::rsa_encrypt::builders::RsaEncryptOutputBuilder::default()
    }
}

/// A builder for [`RsaEncryptOutput`](crate::primitives::operation::operation::RsaEncryptOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_cipher_text(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`RsaEncryptOutput`](crate::primitives::operation::operation::RsaEncryptOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::primitives::operation::rsa_encrypt::RsaEncryptOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::primitives::operation::rsa_encrypt::RsaEncryptOutput {
