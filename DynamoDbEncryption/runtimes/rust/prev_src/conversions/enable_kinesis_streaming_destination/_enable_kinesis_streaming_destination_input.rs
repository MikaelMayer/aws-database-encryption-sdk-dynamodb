...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EnableKinesisStreamingDestinationInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EnableKinesisStreamingDestinationInput::EnableKinesisStreamingDestinationInput {
...
pub fn from_dafny(
    ...
    crate::operation::enable_kinesis_streaming_destination::EnableKinesisStreamingDestinationInput::builder()
