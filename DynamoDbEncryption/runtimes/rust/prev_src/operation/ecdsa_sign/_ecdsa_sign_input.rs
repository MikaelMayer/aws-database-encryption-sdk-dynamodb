...
impl EcdsaSignInput {
    ...
    pub fn builder() -> crate::operation::ecdsa_sign::builders::EcdsaSignInputBuilder {
        crate::operation::ecdsa_sign::builders::EcdsaSignInputBuilder::default()
    }
}
...
pub fn get_signing_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::ecdsa_sign::EcdsaSignInput {
