...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::put_key_policy::PutKeyPolicyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::PutKeyPolicyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::PutKeyPolicyRequest::PutKeyPolicyRequest {
...
pub fn from_dafny(
    ...
    crate::operation::put_key_policy::PutKeyPolicyRequest::builder()
