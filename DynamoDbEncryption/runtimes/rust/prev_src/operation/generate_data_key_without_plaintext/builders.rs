...
pub use crate::operation::generate_data_key_without_plaintext::_generate_data_key_without_plaintext_response::GenerateDataKeyWithoutPlaintextResponseBuilder;

pub use crate::operation::generate_data_key_without_plaintext::_generate_data_key_without_plaintext_request::GenerateDataKeyWithoutPlaintextRequestBuilder;
...
pub struct GenerateDataKeyWithoutPlaintextFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextRequestBuilder,
}
impl GenerateDataKeyWithoutPlaintextFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintext::send(&self.client, input).await
    }
