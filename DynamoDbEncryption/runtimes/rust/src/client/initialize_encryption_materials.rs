...
impl crate::client::Client {
    ...
    ///   - [`algorithm_suite(Option<material_providers::types::AlgorithmSuiteInfo>)`](crate::operation::initialize_encryption_materials::EncryptionMaterials::algorithm_suite): (undocumented)
    ///   - [`encrypted_data_keys(Option<::std::vec::Vec<material_providers::types::EncryptedDataKey>>)`](crate::operation::initialize_encryption_materials::EncryptionMaterials::encrypted_data_keys): (undocumented)
    ...
    pub fn initialize_encryption_materials(&self) -> crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsFluentBuilder {
        crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsFluentBuilder::new(self.clone())
    }
}
