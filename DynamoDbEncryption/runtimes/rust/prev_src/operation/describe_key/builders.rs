...
pub use crate::operation::describe_key::_describe_key_response::DescribeKeyResponseBuilder;

pub use crate::operation::describe_key::_describe_key_request::DescribeKeyRequestBuilder;
...
pub struct DescribeKeyFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::describe_key::builders::DescribeKeyRequestBuilder,
}
impl DescribeKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::describe_key::builders::DescribeKeyRequestBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::describe_key::DescribeKey::send(&self.client, input).await
    }
