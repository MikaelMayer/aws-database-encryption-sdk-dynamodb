...
pub struct CreateMultiKeyringInput {
    #[allow(missing_docs)] // documentation missing in model
pub child_keyrings: ::std::option::Option<::std::vec::Vec<material_providers::types::keyring::KeyringRef>>,
#[allow(missing_docs)] // documentation missing in model
pub generator: ::std::option::Option<material_providers::types::keyring::KeyringRef>,
}
impl CreateMultiKeyringInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn child_keyrings(&self) -> &::std::option::Option<::std::vec::Vec<material_providers::types::keyring::KeyringRef>> {
    &self.child_keyrings
}
#[allow(missing_docs)] // documentation missing in model
pub fn generator(&self) -> &::std::option::Option<material_providers::types::keyring::KeyringRef> {
    &self.generator
}
}
impl CreateMultiKeyringInput {
...
pub struct CreateMultiKeyringInputBuilder {
    pub(crate) child_keyrings: ::std::option::Option<::std::vec::Vec<material_providers::types::keyring::KeyringRef>>,
pub(crate) generator: ::std::option::Option<material_providers::types::keyring::KeyringRef>,
}
