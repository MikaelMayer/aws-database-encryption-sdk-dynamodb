...
impl HkdfOutput {
    ...
    pub fn builder() -> crate::operation::hkdf::builders::HkdfOutputBuilder {
        crate::operation::hkdf::builders::HkdfOutputBuilder::default()
    }
}
...
pub fn get_okm(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::hkdf::HkdfOutput {
            okm: self.okm,
        })
    }
}
