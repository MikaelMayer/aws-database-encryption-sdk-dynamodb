...
impl HkdfExpandInput {
    /// Creates a new builder-style object to manufacture [`HkdfExpandInput`](crate::primitives::operation::hkdf_expand::builders::HkdfExpandInput).
    pub fn builder() -> crate::primitives::operation::hkdf_expand::builders::HkdfExpandInputBuilder {
        crate::primitives::operation::hkdf_expand::builders::HkdfExpandInputBuilder::default()
    }
}

/// A builder for [`HkdfExpandInput`](crate::primitives::operation::operation::HkdfExpandInput).
#[non_exhaustive]
#[derive(
...
pub fn get_prk(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`HkdfExpandInput`](crate::primitives::operation::operation::HkdfExpandInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::operation::hkdf_expand::HkdfExpandInput {
