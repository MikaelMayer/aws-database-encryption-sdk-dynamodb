...
impl CreateAwsKmsMultiKeyringInput {
    ...
    pub fn builder() -> crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInputBuilder {
        crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInputBuilder::default()
    }
}
...
pub fn get_kms_key_ids(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_aws_kms_multi_keyring::CreateAwsKmsMultiKeyringInput {
