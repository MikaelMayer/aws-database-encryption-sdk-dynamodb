...
impl GetPublicKeyFromPrivateKeyOutput {
    ...
    pub fn builder() -> crate::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyOutputBuilder {
        crate::operation::get_public_key_from_private_key::builders::GetPublicKeyFromPrivateKeyOutputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_public_key_from_private_key::GetPublicKeyFromPrivateKeyOutput {
