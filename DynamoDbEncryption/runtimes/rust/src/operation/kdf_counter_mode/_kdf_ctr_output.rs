...
impl KdfCtrOutput {
    ...
    pub fn builder() -> crate::operation::kdf_counter_mode::builders::KdfCtrOutputBuilder {
        crate::operation::kdf_counter_mode::builders::KdfCtrOutputBuilder::default()
    }
}
...
pub fn get_okm(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::kdf_counter_mode::KdfCtrOutput {
            okm: self.okm,
        })
    }
}
