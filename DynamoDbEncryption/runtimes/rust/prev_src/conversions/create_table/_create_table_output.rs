...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_table::CreateTableOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateTableOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateTableOutput::CreateTableOutput {
...
pub fn from_dafny(
    ...
    crate::operation::create_table::CreateTableOutput::builder()
