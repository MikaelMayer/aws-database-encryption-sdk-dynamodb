...
pub use crate::operation::create_raw_aes_keyring::_create_keyring_output::CreateKeyringOutputBuilder;

pub use crate::operation::create_raw_aes_keyring::_create_raw_aes_keyring_input::CreateRawAesKeyringInputBuilder;
...
impl CreateRawAesKeyringInputBuilder {
    ...
    pub async fn send_with(
        ...
        crate::operation::create_raw_aes_keyring::CreateKeyringOutput,
...
pub struct CreateRawAesKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInputBuilder,
}
impl CreateRawAesKeyringFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::create_raw_aes_keyring::CreateRawAesKeyring::send(&self.client, input).await
    }
...
#[allow(missing_docs)] // documentation missing in model
pub fn wrapping_alg(mut self, input: impl ::std::convert::Into<material_providers::types::AesWrappingAlg>) -> Self {
    self.inner = self.inner.wrapping_alg(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_wrapping_alg(mut self, input: ::std::option::Option<material_providers::types::AesWrappingAlg>) -> Self {
    self.inner = self.inner.set_wrapping_alg(input);
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_wrapping_alg(&self) -> &::std::option::Option<material_providers::types::AesWrappingAlg> {
