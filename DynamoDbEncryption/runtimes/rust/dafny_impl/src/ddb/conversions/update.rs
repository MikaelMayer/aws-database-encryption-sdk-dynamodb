...
,
 ReturnValuesOnConditionCheckFailure: ::std::rc::Rc::new(match &value.return_values_on_condition_check_failure {
    Some(x) => crate::Wrappers::Option::Some { value: crate::ddb::conversions::return_values_on_condition_check_failure::to_dafny(x.clone()) },
    None => crate::Wrappers::Option::None { }
})
,
    }
...
,
 ...
 .set_return_values_on_condition_check_failure(match &**dafny_value.ReturnValuesOnConditionCheckFailure() {
    crate::Wrappers::Option::Some { value } => Some(
        crate::ddb::conversions::return_values_on_condition_check_failure::from_dafny(value)
    ),
    _ => None,
}
)
