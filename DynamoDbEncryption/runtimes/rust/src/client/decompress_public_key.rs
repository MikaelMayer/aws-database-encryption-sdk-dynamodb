...
impl crate::client::Client {
    ...
    ///   - [`ecc_curve(impl Into<Option<primitives::types::EcdhCurveSpec>>)`](crate::operation::decompress_public_key::builders::DecompressPublicKeyFluentBuilder::ecc_curve) / [`set_ecc_curve(Option<primitives::types::EcdhCurveSpec>)`](crate::operation::decompress_public_key::builders::DecompressPublicKeyFluentBuilder::set_ecc_curve): (undocumented)<br>
    ...
    ///   - [`public_key(Option<primitives::types::EccPublicKey>)`](crate::operation::decompress_public_key::DecompressPublicKeyOutput::public_key): (undocumented)
    ...
    pub fn decompress_public_key(&self) -> crate::operation::decompress_public_key::builders::DecompressPublicKeyFluentBuilder {
        crate::operation::decompress_public_key::builders::DecompressPublicKeyFluentBuilder::new(self.clone())
    }
}
