...
impl GetBeaconKeyInput {
    ...
    pub fn builder() -> crate::operation::get_beacon_key::builders::GetBeaconKeyInputBuilder {
        crate::operation::get_beacon_key::builders::GetBeaconKeyInputBuilder::default()
    }
}
...
pub fn get_branch_key_identifier(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_beacon_key::GetBeaconKeyInput {
