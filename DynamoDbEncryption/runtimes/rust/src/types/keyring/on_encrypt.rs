...
impl crate::types::keyring::KeyringRef {
    ...
    ///   - [`materials(impl Into<Option<material_providers::types::EncryptionMaterials>>)`](crate::operation::on_encrypt::builders::OnEncryptFluentBuilder::materials) / [`set_materials(Option<material_providers::types::EncryptionMaterials>)`](crate::operation::on_encrypt::builders::OnEncryptFluentBuilder::set_materials): (undocumented)<br>
    /// - On success, responds with [`OnEncryptOutput`](crate::operation::on_encrypt::OnEncryptOutput) with field(s):
    ///   - [`materials(Option<material_providers::types::EncryptionMaterials>)`](crate::operation::on_encrypt::OnEncryptOutput::materials): (undocumented)
