...
pub struct TransactGetItemsInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub sdk_input: ::std::option::Option<dynamodb::types::TransactGetItemsInput>,
}
impl TransactGetItemsInputTransformInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(&self) -> &::std::option::Option<dynamodb::types::TransactGetItemsInput> {
    &self.sdk_input
}
}
impl TransactGetItemsInputTransformInput {
...
pub struct TransactGetItemsInputTransformInputBuilder {
    pub(crate) sdk_input: ::std::option::Option<dynamodb::types::TransactGetItemsInput>,
}
impl TransactGetItemsInputTransformInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn sdk_input(mut self, input: impl ::std::convert::Into<dynamodb::types::TransactGetItemsInput>) -> Self {
    self.sdk_input = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_sdk_input(mut self, input: ::std::option::Option<dynamodb::types::TransactGetItemsInput>) -> Self {
    self.sdk_input = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_sdk_input(&self) -> &::std::option::Option<dynamodb::types::TransactGetItemsInput> {
    &self.sdk_input
}
