...
impl RsaPublicKey {
    /// Creates a new builder-style object to manufacture [`RsaPublicKey`](crate::primitives::types::RsaPublicKey).
    pub fn builder() -> crate::primitives::types::builders::RsaPublicKeyBuilder {
        crate::primitives::types::builders::RsaPublicKeyBuilder::default()
    }
}

/// A builder for [`RsaPublicKey`](crate::primitives::types::RsaPublicKey).
#[non_exhaustive]
#[derive(
...
pub fn get_pem(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`RsaPublicKey`](crate::primitives::types::RsaPublicKey).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::primitives::types::RsaPublicKey {
