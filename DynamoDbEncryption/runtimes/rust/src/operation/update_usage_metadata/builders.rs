...
pub use crate::operation::update_usage_metadata::_unit::UnitBuilder;

pub use crate::operation::update_usage_metadata::_update_usage_metadata_input::UpdateUsageMetadataInputBuilder;
...
pub struct UpdateUsageMetadataFluentBuilder {
    cryptographic_materials_cache: crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef,
    pub(crate) inner: crate::operation::update_usage_metadata::builders::UpdateUsageMetadataInputBuilder,
}
impl UpdateUsageMetadataFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::update_usage_metadata::builders::UpdateUsageMetadataInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::update_usage_metadata::UpdateUsageMetadata::send(&self.cryptographic_materials_cache, input).await
    }
