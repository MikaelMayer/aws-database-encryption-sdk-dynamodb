...
pub use crate::operation::decrypt_materials::_decrypt_materials_output::DecryptMaterialsOutputBuilder;

pub use crate::operation::decrypt_materials::_decrypt_materials_input::DecryptMaterialsInputBuilder;
...
pub struct DecryptMaterialsFluentBuilder {
    cryptographic_materials_manager: crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef,
    pub(crate) inner: crate::operation::decrypt_materials::builders::DecryptMaterialsInputBuilder,
}
impl DecryptMaterialsFluentBuilder {
    /// Creates a new `DecryptMaterials`.
    pub(crate) fn new(cryptographic_materials_manager: crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef) -> Self {
        Self {
    ...
    pub fn as_input(&self) -> &crate::operation::decrypt_materials::builders::DecryptMaterialsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::decrypt_materials::DecryptMaterials::send(&self.cryptographic_materials_manager, input).await
    }
