...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_exports::ListExportsInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListExportsInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListExportsInput::ListExportsInput {
...
pub fn from_dafny(
    ...
    crate::operation::list_exports::ListExportsInput::builder()
