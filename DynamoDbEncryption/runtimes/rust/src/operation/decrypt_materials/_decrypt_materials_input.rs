...
pub struct DecryptMaterialsInput {
    #[allow(missing_docs)] // documentation missing in model
pub algorithm_suite_id: ::std::option::Option<material_providers::types::AlgorithmSuiteId>,
#[allow(missing_docs)] // documentation missing in model
...
impl DecryptMaterialsInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite_id(&self) -> &::std::option::Option<material_providers::types::AlgorithmSuiteId> {
...
impl DecryptMaterialsInput {
    ...
    pub fn builder() -> crate::operation::decrypt_materials::builders::DecryptMaterialsInputBuilder {
        crate::operation::decrypt_materials::builders::DecryptMaterialsInputBuilder::default()
    }
}
...
pub struct DecryptMaterialsInputBuilder {
    pub(crate) algorithm_suite_id: ::std::option::Option<material_providers::types::AlgorithmSuiteId>,
...
impl DecryptMaterialsInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite_id(mut self, input: impl ::std::convert::Into<material_providers::types::AlgorithmSuiteId>) -> Self {
    self.algorithm_suite_id = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_algorithm_suite_id(mut self, input: ::std::option::Option<material_providers::types::AlgorithmSuiteId>) -> Self {
    self.algorithm_suite_id = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_algorithm_suite_id(&self) -> &::std::option::Option<material_providers::types::AlgorithmSuiteId> {
    &self.algorithm_suite_id
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_reproduced_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decrypt_materials::DecryptMaterialsInput {
