...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::list_global_tables::ListGlobalTablesInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListGlobalTablesInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ListGlobalTablesInput::ListGlobalTablesInput {
...
pub fn from_dafny(
    ...
    crate::operation::list_global_tables::ListGlobalTablesInput::builder()
