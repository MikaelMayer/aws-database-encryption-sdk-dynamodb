...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::describe_key::DescribeKeyRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DescribeKeyRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DescribeKeyRequest::DescribeKeyRequest {
...
pub fn from_dafny(
    ...
    crate::operation::describe_key::DescribeKeyRequest::builder()
