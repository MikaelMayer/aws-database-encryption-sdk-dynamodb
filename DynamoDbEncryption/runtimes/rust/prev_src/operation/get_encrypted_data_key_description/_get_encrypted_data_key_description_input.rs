...
pub struct GetEncryptedDataKeyDescriptionInput {
    #[allow(missing_docs)] // documentation missing in model
pub input: ::std::option::Option<dynamo_db::types::GetEncryptedDataKeyDescriptionUnion>,
}
impl GetEncryptedDataKeyDescriptionInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn input(&self) -> &::std::option::Option<dynamo_db::types::GetEncryptedDataKeyDescriptionUnion> {
    &self.input
}
}
impl GetEncryptedDataKeyDescriptionInput {
    ...
    pub fn builder() -> crate::operation::get_encrypted_data_key_description::builders::GetEncryptedDataKeyDescriptionInputBuilder {
        crate::operation::get_encrypted_data_key_description::builders::GetEncryptedDataKeyDescriptionInputBuilder::default()
    }
}
...
pub struct GetEncryptedDataKeyDescriptionInputBuilder {
    pub(crate) input: ::std::option::Option<dynamo_db::types::GetEncryptedDataKeyDescriptionUnion>,
}
...
pub fn get_input(&self) -> &::std::option::Option<dynamo_db::types::GetEncryptedDataKeyDescriptionUnion> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_encrypted_data_key_description::GetEncryptedDataKeyDescriptionInput {
            input: self.input,
        })
    }
}
