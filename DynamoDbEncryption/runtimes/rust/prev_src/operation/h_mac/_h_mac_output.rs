...
impl HMacOutput {
    ...
    pub fn builder() -> crate::operation::h_mac::builders::HMacOutputBuilder {
        crate::operation::h_mac::builders::HMacOutputBuilder::default()
    }
}
...
pub fn get_digest(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::h_mac::HMacOutput {
            digest: self.digest,
        })
    }
}
