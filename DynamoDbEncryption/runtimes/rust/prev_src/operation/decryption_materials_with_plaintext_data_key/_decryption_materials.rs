...
impl DecryptionMaterials {
    ...
    pub fn builder() -> crate::operation::decryption_materials_with_plaintext_data_key::builders::DecryptionMaterialsBuilder {
        crate::operation::decryption_materials_with_plaintext_data_key::builders::DecryptionMaterialsBuilder::default()
    }
}
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decryption_materials_with_plaintext_data_key::DecryptionMaterials {
