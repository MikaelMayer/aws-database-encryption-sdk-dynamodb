...
pub struct DecryptStructureInput {
    #[allow(missing_docs)] // documentation missing in model
pub authenticate_schema: ::std::option::Option<::std::collections::HashMap<::std::string::String, structured_encryption::types::AuthenticateAction>>,
#[allow(missing_docs)] // documentation missing in model
...
impl DecryptStructureInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn authenticate_schema(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, structured_encryption::types::AuthenticateAction>> {
...
impl DecryptStructureInput {
    ...
    pub fn builder() -> crate::operation::decrypt_structure::builders::DecryptStructureInputBuilder {
        crate::operation::decrypt_structure::builders::DecryptStructureInputBuilder::default()
    }
}
...
pub struct DecryptStructureInputBuilder {
    pub(crate) authenticate_schema: ::std::option::Option<::std::collections::HashMap<::std::string::String, structured_encryption::types::AuthenticateAction>>,
...
impl DecryptStructureInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn authenticate_schema(mut self, input: impl ::std::convert::Into<::std::collections::HashMap<::std::string::String, structured_encryption::types::AuthenticateAction>>) -> Self {
    self.authenticate_schema = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_authenticate_schema(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, structured_encryption::types::AuthenticateAction>>) -> Self {
    self.authenticate_schema = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_authenticate_schema(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, structured_encryption::types::AuthenticateAction>> {
    &self.authenticate_schema
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_table_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::decrypt_structure::DecryptStructureInput {
