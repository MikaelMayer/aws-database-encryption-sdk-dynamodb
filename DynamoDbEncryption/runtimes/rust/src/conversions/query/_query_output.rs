...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::query::QueryOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::QueryOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::QueryOutput::QueryOutput {
...
,
 Count: crate::standard_library_conversions::oint_to_dafny(value.count),
 ScannedCount: crate::standard_library_conversions::oint_to_dafny(value.scanned_count),
 LastEvaluatedKey:
...
pub fn from_dafny(
    ...
    crate::operation::query::QueryOutput::builder()
