...
impl DigestInput {
    ...
    pub fn builder() -> crate::operation::digest::builders::DigestInputBuilder {
        crate::operation::digest::builders::DigestInputBuilder::default()
    }
}
...
pub fn get_message(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::digest::DigestInput {
