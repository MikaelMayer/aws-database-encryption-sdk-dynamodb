...
impl GetRsaKeyModulusLengthOutput {
    ...
    pub fn builder() -> crate::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthOutputBuilder {
        crate::operation::get_rsa_key_modulus_length::builders::GetRsaKeyModulusLengthOutputBuilder::default()
    }
}
...
pub fn get_length(&self) -> &::std::option::Option<::std::primitive::i32> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_rsa_key_modulus_length::GetRsaKeyModulusLengthOutput {
            length: self.length,
        })
    }
}
