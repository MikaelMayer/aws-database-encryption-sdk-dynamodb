...
pub use crate::operation::h_mac::_h_mac_output::HMacOutputBuilder;

pub use crate::operation::h_mac::_h_mac_input::HMacInputBuilder;
...
pub struct HMacFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner: crate::operation::h_mac::builders::HMacInputBuilder,
}
impl HMacFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::h_mac::builders::HMacInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::h_mac::HMac::send(&self.client, input).await
    }
