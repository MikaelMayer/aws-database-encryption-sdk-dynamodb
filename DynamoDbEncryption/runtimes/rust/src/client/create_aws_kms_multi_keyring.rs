...
impl crate::client::Client {
    ...
    ///   - [`client_supplier(impl Into<Option<material_providers::types::client_supplier::ClientSupplierRef>>)`](crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringFluentBuilder::client_supplier) / [`set_client_supplier(Option<material_providers::types::client_supplier::ClientSupplierRef>)`](crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringFluentBuilder::set_client_supplier): (undocumented)<br>
    ...
    ///   - [`keyring(Option<material_providers::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_multi_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_multi_keyring(&self) -> crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringFluentBuilder {
        crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringFluentBuilder::new(self.clone())
    }
}
