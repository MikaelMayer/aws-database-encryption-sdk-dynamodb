...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::execute_transaction::ExecuteTransactionInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExecuteTransactionInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::ExecuteTransactionInput::ExecuteTransactionInput {
        TransactStatements: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.transact_statements.clone().unwrap(),
    |e| dynamodb::conversions::parameterized_statement::to_dafny(e.clone())
,
)
,
...
pub fn from_dafny(
    ...
    crate::operation::execute_transaction::ExecuteTransactionInput::builder()
    ...
    |e| dynamodb::conversions::parameterized_statement::from_dafny(e.clone())
,
)
 ))
