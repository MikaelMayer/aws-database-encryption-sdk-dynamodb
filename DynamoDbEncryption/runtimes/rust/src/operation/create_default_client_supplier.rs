...
impl CreateDefaultClientSupplier {
    ...
    pub(crate) async fn send(
        ...
        material_providers::types::client_supplier::ClientSupplierRef,
    ...
    > {
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::create_default_client_supplier::_create_default_client_supplier_output::from_dafny(inner_result.value().clone()),
            )
        } else {
