...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::disable_kinesis_streaming_destination::DisableKinesisStreamingDestinationOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DisableKinesisStreamingDestinationOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::DisableKinesisStreamingDestinationOutput::DisableKinesisStreamingDestinationOutput {
...
pub fn from_dafny(
    ...
    crate::operation::disable_kinesis_streaming_destination::DisableKinesisStreamingDestinationOutput::builder()
