...
impl AesDecryptOutput {
    ...
    pub fn builder() -> crate::operation::aes_decrypt::builders::AesDecryptOutputBuilder {
        crate::operation::aes_decrypt::builders::AesDecryptOutputBuilder::default()
    }
}
...
pub fn get_plaintext(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::aes_decrypt::AesDecryptOutput {
