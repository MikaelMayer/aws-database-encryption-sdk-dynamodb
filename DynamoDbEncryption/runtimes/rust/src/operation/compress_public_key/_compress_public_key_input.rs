...
impl CompressPublicKeyInput {
    ...
    pub fn builder() -> crate::operation::compress_public_key::builders::CompressPublicKeyInputBuilder {
        crate::operation::compress_public_key::builders::CompressPublicKeyInputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<primitives::types::EccPublicKey> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::compress_public_key::CompressPublicKeyInput {
