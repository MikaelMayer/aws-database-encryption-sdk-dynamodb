...
impl crate::client::Client {
    ...
    pub fn create_key_store(&self) -> crate::operation::create_key_store::builders::CreateKeyStoreFluentBuilder {
        crate::operation::create_key_store::builders::CreateKeyStoreFluentBuilder::new(self.clone())
    }
}
