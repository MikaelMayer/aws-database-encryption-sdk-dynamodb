...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::generate_ecdsa_signature_key::GenerateEcdsaSignatureKeyOutput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateECDSASignatureKeyOutput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GenerateECDSASignatureKeyOutput::GenerateECDSASignatureKeyOutput {
...
pub fn from_dafny(
    ...
    crate::operation::generate_ecdsa_signature_key::GenerateEcdsaSignatureKeyOutput::builder()
