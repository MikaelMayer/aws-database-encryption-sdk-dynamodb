...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::get_key_rotation_status::GetKeyRotationStatusResponse,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetKeyRotationStatusResponse,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::GetKeyRotationStatusResponse::GetKeyRotationStatusResponse {
        KeyRotationEnabled: crate::standard_library_conversions::obool_to_dafny(&value.key_rotation_enabled),
...
pub fn from_dafny(
    ...
    crate::operation::get_key_rotation_status::GetKeyRotationStatusResponse::builder()
