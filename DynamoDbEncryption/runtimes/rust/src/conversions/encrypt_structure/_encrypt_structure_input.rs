...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::encrypt_structure::EncryptStructureInput,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EncryptStructureInput,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::EncryptStructureInput::EncryptStructureInput {
...
pub fn from_dafny(
    ...
    crate::operation::encrypt_structure::EncryptStructureInput::builder()
