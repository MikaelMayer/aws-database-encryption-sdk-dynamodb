...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::operation::create_custom_key_store::CreateCustomKeyStoreRequest,
) -> ::std::rc::Rc<
    crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateCustomKeyStoreRequest,
>{
    ::std::rc::Rc::new(crate::r#aws::cryptography::dbencryptionsdk::dynamodb::transforms::internaldafny::types::CreateCustomKeyStoreRequest::CreateCustomKeyStoreRequest {
 ...
 CustomKeyStoreType: ::std::rc::Rc::new(match &value.custom_key_store_type {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::custom_key_store_type::to_dafny(x.clone()) },
...
,
 ...
 XksProxyAuthenticationCredential: ::std::rc::Rc::new(match &value.xks_proxy_authentication_credential {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::xks_proxy_authentication_credential_type::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 XksProxyConnectivity: ::std::rc::Rc::new(match &value.xks_proxy_connectivity {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: kms::conversions::xks_proxy_connectivity_type::to_dafny(x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
    })
...
pub fn from_dafny(
    ...
    crate::operation::create_custom_key_store::CreateCustomKeyStoreRequest::builder()
 ...
 .set_custom_key_store_type(match &**dafny_value.CustomKeyStoreType() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        kms::conversions::custom_key_store_type::from_dafny(value)
    ),
    _ => None,
}
)
 ...
 .set_xks_proxy_authentication_credential(match (*dafny_value.XksProxyAuthenticationCredential()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(kms::conversions::xks_proxy_authentication_credential_type::from_dafny(value.clone())),
    _ => None,
}
)
 .set_xks_proxy_connectivity(match &**dafny_value.XksProxyConnectivity() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        kms::conversions::xks_proxy_connectivity_type::from_dafny(value)
    ),
    _ => None,
}
)
