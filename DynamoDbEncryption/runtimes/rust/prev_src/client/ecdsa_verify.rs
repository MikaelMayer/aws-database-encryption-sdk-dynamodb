...
impl crate::client::Client {
    ...
    ///   - [`signature_algorithm(impl Into<Option<primitives::types::EcdsaSignatureAlgorithm>>)`](crate::operation::ecdsa_verify::builders::ECDSAVerifyFluentBuilder::signature_algorithm) / [`set_signature_algorithm(Option<primitives::types::EcdsaSignatureAlgorithm>)`](crate::operation::ecdsa_verify::builders::ECDSAVerifyFluentBuilder::set_signature_algorithm): (undocumented)<br>
    ...
    pub fn ecdsa_verify(&self) -> crate::operation::ecdsa_verify::builders::EcdsaVerifyFluentBuilder {
        crate::operation::ecdsa_verify::builders::EcdsaVerifyFluentBuilder::new(self.clone())
    }
}
