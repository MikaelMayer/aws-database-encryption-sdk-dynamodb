...
impl DeleteItemOutputTransform {
    ...
    > {
        ...
        let inner_result =
            ::dafny_runtime::md!(client.dafny_client.clone()).DeleteItemOutputTransform(&inner_input);
        if matches!(
            inner_result.as_ref(),
            crate::r#_Wrappers_Compile::Result::Success { .. }
        ) {
            Ok(
                crate::conversions::delete_item_output_transform::_delete_item_output_transform_output::from_dafny(
